...
export class UserRegisterVZambaComponent implements OnDestroy, OnInit {
  constructor(
  ...
  form = this.fb.nonNullable.group(
    {
      ...
      password: [
        ...
        [
          ...
          UserRegisterVZambaComponent.checkPassword.bind(this),
        ],
      ],
  ...
  disableSubmitButton = false; //TODO: cuando este el captcha, dejarlo en true.
  error = '';
  serverError = false;
  type = 0;
  loading = false;
