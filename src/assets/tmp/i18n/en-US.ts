export const enUS = {
    ...
    "app.login.validate-username": "Please enter a valid username",
    "app.login.validate-username-pattern": "The username must be alphanumeric",
    "app.login.password": "password",
    "app.login.validate-password-pattern": "The password has characters not allowed",
    "app.login.validate-password": "Please enter password",

    "app.server.error-message": "Server error, please try again later",
    "app.server.error-user-isnot-active": "The user is not active. Please check your email to activate your account",
    "app.passport.welcome": "Welcome to Zamba",
    ...
    "app.register.form-department-placeholder": "Department",
    "app.register.form-rol-placeholder": "Rol",
    "app.register.form-phone-placeholder": "Phone number",
    "app.register.form-email-placeholder": "Email",
    "app.register.form-user-name-placeholder": "Username",
    "app.register.form-password-placeholder": "Password",
    "app.register.form-confirm-password-placeholder": "Confirm Password",

    "app.register.get-verification-code": "Get code",
    "app.register.sign-in": "Already have an account?",
    "app.register.do-click-here": "Click here",
    "app.register.back-to-login": "Back to login",
    "app.register.resend-verification-email": "Resend",
    "app.register-result.msg": "Account：registered at {{email}}",
    "app.resend-result.msg": "The verification email has been sent to: {{email}}",
    "app.register-result.activation-account": "Your account has been activated successfully.",
    "app.register-result.activation-email":
        "The activation email has been sent to your email address. Please log in to the email and click on the link in the email to activate the account.",
    "app.register-result.resend-email-result": "Please log in to the email and click on the link in the email to activate the account.",
    "app.validate.account": "Account activation successful.",
    ...
    "validation.username.maxLength": "The username cannot exceed 50 characters!",
    "validation.username.usernameExists": "The username already exists!",
    "validation.phone-number.maxlength": "The phone number cannot exceed 50 characters!",
    "validation.enterprise.maxLength": "The company name cannot exceed 50 characters!",
    "validation.email.required": "Please enter your email!",
    "validation.email.emailExists": "The email already exists!",
    "validation.email.maxLength": "The email cannot exceed 50 characters!",
    "validation.enterprise.required": "Please enter the enterprise name",
    "validation.name.required": "Please enter your name",
    "validation.name.maxLength": "The name cannot exceed 50 characters!",
    "validation.lastname.required": "Please enter your lastname",
    "validation.lastname.maxLength": "The lastname cannot exceed 50 characters!",
    "validation.department.required": "Please enter the department",
    "validation.rol.required": "Please select a role",
    ...
    "app.profile.BIRTHDAY": "Birthday",
    "app.profile.WORKEMAIL": "Work Email",
    "app.profile.WORKCELLPHONE": "Work Cellphone",
    "app.profile.COMPANY": "Company",
    "app.profile.POSITION": "Position",
    "app.profile.DEPARTMENT": "Department",
    "app.profile.WORKMODE": "Work Mode",
    "app.profile.DATEEMPLOYMENTENTRY": "Date of Employment Entry",
    "app.profile.EMPLOYMENTSTATUS": "Employment Status"
}
