...
class ConsumeServiceRestApi
{
    ...
    public DocumentData GetDocumentData(long userId, string doctypeId, string docId, bool convertToPDf, IResult res, bool MsgPreview, bool includeAttachs, string newPDFFile)
    {
