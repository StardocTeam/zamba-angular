...
#Region " Atributos "
    ...
    Private _volumestate As IVolume.VolumeStates = IVolume.VolumeStates.VolumenEnPreparacion
...
#Region " Propiedades "
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Property VolumeType() As Core.VolumeType Implements IVolume.VolumeType
        Get
            Return _type
        End Get
        Set(ByVal Value As Core.VolumeType)
            _type = Value
        End Set
    End Property
    ''' -----------------------------------------------------------------------------
    ...
    Public Property offset() As Integer Implements IVolume.offset
        ...
        End Set
    End Property
    Public Property VolumeState() As IVolume.VolumeStates Implements IVolume.VolumeState
        Get
            Return _volumestate
        End Get
        Set(ByVal value As IVolume.VolumeStates)
            _volumestate = value
        End Set
    End Property
