...
public class UserPreferencesFactory
{
    ...
    /// <history>Marcelo Created 29/10/2010</history>
    /// <remarks></remarks>
    public static void setValueDB(string name, string value, Sections section, Int64 userId)
    {
    ...
    /// <history>Marcelo Created 29/10/2010</history>
    /// <remarks></remarks>
    public static string GetDefaultValueDB(string name, Sections section)
    {
        if (Server.isOracle)
        {
    ...
    /// <history>Marcelo Created 29/10/2010</history>
    /// <remarks></remarks>
    public static string getValueDB(string name, Sections Section, Int64 userId)
    {
        if (Server.isOracle)
        {
    ...
    /// <history>Marcelo Created 29/10/2010</history>
    /// <remarks></remarks>
    public static void setValueDBByMachine(string name, string value, Sections section, string machineName)
    {
        if (Server.isOracle)
        {
    ...
    /// <history>Marcelo Created 29/10/2010</history>
    /// <remarks></remarks>
    public static void updateValueDBByMachine(string name, string value, Sections section, string machineName)
    {
        if (Server.isOracle)
        {
            object[] parValues = {
    ...
    /// <history>Marcelo Created 29/10/2010</history>
    /// <remarks></remarks>
    public static string getValueDBByMachine(string name, Sections Section, string machineName)
    {
