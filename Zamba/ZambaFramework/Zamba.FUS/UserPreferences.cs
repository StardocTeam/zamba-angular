...
public class UserPreferences
{
    ...
    public static string getValue(string name, Sections Section, object DefaultValue)
    {
        try
        {
            if (Server.ConInitialized || Server.ConInitializing)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        userId = Zamba.Membership.MembershipHelper.CurrentUser.ID;
    ...
    ///Devuelve el valor de un item por el nombre
    public static string getValueForMachine(string name, Sections Section, object DefaultValue, bool UseCache = true)
    {
        return getValueForMachine(name, Section, DefaultValue, Environment.MachineName, UseCache);
    }

    public static string getValueForMachine(string name, Sections Section, object DefaultValue, string machineName, bool UseCache = true)
    {
        try
        {
    ...
    public static void setValue(string name, string valor, Sections Section)
    {
        try
        {
    ...
    ///agrega un item por el nombre y le asigna el valor
    public static void setValueForMachine(string name, string valor, Sections Section)
    {
        setValueForMachine(name, valor, Section, Environment.MachineName);
    }

    public static void setValueForMachine(string name, string valor, Sections Section, string MachineName)
    {
        try
        {
    ...
    public static void setValueForUsersId(string name, string value, Sections section, long userId)
    {
