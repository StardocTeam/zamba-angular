...
SyncLock (hsSingletonZCoreModules)
            ...
            SyncLock (_hsSingletonZCoreInstances)
                If Not _hsSingletonZCoreInstances.ContainsKey(zCoreKey) Then
                    Dim Listener As New TextWriterTraceListener(Membership.MembershipHelper.AppTempPath & "\Exceptions" & "\Trace " & zModule & " - " & Now.ToString("dd-MM-yyyy HH-mm-ss") & ".txt", zModule)
			...
			If Not _hsSingletonZCoreInstances.ContainsKey(zCoreKey) Then
                ...
                Dim path As String = Membership.MembershipHelper.AppTempPath & "\Exceptions\Trace"
