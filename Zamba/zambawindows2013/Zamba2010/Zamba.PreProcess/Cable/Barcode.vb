...
#Region "Metodos Publicos"
    Public Shared Sub Run(ByVal Fi As IO.FileInfo)
        ...
        Dim sw As IO.StreamWriter = New IO.StreamWriter(Dir & "\tmp2.txt")
        Dim str As String
        ...
        sw = Nothing
        GC.Collect()
        Dim fio As New System.IO.FileInfo(Dir & "\tmp2.txt")
...
#End Region
    ...
    Public Shared Sub QuitarComillas(ByVal Fi As IO.FileInfo)
        ...
        Dim sw As New IO.StreamWriter(Dir & "\tmp3.txt", False, System.Text.Encoding.Default)
        Dim str As String
        sw.AutoFlush = True
        If Fi.Exists Then
            Try
        ...
        Dim fio As New System.IO.FileInfo(dir & "\tmp3.txt")
        fio.CopyTo(Fi.FullName, True)
        fio.Delete()
    End Sub
    ...
    Public Function process(ByVal Files As System.Collections.ArrayList, Optional ByVal param As System.Collections.ArrayList = Nothing, Optional ByVal xml As String = Nothing, Optional ByVal Test As Boolean = False) As System.Collections.ArrayList Implements Ipreprocess.process
        ...
        For I = 0 To Files.Count - 1
            Result.Add(Me.processFile(Files(I)))
        Next
        Return Result
    End Function
