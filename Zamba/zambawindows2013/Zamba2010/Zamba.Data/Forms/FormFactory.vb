...
Public NotInheritable Class FormFactory
    ...
    Public Shared Function GetForm(ByVal formID As Int64) As ZwebForm
        ...
        Try
            ...
            If Server.isOracle Then
                query.Append("SELECT ZFrms.Name, ZFrms.ParentId")
                query.Append(", ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path")
                query.Append(", ZFrms.Description, ZFrms.USERULERIGHTS, Ztype_Zfrms.Form_Id")
                query.Append(", Ztype_Zfrms.DocType_Id, ZFrms.Updated, zfrms.UseBlob")
                query.Append(" FROM ZFrms")
                query.Append(" INNER JOIN Ztype_Zfrms")
                query.Append(" ON ZFrms.Id = Ztype_Zfrms.Form_Id")
                query.Append(" WHERE Form_Id = ")
                query.Append(formID)
            Else
                query.Append("SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where Id = ")
                query.Append(formID)
            End If
    ...
    Public Shared Function GetFormsByType(ByVal Formtype As FormTypes) As ArrayList
        ...
        Try
            Strselect = "SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where Type = " & Integer.Parse(Formtype).ToString()
    ...
    Public Shared Function GetInsertFormsByDocTypeId(ByVal docTypeId As Int64) As List(Of ZwebForm)
        Dim Dstemp As DataSet
        ...
        Try
            ...
            Strselect = "SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where type=4 and doctype_id = " & docTypeId
    ...
    Public Shared Function GetAllForms(ByVal docTypeId As Int64) As List(Of ZwebForm)
        ...
        Dim Dstemp As DataSet
        Try
            Strselect = "SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where doctype_id = " & docTypeId
    ...
    Public Shared Function GetShowAndEditForms(ByVal docTypeId As Int64) As ZwebForm()
        ...
        Try
            ...
            Strselect = "SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where (type=1 or type=2) and doctype_id = " & docTypeId
    ...
    Public Shared Function GetForms(ByVal DocTypeId As Int64, ByVal FormType As FormTypes) As ZwebForm()
        ...
        Try
            ...
            If FormType = FormTypes.All Then
                    Strselect = "SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where doctype_id = " & DocTypeId
                Else
                Strselect = "SELECT ZFrms.Name, ZFrms.ParentId, ZFrms.Type, ZFrms.ObjectTypeId, ZFrms.Path, ZFrms.Description, ZFrms.UseRuleRights, ZFrms.Id, Ztype_Zfrms.DocType_Id, ZFrms.Updated, ZFrms.UseBlob FROM  ZFrms LEFT OUTER JOIN Ztype_Zfrms ON ZFrms.Id = Ztype_Zfrms.Form_Id where doctype_id = " & DocTypeId & " and Type = " & (FormType)
            End If
    ...
    Public Shared Function GetWFForms(ByVal WfStepId As Int32) As ZwebForm()
        Try
            ...
            For i = 0 To DsForms.ZViewForms.Count - 1
                Forms.SetValue(New ZwebForm(DsForms.ZViewForms(i).FORM_ID, DsForms.ZViewForms(i).NAME, DsForms.ZViewForms(i).DESCRIPTION, DsForms.ZViewForms(i).TYPE, DsForms.ZViewForms(i).OBJECTTYPEID, DsForms.ZViewForms(i).PATH, DsForms.ZViewForms(i).DOCTYPE_ID, Date.MinValue), i)
            Next
