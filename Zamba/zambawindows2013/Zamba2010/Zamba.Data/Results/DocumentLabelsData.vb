Public Class DocumentLabelsData
    ...
    Public Shared Function GetDocumentLabelsByUser(ByVal userId As Int64, ByVal docId As Int64) As DataSet
        Dim query As String = String.Format("  SELECT 'IMPORTANCE' as LABEL, COUNT(1) as FLAG FROM DocumentLabels WHERE userid = 0 AND docid = {1} AND importance = 1 UNION SELECT 'FAVORITE' as LABEL, COUNT(1) as FLAG FROM DocumentLabels WHERE userid = {0} AND docid = {1} AND favorite = 1", userId, docId)
