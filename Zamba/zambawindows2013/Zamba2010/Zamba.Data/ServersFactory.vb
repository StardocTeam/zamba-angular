...
Public Class ServersFactory
    ...
    Public Shared Function GetServerTypes() As List(Of String)
        ...
        'ServerTypes.AddRange([Enum].GetValues(GetType(DBTYPES)))
    ...
    Public Shared Function ConvertDate(ByVal pDate As String, Optional ByVal ResolveDate As Boolean = True) As String
        Return Server.Con.ConvertDate(pDate, ResolveDate) 'ResolveDate
    End Function
    ...
    Public Shared Function IsConnectionValid(ByVal intServerType As Int32, ByVal serverName As String, ByVal dataBase As String, ByVal conUser As String, ByVal conPass As String) As Int32
        ...
        If Server.isSQLServer Then
            d = Server.Con.ExecuteScalar(CommandType.Text, "select count(1) from sysobjects")
        Else
            d = Server.Con.ExecuteScalar(CommandType.Text, "select count(1) from user_objects")
        End If
