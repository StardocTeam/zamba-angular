...
Public Class CreateTablesFactory
    ...
    End Sub
    Public Shared Sub CreateSustitucionTable(ByVal Index As Integer, ByVal IndexLen As Int32, ByVal IndexType As Int32) 'Implements Servers.CreateTables.CreateSustitucionTable
        Server.CreateTables.CreateSustitucionTable(Index, IndexLen, IndexType)
    End Sub
