...
Public Class TemplatesFactory
    ...
    Public Shared Function GetTemplates() As DataSet
        ...
        Dim Strselect As String = "Select * from ztempl order by NAME ASC"
    ...
    Public Function ObtainTemplatePath(ByVal id As Int32) As String
        ...
        ds = Server.Con.ExecuteDataset(CommandType.Text, "SELECT PAth from ZTempl WHERE Id = " + id.ToString())
    ...
    Public Shared Function GetIdByName(ByVal name As String) As Int32

        Dim ds As New DataSet
        Dim id As Int32
        Try
            ds = Server.Con.ExecuteDataset(CommandType.Text, "SELECT id from ZTempl WHERE name = '" & name.ToString() & "'")
