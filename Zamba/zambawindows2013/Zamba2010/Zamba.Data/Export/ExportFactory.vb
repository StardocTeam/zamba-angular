...
Public Class ExportFactory
    'Public Shared Property UserPreferences As Object

    'private Shared Sub InsertIncomingMail(ByVal userId As Int64, ByVal codigo As String, ByVal DocTypeId As Int64)
    '    If Server.isOracle Then

    '        Dim ExisteCodigoExportado As Int64 = Server.Con.ExecuteScalar(CommandType.Text, "select count(*) from zexportcontrol WHERE codigo = CODIGO ")

    '        If IsDBNull(ExisteCodigoExportado) = False AndAlso ExisteCodigoExportado > 0 Then

    '            Server.Con.ExecuteNonQuery(CommandType.Text, "UPDATE ZExportControl set Fecha = sysdate , UserId = userId, Insertado = 'N' , codigo = CODIGO, doc_type_id = DOC_TYPE_ID where codigo=CODIGO")

    '        Else

    '            Server.Con.ExecuteNonQuery(CommandType.Text, "INSERT INTO ZExportControl(Fecha, UserId, Insertado, codigo, doc_type_id) VALUES (sysdate,USERID,'N',CODIGO,DOC_TYPE_ID)")
    ...
    ''' <remarks></remarks>
    'private Shared Sub SetMailInserted(ByVal codigo As String)
    '    If Server.isOracle Then

    '            Dim ActualizoMailInsertado As Int64 = Server.Con.ExecuteNonQuery(CommandType.Text,"Update ZExportControl set Insertado='S' where codigo= Codigo")            
    '     Else
    ...
    Private Shared Function InsertDocument(ByVal name As String, ByVal docTypeName As String, ByVal zambaLink As String) As Int64
    ...
    private Shared Function InsertDocument(ByVal name As String, ByVal docTypeName As String, ByVal zambaLink As String, ByRef t As Transaction) As Int64
        Dim QueryBuilder As New StringBuilder()
    ...
    private Shared Sub InsertIndex(ByVal exportId As Int64, ByVal indexName As String, ByVal indexTypeName As String, ByVal indexValue As String)
    ...
    private Shared Sub InsertIndex(ByVal exportId As Int64, ByVal indexName As String, ByVal indexTypeName As String, ByVal indexValue As String, ByRef t As Transaction)
