    ...
    Public Function execute(Optional ByVal GenerateScripts As Boolean = False) As Boolean Implements IPAQ.execute
        ...
        Try
            If GenerateScripts = False Then
                ...
                sqlBuilder.Append("INSERT INTO ZTaskStatus(StatusId, TaskStatus) VALUES(0,'Sin Verificar')")
                Server.Con.ExecuteNonQuery(CommandType.Text, sqlBuilder.ToString)
                sqlBuilder.Remove(0, sqlBuilder.Length - 1)
                sqlBuilder.Append("INSERT INTO ZTaskStatus(StatusId, TaskStatus) VALUES(1,'Aceptada')")
                Server.Con.ExecuteNonQuery(CommandType.Text, sqlBuilder.ToString)
                sqlBuilder.Remove(0, sqlBuilder.Length - 1)
