...
<RuleMainCategory("Archivos y Aplicaciones"), RuleCategory("Archivos"), RuleSubCategory("Validar archivo"), RuleDescription("Validar Archivo"), RuleHelp("Realiza una busqueda en el directorio indicado para comprobar si existe el archivo"), RuleFeatures(False)> _
Public Class IfFileExists
    Inherits WFRuleParent
    Implements IIfFileExists, IRuleIFPlay, IRuleValidate
    ...
    Private playRule As Zamba.WFExecution.PlayIfFileExists
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfstepid As Int64, ByVal searchPath As String, ByVal searchOption As Integer, ByVal textoInteligente As String)
        ...
        playRule = New WFExecution.PlayIfFileExists(Me)
    End Sub
