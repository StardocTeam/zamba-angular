...
<RuleMainCategory("Archivos y Aplicaciones"), RuleCategory("Archivos"), RuleSubCategory("Validar archivo"), RuleDescription("Validar Tamaño de Archivo"), RuleHelp("Comprueba el tamño del archivo para realizar una tarea determinada"), RuleFeatures(False)> _
Public Class IfFileSize
    Inherits WFRuleParent
    Implements IIfFileSize, IRuleIFPlay, IRuleValidate

    Private playRule As Zamba.WFExecution.PlayIfFileSize
...
#Region " Constructores "
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfstepid As Int64, ByVal comparador_ As Comparacion, ByVal path_ As String, ByVal num1_ As System.UInt32, ByVal num2_ As System.UInt32)
        ...
        Me.num1 = num1_
        Me.num2 = num2_
        Me.playRule = New WFExecution.PlayIfFileSize(Me)
    End Sub
#End Region
