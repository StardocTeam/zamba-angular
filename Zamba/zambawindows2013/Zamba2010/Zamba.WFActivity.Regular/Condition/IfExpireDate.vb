...
<RuleMainCategory("Tareas"), RuleCategory(""), RuleSubCategory(""), RuleDescription("Validar Vencimiento de Tarea"), RuleHelp("Comprueba en que fecha y hora vence la tarea"), RuleFeatures(False)> _
Public Class IfExpireDate
    Inherits WFRuleParent
    Implements IIfExpireDate, IRuleIFPlay, IRuleValidate
    ...
    Private playRule As Zamba.WFExecution.PlayIfExpireDate
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfstepid As Int64, ByVal Comparacion As Int32, ByVal Horas As Double)
        ...
        Comp = Comparacion
        dHoras = Horas
        playRule = New WFExecution.PlayIfExpireDate(Me)
    End Sub
