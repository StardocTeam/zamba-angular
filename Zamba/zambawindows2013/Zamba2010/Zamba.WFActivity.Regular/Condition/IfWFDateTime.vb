...
<RuleMainCategory("Workflow"), RuleCategory("Vencimientos"), RuleSubCategory(""), RuleDescription("Validar Fecha de Work Flow"), RuleHelp("Valida la Fecha y Hora del WorkFlow"), RuleFeatures(False)> _
Public Class IfWFDateTime
    Inherits WFRuleParent
    Implements IRuleIFPlay, IIfWFDateTime, IRuleValidate
    Private _isLoaded As Boolean
    Private _isFull As Boolean
    Private _isValid As Boolean
    Private playRule As Zamba.WFExecution.PlayIfWFDateTime
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfstepid As Int64)
        ...
        Me.playRule = New WFExecution.PlayIfWFDateTime(Me)
    End Sub
