...
<RuleMainCategory("Usuario"), RuleCategory("Validar"), RuleSubCategory(""), RuleDescription("Validar Usuario"), RuleHelp("Comprueba el usuario actual para poder tomar una determinada desición"), RuleFeatures(False)> _
Public Class IfUser
