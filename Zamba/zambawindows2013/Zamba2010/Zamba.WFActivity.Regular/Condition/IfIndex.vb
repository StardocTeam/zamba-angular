...
<RuleMainCategory("Atributos"), RuleCategory("Validar atributo"), RuleSubCategory(""), RuleDescription("Validar Atributo"), RuleHelp("Compara el o los atributos ingresados con una condición ingresada para poder tomar una desición determinada por el usuario"), RuleFeatures(False)> _
Public Class IfIndex
    Inherits WFRuleParent
    Implements IIfIndex, IRuleIFPlay, IRuleValidate
    Private _isLoaded As Boolean
    Private _isFull As Boolean
    Private _isValid As Boolean
    Private playRule As Zamba.WFExecution.PlayIfIndex
    ...
    '''' </history>
    '''' -----------------------------------------------------------------------------
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfstepid As Int64, ByVal Condiciones As String, ByVal Variable As String, ByVal OpAnd As Boolean)
        MyBase.New(Id, Name, wfstepid)
        Me.Condiciones = Condiciones
        Me.Variable = Variable
        OperatorAnd = OpAnd
        playRule = New Zamba.WFExecution.PlayIfIndex(Me)
    End Sub
...
#Region "Metodos Locales"
    ...
    Private Class IndexValue
        ...
        Private _Tipo As Zamba.IndexDataType = Nothing
        ...
        Public Function CompareTo(ByVal obj As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End Try
        End Function
        Public Property Tipo() As Zamba.IndexDataType
            Get
                Return _Tipo
            End Get
            Set(ByVal Value As Zamba.IndexDataType)
                _Tipo = Value
            End Set
        End Property
    End Class
