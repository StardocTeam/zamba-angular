...
<RuleCategory("Aplicaciones"), RuleDescription("Escribir en Excel"), RuleApproved("True"), RuleHelp("Genera un documento de excel a partir del tipo de documento seleccionado"), RuleFeatures(False)> <Serializable()>
Public Class DoWriteOnExcel
    Inherits WFRuleParent
    Implements IDoWriteOnExcel

    Private _playrule As Zamba.WFExecution.PlayDoWriteOnExcel
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfStepId As Int64, ByVal excelFile As String, ByVal excelData As String)
        ...
        _playrule = New Zamba.WFExecution.PlayDoWriteOnExcel(Me)
    ...
    Public Property ExcelData() As String Implements Core.IDoWriteOnExcel.ExcelData
        Get
    ...
    Public Property ExcelFile() As String Implements Core.IDoWriteOnExcel.ExcelFile
        Get
