...
<RuleMainCategory("Workflow"), RuleCategory(""), RuleSubCategory(""), RuleDescription("Diseñar Archivo Xoml"), RuleHelp("Permite diseñar un archivo Xoml."), RuleFeatures(True)> <Serializable()> _
