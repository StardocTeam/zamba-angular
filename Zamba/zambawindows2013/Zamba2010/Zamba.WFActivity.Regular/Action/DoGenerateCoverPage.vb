...
<RuleMainCategory("Archivos y Aplicaciones"), RuleCategory("Aplicaciones"), RuleSubCategory("Office"), RuleDescription("Generar Caratula"), RuleHelp("Genera una caratula a partir del documento seleccionado en la tarea"), RuleFeatures(True)> <Serializable()>
Public Class DoGenerateCoverPage
    ...
    Public Sub New(ByVal ruleID As Int64,
        ...
        playRule = New WFExecution.PlayDoGenerateCoverPage(Me)
    End Sub
