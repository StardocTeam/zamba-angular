...
<RuleMainCategory("Archivos y Aplicaciones"), RuleCategory("Aplicaciones"), RuleSubCategory("Web"), RuleDescription("Consumir un servicio WCF"), RuleHelp("Consume un servicio WCF especificando los valores de los parametros."), RuleFeatures(False)> <Serializable()> _
Public Class DoConsumeWCF
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal Wfstepid As Int64, ByVal methodName As String, ByVal wsdl As String, ByVal params As String, ByVal SaveInValue As String, ByVal badValue As String, ByVal UseCredentials As Boolean, ByVal Contract As String)
        ...
        _contract = Contract
        playRule = New Zamba.WFExecution.PlayDoConsumeWCF(Me)
    End Sub
