...
<RuleMainCategory("Mensajes, Mails y Foro"), RuleCategory("Mail"), RuleSubCategory(""), RuleDescription("Automail"), RuleHelp("Permite enviar un mail, preconfigurado o definido por el usuario, de forma automática al ejecutar la regla "), RuleFeatures(False)> <Serializable()> _
