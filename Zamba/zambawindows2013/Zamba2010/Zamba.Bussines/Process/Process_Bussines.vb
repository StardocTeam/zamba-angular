...
#Region "PostProcess"
    Public Shared Function PostProcess(ByVal Files As ArrayList, ByVal ProcessId As Int32) As ArrayList
        ...
        Try
            ZTrace.WriteLineIf(ZTrace.IsInfo, "Ruta XML: " & Application.StartupPath & "\postprocess.xml")
            If IO.File.Exists(Application.StartupPath & "\postprocess.xml") Then
                Dim ds As New DsPostProcess
                Try
                    ds.ReadXml(Application.StartupPath & "\postprocess.xml")
