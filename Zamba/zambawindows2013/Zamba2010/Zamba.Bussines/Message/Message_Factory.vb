...
Public Class Message_Factory
    ...
    Public Shared Sub SendMail(ByVal eMailType As MailTypes, _
                                    ...
                                    ByVal attachFileNames As Generic.List(Of String), _
                                    ...
                                    ByVal imagesToEmbedPaths As Generic.List(Of String), _
        ...
        ElseIf eMailType = MailTypes.LotusNotesMail Then
            Dim tempFileAttachList As New Generic.List(Of String)
    ...
    ''' </history>
    Private Shared Sub AddMailAddress(ByVal mail As String, ByRef mails As Generic.List(Of String))
    ...
    Private Shared Sub SendMailCom(ByVal Para As String, ByVal CC As String, ByVal CCO As String, ByVal Asunto As String, ByVal Body As String, ByVal isBodyHtml As Boolean, Optional ByVal AttachFileNames As Generic.List(Of String) = Nothing)

        Dim lstPara As New Generic.List(Of String)
        Dim lstCC As New Generic.List(Of String)
        Dim lstCCO As New Generic.List(Of String)
        ...
        Dim lstAttach As New Generic.List(Of String)
        If Not IsNothing(AttachFileNames) Then
    ...
    Private Shared Sub SendMailCom(ByVal Para As Generic.List(Of String), ByVal CC As String, ByVal CCO As String, ByVal Asunto As String, ByVal Body As String, ByVal isBodyHtml As Boolean, Optional ByVal AttachFileName As String = "")
