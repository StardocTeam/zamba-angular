...
Public Class ProcessFactory
    ...
    Public Shared Sub DelProcess(ByVal ProcessId As Integer)
        Try
            ...
            UserBusiness.Rights.SaveAction(ProcessId, ObjectTypes.ModuleImport, Zamba.Core.RightsType.Delete, "Eliminando proceso")
        Catch ex As Exception
    ...
    Public Shared Function Get_DocTypes() As ArrayList
        ...
        Dim dt As DataTable = DsDocType1.Tables("Doc_Type")
    ...
    Public Shared Function GetTempProcess(ByVal DsProcess As DSIpType, ByVal Index As Int32) As Process
        ...
        DocType = DocTypesBusiness.GetDocType(CInt(DsProcess.IP_TYPE(Index).IP_DOCTYPEID), True)
