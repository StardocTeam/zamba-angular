...
Public Class RemoteInsert
    ...
    Public Function Insert(ByVal name As String, ByVal binaryDocument As Byte(), ByVal fileExtension As String, ByVal docTypeId As Int64, ByVal indexs As DataTable, ByVal DontOpenTaskAfterInsertInDoGenerateCoverPage As Boolean) As Int64
        Return Results_Business.Insert(name, binaryDocument, fileExtension, docTypeId, indexs, DontOpenTaskAfterInsertInDoGenerateCoverPage, Nothing)
    End Function
        ...
        Try
            ...
            If Not IsNothing(ds) Then
                ...
                For Each dr As DataRow In ds.Tables(0).Rows
                    ...
                    UserBusiness.Rights.SaveAction(docTypeId, ObjectTypes.Index, Zamba.Core.RightsType.Edit, docTypeId)
                Next
            Else
