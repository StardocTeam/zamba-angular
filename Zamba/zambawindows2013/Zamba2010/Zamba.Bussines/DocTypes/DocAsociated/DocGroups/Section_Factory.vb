...
Public Class Section_Factory
    ...
    ''' </summary>
    ''' <param name="Orden">Posicion, de base cero, que indicará el orden para mostrar el o los Tipos de documentos</param>
    ''' <param name="DocTypeId">ID del Tipo de documento que se desea asignar</param>
    ''' <param name="DocGroupId">ID del Archivo(Sector) al que se le asignará el Tipo de Documento</param>
    ''' <remarks></remarks>
