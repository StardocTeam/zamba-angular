...
''' <summary>
''' Contiene métodos relacionados al manejo de archivos
''' </summary>
''' <remarks></remarks>
Public Class FileBusiness
    ...
    ''' <summary>
    ''' Quita los caracteres inválidos en el nombre de archivos
    ''' </summary>
    ''' <param name="fileName">Nombre del archivo sin validar</param>
    ''' <returns>Nombre del archivo válido</returns>
    ''' <remarks></remarks>
    Public Shared Function RemoveInvalidFileChars(ByVal fileName As String) As String
    ...
    ''' <summary>
    ''' Quita los caracteres inválidos en el nombre de carpetas
    ''' </summary>
    ''' <param name="pathName">Nombre de carpeta sin validar</param>
    ''' <returns>Nombre de carpeta válida</returns>
    ''' <remarks></remarks>
    Public Shared Function RemoveInvalidPathChars(ByVal pathName As String) As String
        'Se remueven los caracteres inválidos del nombre del archivo
        For Each invalidChar As Char In IO.Path.GetInvalidPathChars()
            pathName = pathName.Replace(invalidChar, String.Empty)
        Next
    ...
    ''' <param name="min">Número mínimo para el nombre del archivo</param>
    ''' <param name="max">Número máximo para el nombre del archivo</param>
    Public Shared Function GenerateRandomFileName(Optional ByVal ext As String = "",
                                                  Optional ByVal min As Integer = 10000000,
                                                  Optional ByVal max As Integer = 99999999) As String
        Dim rand As New Random(Now.Millisecond)
        Dim fileName As String = rand.Next(min, max).ToString & ext
        rand = Nothing
        Return fileName
    End Function
End Class
