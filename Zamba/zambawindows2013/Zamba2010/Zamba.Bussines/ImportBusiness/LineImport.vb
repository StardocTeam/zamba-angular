    ...
    Private Function CreateResult() As Boolean
        Try
            If IsNothing(Result) Then
                Me.Result = Zamba.Core.Results_Business.GetNewNewResult(Process.DocType, Process.UserId)
            ...
            For i = 0 To MultipleFiles.Count - 1
                ...
                If Result.File.Trim <> "" Then
                    ...
                    If Process.type <> ProcessTypes.Test Then
                        Resultado = Results_Business.InsertDocument(Result, Process.Move, False, Me.Process.Replace, Process.AskConfirmations)
                    Else
