...
#Region "Startprocess"
    ...
    Private Function CreateDocument() As Boolean
        Try
            If IsNothing(Document) Then Document = Results_Business.GetNewNewResult(Me.Process.DocType)
                    ...
                    If Document.File.Trim <> "" Then
                        Try
                            ...
                            If Process.type <> ProcessTypes.Test Then
                                Document.ID = 0
                                Result = Results_Business.InsertDocument(Document, False, False, Me.Process.Replace, Process.AskConfirmations)
            ...
            Else
                Try
                    ...
                    If Process.type <> ProcessTypes.Test Then
                        ...
                        Result = Results_Business.InsertDocument(Document, False, False, Me.Process.Replace, Process.AskConfirmations, isVirtual)
