...
Public Class GenericButtonBusiness
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetRuleButtons(ByVal place As ButtonPlace, usecache As Boolean, ByVal wfId As Int64) As DataTable
        SyncLock (Cache.Workflows.HsDynamicbuttonsByWorkflowId)
            If useCache Then
                If Not Cache.Workflows.HsDynamicbuttonsByWorkflowId.ContainsKey(place & "-" & wfid) Then
                    Cache.Workflows.HsDynamicbuttonsByWorkflowId.Add(place & "-" & wfid, GenericButtonFactory.GetRuleButtons(place, wfId))
                End If
                Return Cache.Workflows.HsDynamicbuttonsByWorkflowId(place & "-" & wfid)
            Else
    ...
    Public Shared Function GetZbuttonsAndGroups() As DataTable
        Return GenericButtonFactory.GetZbuttonsAndGroups()
    End Function


    Public Shared Function InsertZbuttonClassRule(ByVal idRule As Integer, ByVal idClass As Integer)
        GenericButtonFactory.InsertZbuttonClassRule(idRule, idClass)
    End Function
    ''' <summary>
    ...
    Public Shared Function SetNewZButtonsAndGroups(text As String, v As Integer)
        GenericButtonFactory.SetNewZButtonsAndGroups(text, v)
    End Function
