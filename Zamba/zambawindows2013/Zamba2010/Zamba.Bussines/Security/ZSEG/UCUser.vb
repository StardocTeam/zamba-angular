...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label1.Font = Zamba.AppBlock.ZambaUIHelpers.GetFontFamily()
...
#End Region
    ...
    Private Sub LoadUsers()
        Try
            If Me.FlagEspecific = False Then
                Users.Clear()
                Users = UserBusiness.GetUsersArrayList
    ...
    Private Sub LoadUsers(ByVal ObjectId As Integer, ByVal ObjectType As ObjectTypes, ByVal RightType As Zamba.Core.RightsType, ByVal Value As Boolean)
        Try
