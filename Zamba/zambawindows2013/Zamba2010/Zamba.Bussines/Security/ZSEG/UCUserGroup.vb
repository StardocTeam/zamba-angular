...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label1.Font = AppBlock.ZambaUIHelpers.GetFontFamily()
...
#End Region
    ...
    Private Sub LoadUserGroups()
        UserGroups.Clear()
        UserGroups = Zamba.Core.UserGroupBusiness.GetAllGroupsArrayList
        Try
            Dim i As Int32
    ...
    Private Sub LoadUserGroups(ByVal ObjectId As Integer, ByVal ObjectType As ObjectTypes, ByVal RightType As Zamba.Core.RightsType, ByVal Value As Boolean)
        Try
    ...
    Public Sub New(ByVal ObjectId As Integer, ByVal ObjectType As ObjectTypes, ByVal RightType As Zamba.Core.RightsType, ByVal Value As Boolean)
        Me.New()
