...
#Region "Metodos Privados"
    Private ReadOnly Property GroupRights() As dsGroupRights
        Get
            If _DsGroupRights Is Nothing Then
                ...
                Me._DsGroupRights = New dsGroupRights

                ds.Tables(0).TableName = _DsGroupRights.usr_rights.TableName
                _DsGroupRights.Merge(ds)
            End If
            Return _DsGroupRights
        End Get
    End Property
    Private Function GetRows(ByVal id As Integer, ByVal ObjectId As ObjectTypes, ByVal RType As Zamba.Core.RightsType, Optional ByVal AditionalParam As Integer = -1) As dsGroupRights.usr_rightsRow()
        Return Me.GroupRights.usr_rights.Select("GROUPID=" & id & " and OBJID=" & ObjectId & " and RTYPE=" & RType & " and ADITIONAL=" & AditionalParam)
    End Function
