...
Public Class frmAbmSections
    ...
    Private Const CONS_HELP_MSJ As String = "Permite Agregar, Modificar y eliminar secciones, las mismas son utilizadas para ubicar atributos en formularios dinámicos"
    ...
    Private Sub LoadData()
        Try
            ...
            If ds Is Nothing Then
                ...
                ds.Tables(0).Columns.Add(COL_NOMBRE)
                ds.Tables(0).Columns.Add(COL_IDSECCION)
                ds.AcceptChanges()
            End If
            dgrvSectionList.DataSource = ds.Tables(0)
            dgrvSectionList.Columns(COL_NOMBRE).HeaderText = "Nombre"
            dgrvSectionList.Columns(COL_IDSECCION).HeaderText = "ID Seccion"
    ...
    Private Sub frmAbmSections_Load(ByVal sender As System.Object, ByVal e As EventArgs) Handles MyBase.Load
        LoadData()
    End Sub
    ...
    Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles btnRemove.Click
        If dgrvSectionList.SelectedRows.Count = 1 Then
            Try
                If MessageBox.Show(MSG_TEXT_REMOVE, MSG_TEXT_REMOVE, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub btnAcept_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles btnAcept.Click
        ...
        If flagEditModeON Then
            ...
            End If
        Else
            If MessageBox.Show(MSG_TEXT_SAVE_QUESTION, MSG_TITLE_SAVE, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                For Each row As DataGridViewRow In rows
                    Try
                        ...
                        End If
                    Catch ex As Exception
                        MessageBox.Show(String.Format(MSG_TEXT_ERROR_SAVE, nombre), MSG_TITLE_ERROR_SAVE,
                ...
                Next
                If isError Then
                    MessageBox.Show(MSG_TEXT_ERROR_ACEPTAR, MSG_ATENCION_TITLE,
                                    MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Else
    ...
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles btnCancel.Click
        If flagEditModeON Then
            If MessageBox.Show(MSG_TEXT_ANULARCAMBIOS, MSG_TITLE_ANULARCAMBIOS, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                EnableControls(True)
                flagEditModeON = False
            End If
        Else
            If MessageBox.Show(MSG_TEXT_CANCEL, MSG_TITLE_CANCEL, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
...
#End Region
    ...
    Private Sub frmAbmSections_HelpButtonClicked(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.HelpButtonClicked
        Help.ShowPopup(btnAdd, CONS_HELP_MSJ, New Point(Location.X + btnAdd.Location.X, Location.Y + btnAdd.Location.Y))
    End Sub
    ...
    Private Sub dgrvSectionList_SelectionChanged(ByVal sender As System.Object, ByVal e As EventArgs) Handles dgrvSectionList.SelectionChanged
