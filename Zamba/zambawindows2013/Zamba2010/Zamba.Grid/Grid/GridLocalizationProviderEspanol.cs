...
{
    class GridLocalizationProviderEspanol : RadGridLocalizationProvider
    {
        public override string GetLocalizedString(string id)
        {
            switch (id)
            {
                ...
                case RadGridStringId.ColumnChooserFormMessage:
                    return "Para ocultar una columna," + System.Environment.NewLine + "" + System.Environment.NewLine + " arrastre hacia esta ventana.";
                ...
                case RadGridStringId.GroupingPanelDefaultMessage:
                    return "Arrastre aquí las columnas para agrupar";
