...
{
    public class SpanishRadGridLocalizationProvider : RadGridLocalizationProvider
    {
        public override string GetLocalizedString(string id)
        {
            switch (id)
            {
                case RadGridStringId.AddNewRowString: return "Clic aquí para agregar una fila";
                ...
                case RadGridStringId.ColumnChooserFormMessage:
                    return "Para ocultar una columna, arrastre hacia esta ventana.";
