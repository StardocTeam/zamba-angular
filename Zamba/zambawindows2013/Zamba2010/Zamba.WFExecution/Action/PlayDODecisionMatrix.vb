...
Public Class PlayDODecisionMatrix
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult)) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        MatrixEntity = DocTypeBusinessExt.GetDocTypeByID(_myRule.EntityId)
        MatrixEntity.Indexs = IndexsBusiness.GetIndexsSchemaAsListOfDT(_myRule.EntityId, True)
        Try
            For Each R As ITaskResult In results
                ...
                If value IsNot Nothing Then
                    ...
                    If VariablesInterReglas.ContainsKey(_myRule.OutputVariable) = False Then
                        VariablesInterReglas.Add(_myRule.OutputVariable, value.ToString, False)
                    Else
