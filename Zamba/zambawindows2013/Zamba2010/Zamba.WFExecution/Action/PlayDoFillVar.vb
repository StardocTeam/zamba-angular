    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult)) As System.Collections.Generic.List(Of Core.ITaskResult)
        Try
            ...
            For Each r As TaskResult In results
                ...
                newMessage = WFRuleParent.ReconocerVariablesValuesSoloTexto(_myRule.variableValue)
                ...
                ZTrace.WriteLineIf(ZTrace.IsInfo, "Verificando si el nombre de la variable se encuentra en la colección VariablesInterReglas (" & Me._myRule.variableName & ")")
                    _variableName = WFRuleParent.ReconocerVariablesValuesSoloTexto(_myRule.variableName)
                ...
                If _myRule.useConc = False Then

                    If TextoInteligente.AsignItemFromSmartText(WFRuleParent.ReconocerVariablesValuesSoloTexto(_myRule.variableName), r, newMessage) = False Then

                        If (VariablesInterReglas.ContainsKey(_variableName) = False) Then
                            VariablesInterReglas.Add(_variableName, newMessage, False)
