...
Public Class PlayDoChangeState
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult)) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            Steps = WFStepBusiness.GetStepById(_myRule.StepId)
            If Not Steps Is Nothing Then
                If Steps.States.Contains(New WFStepState(_myRule.StateId)) Then

                    state = WFStepStatesComponent.getStateFromList(_myRule.StateId, Steps.States)
