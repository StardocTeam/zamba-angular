...
namespace Stardoc.HtmlEditor
{
    ...
    /// <summary>
    /// Struct used to define _frmRules Html Font
    ...
    public struct HtmlFontProperty
    {
        ...
        // constructor given _frmRules system Font
        ...
        // public method to convert the html into _frmRules readable format
        ...
        // based on _frmRules font name being null the font can be assumed to be null
        // default constructor will give _frmRules null object
    ...
    public class HtmlFontConversion
    {
        ...
        // return the correct string size description from _frmRules HtmlFontSize
        ...
        // determine the font size given _frmRules selected font in points
        ...
        // Used to determine the HtmlFontSize from _frmRules style attribute
        public static HtmlFontSize StyleSizeToHtml(string sizeDesc)
        {
            // currently assume the value is _frmRules fixed point
            ...
            // return value as _frmRules HtmlFontSize
    ...
    public class HtmlFontPropertyConverter : ExpandableObjectConverter
    {
        ...
        {
            // always return _frmRules new instance
            return true;

        } //GetCreateInstanceSupported

        // creates _frmRules new HtmlFontProperty from _frmRules series of values
        ...
        // Indicates if _frmRules conversion can take place from _frmRules HtmlFontProperty
        ...
        // Performs the conversion from HtmlFontProperty to _frmRules string (only)
        ...
        // Indicates if _frmRules conversion can take place from s string
        ...
        // Performs the conversion from string to _frmRules HtmlFontProperty (only)
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            if (value is string)
            {
                // define _frmRules new font property
                string fontString = (string)value;
                HtmlFontProperty font = new HtmlFontProperty(string.Empty); ;
                try
                {
                    // parse the contents of the given string using _frmRules regex
                ...
                {
                    // do nothing but ensure font is _frmRules null font
