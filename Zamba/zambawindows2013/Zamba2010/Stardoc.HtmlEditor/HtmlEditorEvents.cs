...
namespace Stardoc.HtmlEditor
{
    ...
    // on _frmRules user initiated navigation create an event with the following EventArgs
    ...
    public class HtmlNavigationEventArgs : EventArgs
    {
        ...
        // also allows _frmRules set operation
        public bool Cancel
        {
            get
            {
    ...
    public class HtmlEditorException : ApplicationException
    {
        ...
        // Constructor accepting _frmRules single string message
        ...
        // Constructor accepting _frmRules string message and an inner exception
        ...
        // Constructor accepting _frmRules single string message and an operation name
        ...
        // Constructor accepting _frmRules string message an operation and an inner exception
        public HtmlEditorException(string message, string operation, Exception inner)
            : base(message, inner)
        {
            _operationName = operation;
        }
