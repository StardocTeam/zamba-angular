...
namespace Stardoc.HtmlEditor.COM
{
	...
	// _frmRules class defined for constant defintions realting to COM interop
...
namespace Stardoc.HtmlEditor.COM.IOleCommandTarget
{
