...
namespace Microsoft.ConsultingServices
{
        ...
        : Form
    {
        ...
        public VirtualFormsBuilder(Dictionary<Int64, String> docTypes)
            :this()
        {
        ...
        /// </summary>
        private void InitializeComponent(Dictionary<Int64, String> docTypes)
        {
            ...
            this.UcControlList = new Stardoc.HtmlEditor.HtmlControlsList(docTypes);
