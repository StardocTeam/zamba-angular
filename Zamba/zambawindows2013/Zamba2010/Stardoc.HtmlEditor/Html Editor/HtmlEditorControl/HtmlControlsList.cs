            ...
            foreach (IHtmlElement CurrentElement in elements)
            {
                switch (CurrentElement.Type)
                {
                    case HtmlControlType.CheckBox:
                        ...
                        {
                            ListViewItems.ZCheckBox Item = new ListViewItems.ZCheckBox(0, CurrentElement.ToString(), (ZCheckBoxItem)CurrentElement);
                            Item.Group = GetItemGroup(HtmlControlType.CheckBox);
                            lvControls.Items.Add(Item);
                        }
                    ...
                    case HtmlControlType.Select:
                        ...
                        {
                            ZSelect SelectItem = new ZSelect(0, CurrentElement.ToString(), (ZSelectItem)CurrentElement);
                    ...
                    case HtmlControlType.TextArea:
                        ...
                        {
                            ZTextArea TextAreaItem = new ZTextArea(0, CurrentElement.ToString(), (ZTextAreaItem)CurrentElement);
                    ...
                    case HtmlControlType.RadioButton:
                        ...
                        {
                            ListViewItems.ZRadioButton RadioItem = new ListViewItems.ZRadioButton(0, CurrentElement.ToString(), (ZRadioButtonItem)CurrentElement);
                    ...
                    case HtmlControlType.TextBox:
                        ...
                        {
                            ListViewItems.ZTextBox TextBoxItem = new ListViewItems.ZTextBox(0, CurrentElement.ToString(), (ZTextBoxItem)CurrentElement);
