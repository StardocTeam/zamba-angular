...
{
    #region Atributos
    protected HtmlFormState _state = HtmlFormState.Insert;
    #endregion
    ...
    public RadioButtonItem Radio
    {
        get
        {
            return new RadioButtonItem(tbName.Text, tbCategory.Text, chkChecked.Checked, chkEnabled.Checked, chkRequired.Checked);
        }
        set
        {
