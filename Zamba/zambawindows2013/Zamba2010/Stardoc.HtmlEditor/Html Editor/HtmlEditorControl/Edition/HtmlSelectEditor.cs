...
{
    #region Constatens
    protected const String TITLE_STATE_VIEW = "Resumen elemento SELECT";
    protected const String TITLE_STATE_UPDATE = "Edicion elemento SELECT";
    protected const String TITLE_STATE_INSERT = "Creacion elemento SELECT";
    #endregion

    #region Atributos
    protected List<OptionItem> _options;
    ...
    public SelectItem SelectItem
    {
        get
        {
            return new SelectItem(_options, chkEnabled.Checked, chkRequired.Checked);
        }
        set
        {
    ...
    protected void ValidateDefault(Int32 editedIndex)
    {
