        ...
        partial class ExcelWrapper
        {
            ...
            protected override void Dispose(bool disposing)
            {
                ...
                try
                {
                    ...
                    {
                        OpenExcelFileDialog.Dispose();
                        OpenExcelFileDialog = null;
                    }
                    if (m_Workbook != null)
                    {
                    ...
                    if (m_StandardCommandBar != null)
                    {
                        System.Runtime.InteropServices.Marshal.ReleaseComObject(m_StandardCommandBar);
                        m_StandardCommandBar = null;
                    }
                    if (WebBrowserExcel != null && !WebBrowserExcel.Disposing)
                    {
                        WebBrowserExcel.Dispose();
                        WebBrowserExcel = null;
                    }
