Public Interface IFilterElem
    ...
    ''' <returns></returns>
    ''' <remarks>La razón de que primero se remueven los espacios entre las comas y luego las comillas simples
    ...
    '' valor a filtrar queda definido) y luego se agregan las comillas simples entre los valores.</remarks>
