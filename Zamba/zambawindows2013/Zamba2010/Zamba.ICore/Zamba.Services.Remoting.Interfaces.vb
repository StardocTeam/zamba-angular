...
Public Interface IAutoCompleteBarcode_Factory
    Function GetComplete(ByVal docTypeId As Int64, ByVal IndexId As Int32) As IZClass
End Interface
...
Public Interface IDocTypesBusiness
    Function GetDocTypesbyUserRightsOfView(ByVal UserId As Long, ByVal RightType As RightsType) As ArrayList
...
Public Interface IUserPreferences
    ...
    'void setValue( string name , string valor , Sections Section )
    Sub setValue(ByVal name As String, ByVal valor As String, ByVal Section As UPSections)
    'string getValue(string name, Sections Section, object DefaultValue)
...
Public Interface IZCore
    Function FilterIndex(ByVal docTypeId As Int64) As ArrayList
End Interface
