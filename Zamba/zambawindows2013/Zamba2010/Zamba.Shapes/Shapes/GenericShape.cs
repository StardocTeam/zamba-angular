...
namespace Zamba.Diagrams.Shapes
{
    ...
    /// </summary>
  public   class GenericShape : ShapeNode, IShape,  IDisposable
    {
        #region Properties
        ...
        /// <summary>
        /// Especifica si es un nodo raiz del diagrama
        /// </summary>
            ...
            : base(diagram)
        {
            ...
            if (parentNode != null)
            {
                ...
                this.Font = new System.Drawing.Font("Microsoft Sans Serif", 8);
