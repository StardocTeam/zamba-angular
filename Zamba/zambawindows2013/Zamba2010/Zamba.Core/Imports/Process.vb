...
#Region " Atributos "
    ...
    Private _dsProcessIndex As New DataSet
...
#Region " Propiedades "
    ...
    Public Property AskConfirmations() As Boolean Implements IProcess.AskConfirmations
        ...
        End Set
    End Property
    Public Property DsProcessIndex() As DataSet Implements IProcess.DsProcessIndex
        Get
