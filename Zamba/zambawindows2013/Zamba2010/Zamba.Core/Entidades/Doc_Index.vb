...
#End Region
    ...
    Public Sub FillIndexData(ByVal index2 As DataRow) Implements IDoc_Index1.FillIndexData
        ...
        Id = Convert.ToInt32(index("INDEX_ID"))
        Name = index("INDEX_NAME")
        Type = DirectCast(Int32.Parse(index("INDEX_TYPE")), IndexDataType)
        Len = Convert.ToInt32(index("INDEX_LEN"))
        DropDown = DirectCast(Convert.ToInt32(index("DROPDOWN")), IndexAdditionalType)

        AutoFill = Convert.ToBoolean(Convert.ToInt32(index("AUTOFILL")))
        'If AutoFill = True Then AutoFill1 = 1 Else AutoFill1 = 0
        NoIndex = Convert.ToBoolean(Convert.ToInt32(index("NOINDEX")))
        'If NoIndex = True Then NoIndex1 = 1 Else NoIndex1 = 0
        AutoDisplay = Convert.ToBoolean(Convert.ToInt32(index("AUTODISPLAY")))
        'If AutoDisplay = True Then AutoDisplay1 = 1 Else AutoDisplay1 = 0
        Invisible = Convert.ToBoolean(Convert.ToInt32(index("INVISIBLE")))
        'If Invisible = True Then Invisible1 = 1 Else Invisible1 = 0
    End Sub
End Class
