...
Public Class DocType
    Inherits ZambaCore
    Implements IDocType, ICloneable, IDisposable
...
#Region "Propiedades"
    ...
    '    Try
    '        Icons = New DocTypeIcons
    '    Catch ex As Exception
    '        zamba.core.zclass.raiseerror(ex)
    '    End Try
    'End Sub
    'Public Sub AsignDocTypeIcon(ByVal IconId As Int32)
    '    IconId = IconId
    'End Sub
    'Public Sub AddDocTypeIcon(ByVal IconFile As String, ByVal Description As String)
    '    Icons.AddIcon(IconFile, Description)
    'End Sub
...
#Region "Constructores"
    ...
    Public Sub New(ByVal id As Integer, ByVal name As String, ByVal iconId As Int32)
        ...
        Me.IconId = iconId
    End Sub
    Public Sub New(ByVal id As Integer, ByVal name As String, ByVal fileFormatId As Integer, ByVal diskGroupId As Integer, ByVal thumbnails As Integer, ByVal iconId As Integer, ByVal objectTypeId As Integer, ByVal autoNameCode As String, ByVal autoNameText As String, ByVal docCount As Int32, ByVal docTypeGroupId As Int32, ByVal documentalId As Int32)
    ...
    Protected Overridable Overloads Sub Dispose(ByVal disposing As Boolean)
        ...
        If Not _disposed Then
            If disposing Then
                ...
                If Not IsNothing(_IndexDefaultValues) Then
                    For i = 0 To _IndexDefaultValues.Count - 1
                        _IndexDefaultValues(i) = Nothing
                    Next
                    _IndexDefaultValues.Clear()
                End If
            End If
