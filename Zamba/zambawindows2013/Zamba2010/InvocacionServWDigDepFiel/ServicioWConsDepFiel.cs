...
namespace InvocacionServWConsDepFiel
{
    public class ServicioWConsDepFiel
    {
        ...
        public ListaEstadoResponse InvocarServicioListaEstadoRequestRequest(Autenticacion autenticacion,
                                      string nroLegajo,
                                      string cuitPSAD,
                                      string codigo,
                                      string ticket,
                                      ...
                                      )
        {
            try
            {
                ...
                listaEstadoRequest.Body.argAutentica = autenticacion;// CrearAutenticacion(autenticacion.Cuit, autenticacion.Rol, autenticacion.Sign, autenticacion.TipoAgente, autenticacion.Token);

                var wConsDepFielSoapClient = new wConsDepFielSoapClient("wConsDepFielSoap");
        ...
        public PndListaEndoResponse InvocarServicioPndListaEndoRequest(Autenticacion autenticacion,                                    
                                     string cuitPSAD,
                                     string codigo,
                                     DateTime FechaDesde,
                                     DateTime FechaHasta
                                     )
        {
            try
            {
                PndListaEndoRequest PndListaEndoRequest = new PndListaEndoRequest();

                PndListaEndoRequest.Body = new PndListaEndoRequestBody();


                PndListaEndoRequest.Body = CrearPndListaEndoRequestBody(autenticacion, codigo, cuitPSAD, FechaDesde, FechaHasta);

                PndListaEndoRequest.Body.argAutentica = autenticacion;// CrearAutenticacion(autenticacion.Cuit, autenticacion.Rol, autenticacion.Sign, autenticacion.TipoAgente, autenticacion.Token);
                ...
                var newlistaEstadoRequest = JsonConvert.SerializeObject(PndListaEndoRequest, Newtonsoft.Json.Formatting.Indented,
                    new JsonSerializerSettings
                    {
                        PreserveReferencesHandling = PreserveReferencesHandling.Objects
                    });

                ZTrace.WriteLineIf(ZTrace.IsVerbose, "Request: ");
                ZTrace.WriteLineIf(ZTrace.IsVerbose, newlistaEstadoRequest);
                }
                catch (Exception)
                {
                }

                PndListaEndoResponse ListaEndoResponse = GetPndListaEndoResponse(PndListaEndoRequest, wConsDepFielSoap);
                ...
                var ListaEndoResponseString = JsonConvert.SerializeObject(ListaEndoResponse, Newtonsoft.Json.Formatting.Indented,
                    new JsonSerializerSettings
                    {
                        PreserveReferencesHandling = PreserveReferencesHandling.Objects
                    });
                ZTrace.WriteLineIf(ZTrace.IsVerbose, "Response: ");
                ZTrace.WriteLineIf(ZTrace.IsVerbose, ListaEndoResponseString);
                }
                catch (Exception)
                {
                }

                return ListaEndoResponse;
        ...
        public PndListaEndoRequestBody CrearPndListaEndoRequestBody(Autenticacion autenticacion,string codigo, string cuitPSAD, DateTime FechaDesde, DateTime FechaHasta)
        {
            ValidarCUITPSAD(autenticacion, cuitPSAD);
            ValidarCodigo(codigo);

            var PndListaEndoRequestBody = new PndListaEndoRequestBody();
            InPndListaEndo InPndListaEndo = new InPndListaEndo();
            InPndListaEndo.CuitDeclarante = cuitPSAD;
            InPndListaEndo.CodigoCarpeta = codigo;
            InPndListaEndo.FechaDesde = FechaDesde;
            InPndListaEndo.FechaHasta = FechaHasta;
            
            PndListaEndoRequestBody.argInPndListaEndo = InPndListaEndo;

            return PndListaEndoRequestBody;
        }
        ...
        public  Task<ListaEstadoResponse> GetListaEstadoResponse(ListaEstadoRequest listaEstadoRequest, wConsDepFielSoap wConsDepFielSoap)
        {
            ServicePointManager.ServerCertificateValidationCallback = new System.Net.Security.RemoteCertificateValidationCallback(AcceptAllCertifications);
            return  wConsDepFielSoap.ListaEstadoAsync(listaEstadoRequest);
        }

        public PndListaEndoResponse GetPndListaEndoResponse(PndListaEndoRequest PndListaEndoRequest, wConsDepFielSoap wConsDepFielSoap)
        {
            ServicePointManager.ServerCertificateValidationCallback = new System.Net.Security.RemoteCertificateValidationCallback(AcceptAllCertifications);
            PndListaEndoResponse response =  wConsDepFielSoap.PndListaEndo(PndListaEndoRequest);
            return response;
        }
