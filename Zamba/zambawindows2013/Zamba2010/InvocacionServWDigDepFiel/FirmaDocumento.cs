...
namespace InvocacionServWDigDepFiel
{
    ...
    public static class FirmaDocumento
    {
        ...
        public static X509Certificate2 ObtenerCertificadoPorSerialNumber(string serialNumber, string storeName)
        {
            if (serialNumber == string.Empty)
                throw new Exception("serialNumber Invalido");
            ...
            var fcollection = collection.Find(X509FindType.FindBySerialNumber,
                serialNumber, false);
