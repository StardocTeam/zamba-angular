...
namespace Zamba.DataWS.WSResults {
    using System;
    ...
    public partial class Results : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Results() {
            this.Url = global::Zamba.DataWS.Properties.Settings.Default.Zamba_DataWS_WSResults_Results;
        ...
        public bool SaveMessageFileBlob(string url, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] file) {
