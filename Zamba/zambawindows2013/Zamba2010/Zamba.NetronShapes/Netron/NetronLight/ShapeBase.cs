...
namespace Zamba.Shapes.NetronLight
{
    ...
    public class ShapeBase : Entity
    {
        ...
        private void SetBrush()
        {
            ...
            {
                System.Drawing.Color newcolor = System.Drawing.Color.FromArgb(128, shapeColor);
                shapeBrush = new SolidBrush(newcolor);
            }
            else
            {
                System.Drawing.Color newcolor = System.Drawing.Color.FromArgb(255, shapeColor);
                shapeBrush = new SolidBrush(newcolor);
            }
        }
