...
#Region "Eventos"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frmAddOrUpdateTemplate_Load(ByVal sender As System.Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnAddOrUpdate_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles btnAddOrUpdate.Click
        addOrUpdateTemplate()
    End Sub
...
#Region "Eventos de Validación"
    ...
    Private Sub txtPath_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtPath.Validating
        ...
        If (controllerErrorInPath = False) Then
            executeErrorProvider(txtPath, "Debe especificar un template", ErrorProvider1)
        End If
    ...
    Private Sub txtName_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtName.Validating
        executeErrorProvider(txtName, "Debe especificar un nombre", ErrorProvider2)
    End Sub
    ...
    Private Sub txtDescription_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtDescription.Validating
        executeErrorProvider(txtDescription, "Debe especificar una descripción", ErrorProvider3)
    End Sub
    ...
    Private Sub txtName_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyUp, txtDescription.KeyUp
        ...
        If (txtPath.Text = "") Then
            ErrorProvider1.SetError(txtPath, "Debe especificar un template válido")
        End If
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub txtName_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles txtName.Click, txtDescription.Click
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub txtPath_TextChanged(ByVal sender As System.Object, ByVal e As EventArgs) Handles txtPath.TextChanged, txtName.TextChanged, txtDescription.TextChanged
...
#Region "Métodos"
    ...
    Private Sub addOrUpdateTemplate()
        ...
        Try
            ...
            If (verifyIfThePathExists() = True) Then
                ...
                mPath = txtPath.Text.Trim()
                mName = txtName.Text.Trim()
                mDescription = txtDescription.Text.Trim()
    ...
    ''' <remarks></remarks>
    Private Sub executeErrorProvider(ByRef textbox As TextBox, ByRef message As String, ByRef errorProvider As System.Windows.Forms.ErrorProvider)
    ...
    Private Function verifyIfThePathExists() As Boolean
        ...
        Dim Fi As New IO.FileInfo(txtPath.Text.Trim)

        ' Si el archivo no existe
        If Fi.Exists = False Then
            ErrorProvider1.SetError(txtPath, "Camino inválido o archivo inexistente")
            Return False
        Else
