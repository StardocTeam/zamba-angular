...
#Region "Constructores"
    ...
    Public Sub New(ByVal _typeId As GroupToNotifyTypes, ByVal MsgId As Int64, ByVal participantIds As Generic.List(Of Int64))
        InitializeComponent()
        TypeId = _typeId
        Me.msgId = MsgId
...
#Region "Eventos"
    ...
    Public Sub Aceptar()
        ...
        For Each user As IUser In lstSelectedUsers.Items
            notifyIds.Add(user.ID)
        Next
        For Each group As IUserGroup In lstSelectedGroups.Items
            notifyIds.Add(group.ID)
        Next
