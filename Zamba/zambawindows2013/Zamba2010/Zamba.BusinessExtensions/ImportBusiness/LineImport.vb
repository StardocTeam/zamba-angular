Public Class LineImport
    ...
    Private Function CreateResult() As Boolean
        Try
            If IsNothing(Result) Then
                ...
                Result = RB.GetNewNewResult(Process.DocType, Process.UserId)
                RB = Nothing
            End If
    ...
    Private Function CreateProcess(ByVal ProcessId As Int32, ByVal DocType As DocType, ByVal UserId As Int32) As Boolean
        If Process Is Nothing Then Process = New Process
    ...
    Private Sub Import(ByVal ProcessId As Int32, ByVal x As String, ByVal Type As ProcessTypes, ByVal DocType As DocType, ByVal userId As Int32, Optional ByVal _caracter As Char = "|")
        ...
        'Separo los atributos y archivos segun el separador
        Caracter = _caracter
            ...
            Select Case IndexId.ToUpper
                ...
                Case "RUTACOMPLETA"
                    If Process.FlagMultipleFiles = True Then
                        ...
                        Dim FilesSplit() As String = xsplit(ProcessIndexCounter).Split(Process.MultipleCaracter.Trim)
                ...
                Case Else
                    ...
                    For i = 0 To Result.Indexs.Count - 1
                        If Result.Indexs(i).ID = OIndexId Then
                            ArrayIndex = i
                            Exit For
                        End If
                    Next
            ...
            For i = 0 To MultipleFiles.Count - 1
                ...
                If Result.File.Trim <> "" Then
                    ...
                    If Process.type <> ProcessTypes.Test Then
                        Resultado = Results_Business.InsertDocument(Result, Process.Move, False, Process.Replace, Process.AskConfirmations)
                    Else
