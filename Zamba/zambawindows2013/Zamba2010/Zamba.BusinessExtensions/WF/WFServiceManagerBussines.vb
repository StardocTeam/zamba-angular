...
#End Region
    ...
    Public Sub New()
        ...
        If Not ds Is Nothing Then
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If Not firstRow.Item("Version_Act").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("Version_Act").ToString, _versionActual)
                End If

                If Not firstRow.Item("Version_Upd").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("Version_Upd").ToString, _versionNueva)
                End If

                If Not firstRow.Item("Path_Actual").ToString Is Nothing Then
                    _pathActual = firstRow.Item("Path_Actual").ToString
                End If

                If Not firstRow.Item("Path_Nuevo").ToString Is Nothing Then
                    _pathNueva = firstRow.Item("Path_Nuevo").ToString
                End If

                If Not firstRow.Item("Path_Backup").ToString Is Nothing Then
                    _pathBackup = firstRow.Item("Path_Backup").ToString
                End If

                If Not firstRow.Item("Actualizar").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("Actualizar").ToString, _actualizar)
                End If

                If Not firstRow.Item("Actualizado").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("Actualizado").ToString, _actualizado)
                End If

                If Not firstRow.Item("Fecha_Upd").ToString Is Nothing Then
                    Date.TryParse(firstRow.Item("Fecha_Upd").ToString, _fechaUpdate)
                End If

                If Not firstRow.Item("Forzar_Upd").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("Forzar_Upd").ToString, _forzarUpdate)
                End If

                If Not firstRow.Item("Fallas").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("Fallas").ToString, _fallas)
                End If

                If Not firstRow.Item("MON_Version_Act").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("MON_Version_Act").ToString, _MonversionActual)
                End If

                If Not firstRow.Item("MON_Version_Upd").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("MON_Version_Upd").ToString, _MonversionNueva)
                End If

                If Not firstRow.Item("MON_Path_Actual").ToString Is Nothing Then
                    _MonpathActual = firstRow.Item("MON_Path_Actual").ToString
                End If

                If Not firstRow.Item("MON_Path_Nuevo").ToString Is Nothing Then
                    _MonpathNueva = firstRow.Item("MON_Path_Nuevo").ToString
                End If

                If Not firstRow.Item("MON_Path_Backup").ToString Is Nothing Then
                    _MonpathBackup = firstRow.Item("MON_Path_Backup").ToString
                End If

                If Not firstRow.Item("MON_Actualizar").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("MON_Actualizar").ToString, _Monactualizar)
                End If

                If Not firstRow.Item("MON_Actualizado").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("MON_Actualizado").ToString, _Monactualizado)
                End If

                If Not firstRow.Item("MON_Fecha_Upd").ToString Is Nothing Then
                    Date.TryParse(firstRow.Item("MON_Fecha_Upd").ToString, _MonfechaUpdate)
                End If

                If Not firstRow.Item("MON_Forzar_Upd").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("MON_Forzar_Upd").ToString, _MonforzarUpdate)
                End If

                If Not firstRow.Item("MON_Fallas").ToString Is Nothing Then
                    Int32.TryParse(firstRow.Item("MON_Fallas").ToString, _Monfallas)
                End If
    ...
    Public Shared Sub ActivateAction(ByVal id As Int16)
    ...
    Public Shared Sub InsertAction(ByVal serviceID As Int32, ByVal action As ServiceManagerAction)
        ZTrace.WriteLineIf(ZTrace.IsInfo, "Insertando accion: " & action.ToString() & " para el servicio: " & serviceID)
