...
#End Region
    ...
    Public Shared Function GetIndexById(ByVal indexID As Int64, ByVal value As String) As IIndex
        ...
        CurrentIndexaux.Data = value
        CurrentIndexaux.DataTemp = CurrentIndexaux.Data
        CurrentIndexaux.dataDescriptionTemp = CurrentIndexaux.dataDescription
        CurrentIndexaux.Data2 = value
        CurrentIndexaux.DataTemp2 = CurrentIndexaux.Data2
        CurrentIndexaux.dataDescription2 = value
        CurrentIndexaux.dataDescriptionTemp2 = CurrentIndexaux.dataDescription2

        Return CurrentIndexaux
    End Function
    ...
    Public Shared Function GetIndexIdByName(ByVal IndexName As String) As Int64
        If Not Cache.DocTypesAndIndexs.hsIndexsName.ContainsKey(Trim(IndexName)) Then
            Cache.DocTypesAndIndexs.hsIndexsName.Add(Trim(IndexName), Indexs_Factory.GetIndexIdByName(Trim(IndexName)))
        End If
        Return Cache.DocTypesAndIndexs.hsIndexsName(Trim(IndexName))
    End Function
    ...
    Public Shared Function getAllIndexes() As Hashtable
        ...
        'Dim Indexs(DSIndex.Tables(0).Rows.Count - 1) As Index
        DsIndex = Indexs_Factory.GetIndex()
        For i = 0 To DsIndex.Tables(0).Rows.Count - 1
            'Indexs.SetValue(New Index(DSIndex.Tables(0)(i).INDEX_ID, DSIndex.Tables(0)(i).INDEX_NAME, DSIndex.Tables(0)(i).INDEX_TYPE, DSIndex.Tables(0)(i).INDEX_LEN, False, False, DSIndex.Tables(0)(i)("DROPDOWN"), False, False, DSIndex.Tables(0)(i).MUSTCOMPLETE), i)
            If Not IsDBNull(DsIndex.Tables(0).Rows(i)("DataTableName")) Then
                Ind = New Index(DsIndex.Tables(0)(i)("INDEX_ID"), DsIndex.Tables(0)(i)("INDEX_NAME"), DsIndex.Tables(0)(i)("INDEX_TYPE"),
                                DsIndex.Tables(0)(i)("INDEX_LEN"), False, False, DsIndex.Tables(0)(i)("DROPDOWN"), False, False, 0,
    ...
    Public Shared Function GetAssociateDocumentIndexsRightsNonvisibleIndexs(ByVal DocTypeParentId As Int64, ByVal DoctypeId As String, ByVal userID As Int64) As List(Of Int64)
        ...
        Dim DocTypeIdInteger As Integer
        ...
        AssociateRight = RightsBusiness.GetUserRights(ObjectTypes.DocTypes, RightsType.ViewAssociateRightsByIndex, Int64.Parse(DoctypeId))
        If AssociateRight Then
            Indexs = Indexs_Factory.GetAssociateDocumentIndexsRights(DocTypeParentId, Int64.Parse(DoctypeId), groupIds)
    ...
    Public Shared Function GetIndexsSchemaAsListOfDT(ByVal DocTypeId As Int64, ByVal UseCache As Boolean) As Generic.List(Of IIndex)
        ...
        Else
            Dim DsIndex As DataSet
            DsIndex = Indexs_Factory.GetIndexsSchema(DocTypeId)
            ...
            If Not IsNothing(DsIndex) Then
                ...
                For i = 0 To DsIndex.Tables(0).Rows.Count - 1
                    If Not IsDBNull(DsIndex.Tables(0).Rows(i)("DataTableName")) Then
                        IndexsList.Add(New Index(DsIndex.Tables(0)(i)("INDEX_ID"), DsIndex.Tables(0)(i)("INDEX_NAME"), DsIndex.Tables(0)(i)("INDEX_TYPE"),
                                                 DsIndex.Tables(0)(i)("INDEX_LEN"), False, False, DsIndex.Tables(0)(i)("DROPDOWN"), False, False, DsIndex.Tables(0)(i)("MUSTCOMPLETE"),
                                                 String.Empty, DsIndex.Tables(0).Rows(i)("IndicePadre"), Nothing, DsIndex.Tables(0).Rows(i)("DataTableName")))
                    Else
                        IndexsList.Add(New Index(DsIndex.Tables(0)(i)("INDEX_ID"), DsIndex.Tables(0)(i)("INDEX_NAME"), DsIndex.Tables(0)(i)("INDEX_TYPE"),
                                                 DsIndex.Tables(0)(i)("INDEX_LEN"), False, False, DsIndex.Tables(0)(i)("DROPDOWN"), False, False, DsIndex.Tables(0)(i)("MUSTCOMPLETE"),
...
#End Region
    ...
    Public Shared Function GetIndexDefaultValues(ByVal doctype As DocType) As Dictionary(Of Int64, String)
        ...
        Return New Dictionary(Of Long, String)
    End Function
    ''' -----------------------------------------------------------------------------
    ''' <summary>
...
#Region "Versiones"
    ...
    Public Shared Function GetIndexByPublishStates(ByVal result As PublishableResult) As Hashtable
        ...
        Try
            Dim ds As DataSet
            ds = Indexs_Factory.GetIndexByPublishStates(result.DocTypeId)
...
#End Region
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Shared Sub addindexlist(ByVal IndexId As Int64, ByVal IndexLen As Int32)
    ...
    ''' <remarks></remarks>
    Public Shared Sub addindexlist(ByVal IndexId As Int64, ByVal tableName As String, ByVal columnCodName As String, ByVal columnDescName As String, ByVal script As String)
        Indexs_Factory.addindexlist(IndexId, tableName, columnCodName, columnDescName, script)
    End Sub
    ...
    ''' <history>Marcelo 07/10/08 Created</history>
    ''' <remarks></remarks>
    Public Shared Sub addindexsust(ByVal IndexId As Int64, ByVal tableName As String, ByVal columnCodName As String, ByVal columnDescName As String, ByVal script As String)
        Indexs_Factory.addindexSust(IndexId, tableName, columnCodName, columnDescName, script)
    End Sub

    Public Shared Sub InsertIndexList(ByVal indexid As Int64, ByVal IndexList As ArrayList)
    ...
    Public Shared Sub InsertIndexSust(ByVal IndexId As String, ByVal Code As String, ByVal ColumnDescName As String)
        ...
        Dim description As String = AutoSubstitutionBusiness.getDescription(Code, IndexId)

        If description IsNot Nothing AndAlso description.Length > 0 Then
        ...
        Try
            AutoSubstitutionBusiness.GetIndexData(IndexId, True)
        Catch ex As Exception
            ZClass.raiseerror(ex)
        End Try
    End Sub
    ...
    Public Shared Function getReferenceStatus(ByVal docTypeID As Int64, ByVal indexID As Int64) As Boolean
        If Not Cache.DocTypesAndIndexs.hsIndexsReferenceStatus.ContainsKey(docTypeID & "-" & indexID) Then
            Cache.DocTypesAndIndexs.hsIndexsReferenceStatus.Add(docTypeID & "-" & indexID, Indexs_Factory.getReferenceStatus(docTypeID, indexID))
        End If
        Return Cache.DocTypesAndIndexs.hsIndexsReferenceStatus(docTypeID & "-" & indexID)
    End Function
