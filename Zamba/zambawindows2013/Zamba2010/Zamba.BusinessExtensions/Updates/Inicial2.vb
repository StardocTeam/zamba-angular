...
#Region "Métodos"
    ...
    Public Sub StartActions()
        ...
        UpdaterBusiness.GetLastestVersion(String.Empty, Updatepath, String.Empty)

        'Seteo las versiones.
        GetVersions()

        Try
            DeleteFailedFiles(System.Windows.Forms.Application.StartupPath)
    ...
    Private Sub UpdateFiles()
        ...
        Else
            ...
            Dim PathOrigen As String = Updatepath
            Dim PathDestino As String = System.Windows.Forms.Application.StartupPath
            Dim PathBackToExecute As String = System.Windows.Forms.Application.StartupPath & "\Zamba.Cliente.exe"
            ...
            Dim dll As String = System.Windows.Forms.Application.StartupPath & "\UpToDate\Zamba.UpdateClientNGen.exe "
    ...
    Private Sub DeleteFailedFiles(ByVal path As String)
        ...
        Dim files() As FileInfo = dir.GetFiles("failed*.*")
    ...
    Private Sub UpdateTheUpdater()
        Try
            Dim destPath As String = System.Windows.Forms.Application.StartupPath & "\UpToDate\"

            Dim origPath As String = Updatepath & "\UpToDate\"
    ...
    Private Sub GetVersions()
        ...
        Try
            MyVersion = UpdaterBusiness.GetVersion()
        Catch ex As Exception
            MyVersion = String.Empty
            ZClass.raiseerror(ex)
        End Try

        Try
            CurrentVersion = UpdaterBusiness.GetLastestVersion()
        Catch ex As Exception
