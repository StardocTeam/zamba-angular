...
Public Class UcmServices
    ...
    Private Shared Sub InitializeConnectionTimer()
        ...
        If (_ConnectionTimer Is Nothing) Then
            ...
            _ConnectionTimer = New ZTimer(_CTCB, state, duetime, period, Int32.Parse(UserPreferences.getValue("TimeStartT", UPSections.UserPreferences, "0")), Int32.Parse(UserPreferences.getValue("TimeEndT", UPSections.UserPreferences, "23")))
