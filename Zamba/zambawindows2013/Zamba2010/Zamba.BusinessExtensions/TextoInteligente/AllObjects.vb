...
Public Class CommonFunctions
    ...
    <PropiedadesType(Propiedades.PropiedadPublica), PropiedadesReturnType(New String() {"Ruta archivo generado"}), PropiedadesParam(New String() {"RutaFTP,usuario,contraseña,RutaDestino"})>
