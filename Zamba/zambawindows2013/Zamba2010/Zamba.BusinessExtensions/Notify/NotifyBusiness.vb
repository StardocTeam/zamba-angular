...
Public Class NotifyBusiness
    ...
    Public Shared Function GetMails(ByVal typeGroupToNotify As GroupToNotifyTypes, ByVal idGroupToNotify As Int64, ByRef mailsToNotify As List(Of String)) As Boolean
        ...
        If IsNothing(mailsToNotify) Then
            mailsToNotify = New List(Of String)
        End If
        ...
        Try
            ...
            If reciepusers.Count > 0 Or externalMails.Count > 0 Then
                ...
                Dim auxLst As New List(Of String)
    ...
    Public Shared Function GetGroupToNotifyMails(ByVal users As ArrayList) As List(Of String)
    ...
    Public Shared Function GetGroupToNotifyMails(ByVal userIDs As List(Of Int64)) As List(Of String)
        Dim mails As New List(Of String)
