...
Public Class BarcodesBusiness
    ...
    Public Shared Function getInforme() As DataSet
        Try
            ...
            For Each fila As DataRow In tablaResultado.Rows
                ...
                Dim path As String =
                Results_Factory.getPathForIdTypeIdDoc(fila(NOMBRE_COLUMNA_DOC_ID),
                 fila(NOMBRE_COLUMNA_DOC_TYPE_ID))
    ...
    Public Shared Function Insert(ByVal TaskResultId As Int64,
    ByVal docTypeId As Int64,
    ByVal UserId As Int32,
    ByVal CaratulaId As Int32,
    ByVal DontOpenTaskAfterInsertInDoGenerateCoverPage As Boolean) As Boolean
        Try
            InsertBarCodeInDB(TaskResultId, docTypeId, UserId, CaratulaId)
        Catch ex As Exception
            raiseerror(ex)
            Return False
        End Try
    ...
    Private Shared Sub InsertBarCodeInDB(ByVal resultid As Int64, ByVal docTypeId As Int64, ByVal UserId As Int32, ByVal CaratulaId As Int32)
        'Inserta caratula
        BarcodeFactory.InsertBarCode(resultid, docTypeId, UserId, CaratulaId)
        'Actualiza el IconId del result (60 = caratula no escaneada).
        Results_Business.UpdateResultIcon(resultid, docTypeId, 60)
    End Sub
