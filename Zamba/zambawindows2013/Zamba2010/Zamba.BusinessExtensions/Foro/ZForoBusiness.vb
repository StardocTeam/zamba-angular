...
Public Class ZForoBusiness
    ...
    Public Shared Sub GetAllMessages(ByVal DocId As Int64, ByVal DocTypeId As Int64, ByRef ArrayMensajes As ArrayList, ByRef ArrayRespuestas As ArrayList, ByVal CheckIfVersionMessagesShouldShow As Boolean, byval RootDocumentId As int64)
        Dim ShowAllConversations As Boolean = RightsBusiness.GetUserRights(Membership.MembershipHelper.CurrentUser, ObjectTypes.DocTypes, RightsType.MostrarConversaciones, DocTypeId)
...
#Region "Adjuntos"
    ...
    ''' </summary>
    Public Shared Sub InsertAttach(ByVal idMensaje As Int32, ByVal attachs As List(Of String))
