                ...
                For Each pair As KeyValuePair(Of RightsType, Boolean) In myRule.Rights
                    ...
                    Select Case pair.Key
                        Case RightsType.Edit
                            ...
                            Trace.WriteLineIf(ZTrace.IsInfo, "Modificando por regla el permiso de Edición a " & pair.Value)
                        ...
                        Case RightsType.ReIndex
                            ...
                            Trace.WriteLineIf(ZTrace.IsInfo, "Modificando por regla el permiso de Reindex a " & pair.Value)
                            ZClass.HandleRuleModule(ResultActions.SetReindex, taskResults, hshValues)

                        Case RightsType.HideReplaceDocument
                            hshValues.Add("value", Not pair.Value)
                            Trace.WriteLineIf(ZTrace.IsInfo, "Modificando por regla la visualización del botón Reemplazar Documento a " & pair.Value)
