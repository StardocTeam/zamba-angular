...
Public Class PlayDoGetFiles
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult)) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            Trace.WriteLineIf(ZTrace.IsInfo, "Directorio: " & filepath)
            ...
            If VariablesInterReglas.ContainsKey(Me._myrule.VarName) = Nothing Then
                VariablesInterReglas.Add(Me._myrule.VarName, files, False)
            Else
                VariablesInterReglas.Item(Me._myrule.VarName) = files
            End If
            Trace.WriteLineIf(ZTrace.IsInfo, "Nombre Variable: " & _myrule.VarName)
