...
//				indexer.DocumentCollection.Clear();
		...
		private void menuItem5_Click(object sender, System.EventArgs e)
		{
			...
			{
				IndexDirectory(lblSearchIn.Text);
                indexer.WriteIndices();
            }
		}
...
//        DirectoryInfo DirInfo;
        private void IndexDirectory(string Dir)
        {
            		if(Directory.Exists(Dir))
				{
                      //  DirInfo = new DirectoryInfo(Dir);
                        ...
                        CallAsyncIndexing(Dir);
                        CallAsyncIndexingWrite(Dir);
  ...
  //                          DirInfo = D;
                    ...
                    //doIndexingPhase1.BeginInvoke(Dir,new AsyncCallback(IndexingComplete),null);
        ...
        //    doIndexingPhase2.BeginInvoke(DirInfo.FullName, new AsyncCallback(DocumentCollectionrReady), null);
        //}
        ...
        //    {
        //        DirInfo = D;
        //        IndexDirectory(DirInfo.FullName);
        //    }
