...
Public Class RptDocumentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocumentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocumentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocumentos = New RptDocumentos
        rpt.Site = Me.Site
        Return rpt
    End Function
