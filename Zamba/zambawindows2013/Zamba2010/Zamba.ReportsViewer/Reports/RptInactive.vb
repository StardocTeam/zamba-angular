...
Public Class RptInactive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptInactive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInactive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInactive = New RptInactive
        rpt.Site = Me.Site
        Return rpt
    End Function
