...
Public Class RptMailsToImport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptMailsToImport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMailsToImport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMailsToImport = New RptMailsToImport
        rpt.Site = Me.Site
        Return rpt
    End Function
