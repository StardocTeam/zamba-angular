...
Public Class RptOnlineUsers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptOnlineUsers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOnlineUsers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOnlineUsers = New RptOnlineUsers
        rpt.Site = Me.Site
        Return rpt
    End Function
