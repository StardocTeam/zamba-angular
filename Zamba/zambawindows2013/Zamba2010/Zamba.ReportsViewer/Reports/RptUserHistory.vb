...
Public Class RptUserHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptUserHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptUserHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptUserHistory = New RptUserHistory
        rpt.Site = Me.Site
        Return rpt
    End Function
