...
Public Class RptInstalled
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptInstalled.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInstalled
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInstalled = New RptInstalled
        rpt.Site = Me.Site
        Return rpt
    End Function
