...
Public Class RptMailsImportados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptMailsImportados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMailsImportados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMailsImportados = New RptMailsImportados
        rpt.Site = Me.Site
        Return rpt
    End Function
