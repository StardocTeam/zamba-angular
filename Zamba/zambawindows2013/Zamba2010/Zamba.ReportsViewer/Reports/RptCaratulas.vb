...
Public Class RptCaratulas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptCaratulas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCaratulas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCaratulas = New RptCaratulas
        rpt.Site = Me.Site
        Return rpt
    End Function
