...
Public Class RptImpresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptImpresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptImpresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptImpresos = New RptImpresos
        rpt.Site = Me.Site
        Return rpt
    End Function
