...
Public Class RptMailsPub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptMailsPub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMailsPub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMailsPub = New RptMailsPub
        rpt.Site = Me.Site
        Return rpt
    End Function
