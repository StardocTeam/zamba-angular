...
Public Class RptWfStepStates
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptWfStepStates.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptWfStepStates
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptWfStepStates = New RptWfStepStates
        rpt.Site = Me.Site
        Return rpt
    End Function
