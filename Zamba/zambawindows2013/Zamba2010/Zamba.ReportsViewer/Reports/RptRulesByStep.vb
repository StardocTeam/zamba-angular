...
Public Class RptRulesByStep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptRulesByStep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRulesByStep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRulesByStep = New RptRulesByStep
        rpt.Site = Me.Site
        Return rpt
    End Function
