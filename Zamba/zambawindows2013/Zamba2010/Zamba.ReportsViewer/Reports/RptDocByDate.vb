...
Public Class RptDocByDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocByDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocByDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocByDate = New RptDocByDate
        rpt.Site = Me.Site
        Return rpt
    End Function
