...
Public Class RptDocCountInStep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocCountInStep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocCountInStep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocCountInStep = New RptDocCountInStep
        rpt.Site = Me.Site
        Return rpt
    End Function
