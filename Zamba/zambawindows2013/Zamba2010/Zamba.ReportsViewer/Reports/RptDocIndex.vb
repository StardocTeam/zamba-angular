...
Public Class RptDocIndex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocIndex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocIndex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocIndex = New RptDocIndex
        rpt.Site = Me.Site
        Return rpt
    End Function
