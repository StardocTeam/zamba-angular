...
Public Class rptLockUser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.rptLockUser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLockUser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLockUser = New rptLockUser
        rpt.Site = Me.Site
        Return rpt
    End Function
