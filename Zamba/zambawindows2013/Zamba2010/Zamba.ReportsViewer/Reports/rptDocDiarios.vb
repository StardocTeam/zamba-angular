...
Public Class rptDocDiarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.rptDocDiarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDocDiarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDocDiarios = New rptDocDiarios
        rpt.Site = Me.Site
        Return rpt
    End Function
