...
Public Class RptDocMasCons
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocMasCons.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocMasCons
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocMasCons = New RptDocMasCons
        rpt.Site = Me.Site
        Return rpt
    End Function
