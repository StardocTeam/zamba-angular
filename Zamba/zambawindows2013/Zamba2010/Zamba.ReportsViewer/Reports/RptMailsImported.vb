...
Public Class RptMailsImported
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptMailsImported.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMailsImported
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMailsImported = New RptMailsImported
        rpt.Site = Me.Site
        Return rpt
    End Function
