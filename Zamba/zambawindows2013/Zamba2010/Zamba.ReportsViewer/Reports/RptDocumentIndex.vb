...
Public Class RptDocumentIndex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocumentIndex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocumentIndex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocumentIndex = New RptDocumentIndex
        rpt.Site = Me.Site
        Return rpt
    End Function
