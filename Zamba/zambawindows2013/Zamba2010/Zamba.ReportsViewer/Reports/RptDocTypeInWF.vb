...
Public Class RptDocTypeInWF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocTypeInWF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocTypeInWF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocTypeInWF = New RptDocTypeInWF
        rpt.Site = Me.Site
        Return rpt
    End Function
