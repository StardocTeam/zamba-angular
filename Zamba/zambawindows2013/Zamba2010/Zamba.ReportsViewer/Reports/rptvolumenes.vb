...
Public Class rptvolumenes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.rptvolumenes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptvolumenes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptvolumenes = New rptvolumenes
        rpt.Site = Me.Site
        Return rpt
    End Function
