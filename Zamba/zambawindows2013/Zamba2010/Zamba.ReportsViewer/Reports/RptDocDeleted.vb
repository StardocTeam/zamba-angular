...
Public Class RptDocDeleted
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RptDocDeleted.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDocDeleted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDocDeleted = New RptDocDeleted
        rpt.Site = Me.Site
        Return rpt
    End Function
