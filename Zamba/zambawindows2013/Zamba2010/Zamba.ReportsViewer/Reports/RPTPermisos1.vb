...
Public Class RPTPermisos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zamba.ReportsViewer.RPTPermisos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTPermisos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPermisos = New RPTPermisos
        rpt.Site = Me.Site
        Return rpt
    End Function
