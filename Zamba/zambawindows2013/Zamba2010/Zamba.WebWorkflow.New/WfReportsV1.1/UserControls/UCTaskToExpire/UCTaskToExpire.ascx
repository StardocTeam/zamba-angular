...
<body class="ms-informationbar">
    <table style="margin: 0px 0px 0px 0px">
        ...
        <tr>
            ...
            <td style="margin: 0px 0px 0px 0px">
                <asp:TextBox ID="txtHoursToExpire" runat="server" Width="35px" Font-Size="XX-Small" /> <asp:Button
            ...
            <td style="margin: 0px 0px 0px 0px">
                <asp:Label ID="lblNoData" runat="server" Font-Bold="True" Font-Size="XX-Small" ForeColor="Red"
                    Visible="False">No se encontraron Tareas</asp:Label>
                     <asp:GridView runat="server" ID="gvExpire" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" >
                         <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                         <RowStyle BackColor="#FFFBD6" ForeColor="#333333" />
                         <Columns>
                             <asp:BoundField DataField="TaskToExpire_Source" HeaderText="Nombre" />
                             <asp:BoundField DataField="TaskToExpire_Count" HeaderText="Cantidad" />
                         </Columns>
