<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Security/LogIn.aspx.cs" Inherits="Login" %>
...
<body topmargin="0" id="loginBody" runat="server">
    <form id="form1" runat="server" style="background-image: url(images/fondoPantalla.JPG);">
        ...
        <table style="width: 100%; height: 500; background-image: url(images/fondoPantalla.JPG);
            ...
            <tr>
                <td style="vertical-align: bottom" bgcolor="#284775" class="UserDottedLine">
                    <img src="../images/ClienteBanner.JPG" width="169" height="75" />
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <div align="center">
                        <asp:Table Width="40%" runat="server" ID="tbl5" Height="78px" CssClass="ms-sitetitle">
                            <asp:TableRow runat="server">
                                <asp:TableCell runat="server">
										<font face="Arial, Helvetica, sans-serif" size="4">
										<strong><em>Reportes de Workflow</em></strong></font>
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </div>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="Submit2" OnClick="Submit2_Click" Text="Iniciar Sesión" BackColor="#FFFBFF"
                                    ...
                                    Font-Size="0.8em" ForeColor="#284775" runat="server" /></td>
                        </tr>
                    </table>
            </tr>
            <tr>
                <td>
                    ...
                    <div align="center">
                        <span style="font-size: 7pt; font-family: Arial; vertical-align: middle;">Copyright©
                            2007 Stardoc Argentina - Todos los derechos reservados.
                            <br />
