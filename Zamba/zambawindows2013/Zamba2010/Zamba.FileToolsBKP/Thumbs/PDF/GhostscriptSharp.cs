...
namespace Zamba.FileTools
{
    ...
    public class GhostscriptWrapper
    {
        ...
        {
            if (IntPtr.Size == 4)
                GhostscriptSharp.API.GhostScript32.CallAPI(GetArgs(inputPath, outputPath, firstPage, lastPage, dpix, dpiy, width, height));
            else
                GhostscriptSharp.API.GhostScript64.CallAPI(GetArgs(inputPath, outputPath, firstPage, lastPage, dpix, dpiy, width, height));
        }
        ...
        {
            if (IntPtr.Size == 4)
                GhostscriptSharp.API.GhostScript32.CallAPI(GetArgs(inputPath, outputPath, settings));
            else
                GhostscriptSharp.API.GhostScript64.CallAPI(GetArgs(inputPath, outputPath, settings));
        }
            ...
            GhostscriptSettings settings)
        {
            ...
            if (settings.Device == GhostscriptSharp.Settings.GhostscriptDevices.UNDEFINED)
            {
            ...
            if (settings.Size.Native == GhostscriptSharp.Settings.GhostscriptPageSizes.UNDEFINED && settings.Size.Manual.IsEmpty)
            {
            ...
            // Page size
            if (settings.Size.Native == GhostscriptSharp.Settings.GhostscriptPageSizes.UNDEFINED)
            {
    ...
    {
        private GhostscriptSharp.Settings.GhostscriptDevices _device;
        private GhostscriptSharp.Settings.GhostscriptPages _pages = new GhostscriptSharp.Settings.GhostscriptPages();
        private System.Drawing.Size _resolution;
        private GhostscriptSharp.Settings.GhostscriptPageSize _size = new GhostscriptSharp.Settings.GhostscriptPageSize();

        public GhostscriptSharp.Settings.GhostscriptDevices Device
        {
            get { return this._device; }
            set { this._device = value; }
        }

        public GhostscriptSharp.Settings.GhostscriptPages Page
        {
        ...
        public GhostscriptSharp.Settings.GhostscriptPageSize Size
        {
