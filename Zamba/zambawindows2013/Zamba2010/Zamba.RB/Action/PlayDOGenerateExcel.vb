...
Public Class PlayDOGenerateExcel
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult)) As System.Collections.Generic.List(Of Core.ITaskResult)
        Try
            ...
            If results.Count > 0 Then
                Trace.WriteLineIf(ZTrace.IsInfo, "Generando Excel...")
                GenerarFactura(results)
                Trace.WriteLineIf(ZTrace.IsInfo, "Excel generado con éxito!")
            Else
                Trace.WriteLineIf(ZTrace.IsInfo, "No hay datos para generar el excel.")
            End If
        Finally
        End Try
    ...
    Private Sub GenerarFactura(ByVal Results As System.Collections.Generic.List(Of Core.ITaskResult))
        Trace.WriteLineIf(ZTrace.IsInfo, "Armo el cuerpo")
        ...
        Trace.WriteLineIf(ZTrace.IsInfo, "Obtengo los atributos y sus valores")
        While strIndex <> ""
        ...
        Trace.WriteLineIf(ZTrace.IsInfo, "Guardo los datos de los atributos")
        ...
        Trace.WriteLineIf(ZTrace.IsInfo, "Creo el documento de Excel")
