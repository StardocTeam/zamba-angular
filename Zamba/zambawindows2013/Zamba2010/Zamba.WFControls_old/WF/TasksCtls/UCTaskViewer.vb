            ...
            If Not isDisposed Then
                Try
                    If disposing Then
                        ...
                        RemoveHandler CloseCtrl, AddressOf UCTaskViewer_CloseCtrl
                        ...
                        If TabDoc IsNot Nothing Then
                            RemoveHandler TabDoc.CloseOpenTask, AddressOf CerrarTab
            ...
            Try
                ...
                For Each RuleRow As DataRow In DVDSRules.ToTable().Rows ' wfstep.Rules
                    ...
                    If RuleEnabled = True Then
                        ...
                        Try
                            userActionName = WFBusiness.GetUserActionName(ruleid, wfstep.ID, rulename, True)
                        Catch ex As Exception
                            ZClass.raiseerror(ex)
        ...
        Private Sub LoadViewer(ByVal seleccionarTabTarea As Boolean, Optional ByVal tabSelect As Int16 = 0)
            ...
            Try
                If IsNothing(TabDoc) Then
                    ...
                    RemoveHandler TabDoc.CloseOpenTask, AddressOf CerrarTab
                    AddHandler TabDoc.CloseOpenTask, AddressOf CerrarTab
                    RemoveHandler TabDoc.ShowDocumentsAsociated, AddressOf ActivateDocAsociated
        ...
        Private Sub ShowDocAsociated()
            ...
            Try
                If TabAsociated.Controls.Count = 0 Then
                    ...
                    asociatedGrid = New UCFusion2(UCFusion2.Modes.AsociatedTasksResults, CurrentUserId, TaskResult)
                    RemoveHandler asociatedGrid.currentContextMenu.ItemClicked, AddressOf currentContextMenuClick
                    AddHandler asociatedGrid.currentContextMenu.ItemClicked, AddressOf currentContextMenuClick
...
#Region "Cerrar"
        ...
        Public Sub CloseTaskViewer(ByVal blnDisposeRes As Boolean)
            FlagClosingTV = True
            SuspendLayout()
        ...
        Public Function CerrarTab(Optional ByVal refreshGrid As Boolean = False) As Boolean
...
#Region "UserActions"
        ...
        Public Property currentContextMenu As UCGridContextMenu
