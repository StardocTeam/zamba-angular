...
Public Class EnvironmentUtil
    ...
    Public Shared Function GetTempDir(ByVal dire As String) As IO.DirectoryInfo
        ...
        Try
            If dire.StartsWith("\") Then dire = dire.Remove(0, 1)
            Dir = New IO.DirectoryInfo(Path.Combine(MembershipHelper.AppTempPath, dire))
    ...
    Public Shared Function CopyFilesToTemp(ByVal fileFullPath As String, ByVal newName As String) As String
        ...
        If File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) & officeTemp) Then
            Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) & officeTemp)
        End If
        ...
        If newName <> String.Empty Then
            ...
            Dim i As Int16 = 0
            Do While File.Exists(NewFileRoute)
                If i = 0 Then
            ...
            File.Copy(fileFullPath, NewFileRoute, True)
            filePath = NewFileRoute
        Else
            'hago la copia del documento en officeTemp
            File.Copy(fileFullPath, Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) & officeTemp & OriginalFileName)
        End If
