...
<table style="margin: 0px 0px 0px 0px">
    <tr>
        <td width="100%" style="background-color: Navy; margin: 0px 0px 0px 0px" colspan="2">
            ...
            <asp:Label ID="lblTitle" Text="Distribución de tareas" runat="server" Font-Bold="true"
    ...
    <tr>
        <td style="margin: 0px 0px 0px 0px">
            <asp:RadioButton ID="rdbByWf" AutoPostBack="true" runat="server" Checked="True"
                Font-Size="XX-Small" OnCheckedChanged="rdbByWf_CheckedChanged" Text="Por Workflow" /><asp:RadioButton
        ...
        <td style="margin: 0px 0px 0px 0px">
            ...
            <asp:RadioButton ID="rdbVerGrafico" AutoPostBack="true" runat="server" Checked="True"
                Font-Size="XX-Small" Text="Ver Gráfico" OnCheckedChanged="rdbVerGrafico_CheckedChanged" /><asp:RadioButton ID="rdbVerTabla" AutoPostBack="true" runat="server" Font-Size="XX-Small"
    ...
    <tr height="100px">
        <td style="margin: 0px 0px 0px 0px">
            <rsweb:ReportViewer ID="rpvTasksBalance" runat="server" ShowFindControls="False"
                ...
                <LocalReport ReportPath="Reports\rptTasksBalances.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
            &nbsp;
        ...
        <td style="margin: 0px 0px 0px 0px">
            <rsweb:ReportViewer ID="rpvGrdTasksBalance" runat="server" ShowFindControls="False"
                ...
                <LocalReport ReportPath="Reports\rptGrdTasksBalances.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </td>
    </tr>
