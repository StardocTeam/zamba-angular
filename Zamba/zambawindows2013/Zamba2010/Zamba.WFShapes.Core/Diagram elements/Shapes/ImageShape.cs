...
namespace Zamba.WFShapes
{
	public class ImageShape : SimpleShapeBase, ISerializable
	{
		...
		public ImageShape(Int64 Id) : base()
		{
            Init(Id);
		}
		public ImageShape(Int64 Id,IModel site) : base(site)
		{
            Init(Id);
		}
		...
		public  Bitmap GetThumbnail()
		{
			...
			try
			{
				Stream stream=Assembly.GetExecutingAssembly().GetManifestResourceStream("Zamba.GraphLib.BasicShapes.Resources.ImageShape.gif");
			...
			{
				ZTrace.WriteLineIf(ZTrace.IsError,exc.Message + "ImageShape.GetThumbnail");
			}
			return bmp;
		}
