...
Public Class frmGeneralRules
    ...
    Private Sub GenerateHelp()
        Try
            ...
            help.Show("El orden se determina con un valor numérico que comienza por el cero," & vbCrLf &
    ...
    Private Sub cboPlace_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As EventArgs)
        ...
        If cboPlace.SelectedValue = ButtonPlace.WebHome OrElse cboPlace.SelectedValue = ButtonPlace.WebHeader Then
            lstTypesClass.Enabled = True
            lstTypesGroups.Enabled = True
            cmbSelectIcon.Enabled = False
        Else
            lstTypesClass.Enabled = False
            lstTypesGroups.Enabled = False
    ...
    Private Sub ZbtnAddClass_Click(sender As Object, e As EventArgs) Handles ZbtnAddClass.Click

        Dim addClass As New AddTextCSS
        addClass.Location = Location

        If addClass.ShowDialog() = DialogResult.OK Then

            If Not String.IsNullOrEmpty(addClass.txtAddClass.Text) Then

                lstTypesClass.Items.Add(addClass.txtAddClass.Text)

                GenericButtonBusiness.SetNewZButtonsAndGroups(addClass.txtAddClass.Text, 1)
    ...
    Private Sub ZButton2_Click(sender As Object, e As EventArgs) Handles ZButton2.Click
        ...
        If addClass.ShowDialog() = DialogResult.OK Then
            ...
            If Not String.IsNullOrEmpty(addClass.txtAddClass.Text) Then
                ...
                lstTypesGroups.Items.Add(addClass.txtAddClass.Text)

                GenericButtonBusiness.SetNewZButtonsAndGroups(addClass.txtAddClass.Text, 2)
