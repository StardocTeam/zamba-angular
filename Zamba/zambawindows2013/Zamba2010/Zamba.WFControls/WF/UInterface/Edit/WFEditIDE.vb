        ...
        Try
            ...
            If DirectCast(Me.WFPanelCircuit.tvwRules.SelectedNode, RuleNode).ParentType = TypesofRules.AccionUsuario Then
                ...
                Try
                    ...
                    userActionName = WFB.GetUserActionName(DirectCast(WFPanelCircuit.tvwRules.SelectedNode, RuleNode).RuleId, DirectCast(WFPanelCircuit.tvwRules.SelectedNode, RuleNode).WFStepId, DirectCast(WFPanelCircuit.tvwRules.SelectedNode, RuleNode).RuleName, False)
                    WFB = Nothing
                Catch ex As Exception
