...
if (Model != null)
{
    ...
    {
        if (i == 0 && Request.QueryString["pagina"].ToString() == "1")
        {
    %>
...
%>     
    <div style="float:left">
        <a href="#" rel="<%=(int)ViewData["pagina_actual"] - 1%>" id="link_mas_noticias" class="linkmenu_izq">
            &laquo; Anterior
        </a>
    </div> 
<%
