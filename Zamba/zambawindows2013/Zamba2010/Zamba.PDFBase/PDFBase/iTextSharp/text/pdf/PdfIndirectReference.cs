...
namespace iTextSharp.text.pdf {
    ...
    public class PdfIndirectReference : PdfObject {
        ...
        public PdfIndirectReference(int type, int number, int generation) : base(0, new StringBuilder().Append(number).Append(' ').Append(generation).Append(" R").ToString()) {
            this.number = number;
        ...
        public  PdfIndirectReference(int type, int number) : this(type, number, 0) {}
