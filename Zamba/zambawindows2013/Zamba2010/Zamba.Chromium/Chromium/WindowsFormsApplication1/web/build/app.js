...
angular.module('app.graphs').controller('FlotCtrl', function ($scope) {
    ...
    //{ return window.salesObject.SalesData },
    //function () {
    //    $scope.salesChartData = window.salesObject.SalesData;
    //});
...
angular.module('app.graphs').directive('flotAutoUpdatingChart', function ($timeout, FlotConfig) {
    return {
        restrict: 'E',
        replace: true,
        template: '<div class="chart" id="flotAutoUpdatingChart" style="min-height:100px;"></div>',
        scope: {
            data: '='
        },
        link: function (scope, element) {
...
angular.module('app.graphs').directive('flotBarChart', function (FlotConfig) {
    return {
        restrict: 'E',
        replace: true,
        template: '<div class="chart" style="min-height:100px;"></div>',
        scope: {
            data: '='
        },
        link: function (scope, element) {
...
angular.module('app.graphs').directive('flotSalesChart', function (FlotConfig) {
    return {
        restrict: 'E',
        replace: true,
        template: '<div class="chart" id="flotSalesChart" style="min-height:100px;"></div>',
        scope: {
            data: '='
        },
        link: function (scope, element) {
