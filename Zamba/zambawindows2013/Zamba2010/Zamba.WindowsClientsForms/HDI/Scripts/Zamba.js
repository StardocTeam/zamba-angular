$( document ).ready(function(){
   ...
   // alert('AddDynamicsTags');
    AddDynamicsTags();
   // alert('searchForInteligentText');
    searchForInteligentText();
   // alert('ProcessAjaxFunctions');
    //ProcessAjaxFunctions();
...
function LoadZVarComponents() {
    ...
    $(".zvar").each(function () {
        ...
        $.ajax({
            type: "POST",
            url: document.config.urlBase + "/AsignVarValue",
...
function AddDynamicsTags()
{
 ...
 if (typeof jQuery == 'undefined')
        $('head').append('<script src="/Scripts/jquery-3.1.1.min.js""></script>');
 ...
 //Inclusion de librerias JS y CSS
    (function () {
        ...
        //SignalR
        if ($('script[src*="/jquery.signalR-2.2.0.min.js"]').length == 0)
            $('head').append('<script src="' + referenceFilesJS + '/jquery.signalR-2.2.0.min.js"></script>');
        if ($('script[src*="/jquery.chatjs.signalradapter.js"]').length == 0)
            $('head').append('<script src="' + referenceFilesJS + '/jquery.chatjs.signalradapter.js"></script>');
