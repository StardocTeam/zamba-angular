...
#Region "ExecuteNonQuery"
    ...
    Public Overloads Function ExecuteNonQuery(ByVal spName As String,
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            Try
                commandParameters = OracleHelperParameterCacheODP.GetSpParameterSet(CN, CN.ConnectionString, spName)
    ...
    Public Overloads Function ExecuteNonQuery(ByVal transaction As IDbTransaction, ByVal spName As String,
        ...
        Dim commandParameters As IDbDataParameter()
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            commandParameters = OracleHelperParameterCacheODP.GetSpParameterSet(transaction, transaction.Connection.ConnectionString, spName)
            AssignParameterValues(commandParameters, parameterValues)
            State = IConnection.ConnectionStates.Ready
...
Public Class OraODPCreateTables
