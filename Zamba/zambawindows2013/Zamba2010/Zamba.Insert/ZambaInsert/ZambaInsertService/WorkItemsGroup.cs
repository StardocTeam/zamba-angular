...
namespace Zamba.ThreadPool.Internal
{
			...
			lock(_lock)
			{
				...
				if (null != workItem)
				{
						...
						(0 == _workItemsInStpQueue))
					{
						...
						Trace.WriteLineIf(ZTrace.IsInfo,"WorkItemsGroup " + Name + " is NOT idle");
				...
				if (0 == _workItemsQueue.Count)
				{
					if (0 == _workItemsInStpQueue)
					{
						...
						Trace.WriteLineIf(ZTrace.IsInfo,"WorkItemsGroup " + Name + " is idle");
