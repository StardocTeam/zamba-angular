...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("VALIDA LOS USUARIOS"), RuleHelp("Valida los usuarios")]
    [ToolboxItem(typeof(ParallelToolboxItem))]
    [Designer(typeof(ParallelDesigner), typeof(IDesigner))]
public partial class IfUsers : ZCompositeRule, IResultActivity, IIfUsers
	{
        public IfUsers()
		{
			InitializeComponent();
        ...
        protected override ActivityExecutionStatus Execute(ActivityExecutionContext executionContext)
        {
            for (int child = 0; child < this.EnabledActivities.Count; child++)
            {
                ...
                Zamba.WFExecution.PlayIfUsers play =
                new Zamba.WFExecution.PlayIfUsers();
                play.Play(this.Results, (Zamba.Core.IIfUsers)this);
