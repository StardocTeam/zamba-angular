...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("VALIDA ESTADO DE LA ETAPA"), RuleHelp("Valida el estado de la etapa")]
    [ToolboxItem(typeof(ParallelToolboxItem))]
    [Designer(typeof(ParallelDesigner), typeof(IDesigner))]
public partial class IfTaskStepState : ZCompositeRule, IResultActivity, IIfTaskStepState
	{
        private String _States = String.Empty;
        private Zamba.Core.Comparators _Comp;
        private const String _SEPARADOR_INDICE = ",";
        private Zamba.WFExecution.PlayIfTaskStepState play;
        
        public IfTaskStepState()
		{
			InitializeComponent();
            play = new Zamba.WFExecution.PlayIfTaskStepState(this);
		}
        ...
        #region IIfTaskStepState Members

        Zamba.Core.Comparators Zamba.Core.IIfTaskStepState.Comp
        {
            get
            {
                return _Comp;
        ...
        string Zamba.Core.IIfTaskStepState.SEPARADOR_INDICE
        {
            get { return _SEPARADOR_INDICE; }
        }

        string Zamba.Core.IIfTaskStepState.States
        {
            get
            {
                return _States;
        ...
        //{
        //    Core.IIfTaskStepState rule = (Core.IIfTaskStepState)this;
        //    UCIfTaskStepState designer = new UCIfTaskStepState(ref rule);
        //    return designer;
        //}
