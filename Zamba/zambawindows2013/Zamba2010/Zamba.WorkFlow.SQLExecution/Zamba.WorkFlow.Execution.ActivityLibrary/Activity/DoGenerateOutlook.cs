...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("GENERAR E-MAIL DE OUTLOOK "), RuleHelp("Envía un mail de Outlook.")]
    public partial class DOGenerateOutlook : ZRule, IResultActivity, IDOGenerateOutlook
    {
        private Zamba.WFExecution.PlayDoGenerateOutlook  play;
        public DOGenerateOutlook()
        {
            InitializeComponent();
            play = new Zamba.WFExecution.PlayDoGenerateOutlook(this);
        }
        ...
        public override void SetParams(object[] Params)
        {
            ...
            this._sendTimeOut = Convert.ToInt32(Params[10]);
        }
        ...
        #region Miembros de IDOGenerateOutlook
