...
{
    [RuleDescription("ENVIAR UN MENSAJE AL FORO"), RuleHelp("Permite enviar o visualizar mensajes del foro de un documento asociado.")]
    public partial class DoAddForumMessage : ZRule, IResultActivity, IDoAddForumMessage
	{	
		public DoAddForumMessage()
		{
			InitializeComponent();
		}
        ...
        {
            Zamba.WFExecution.PlayDoAddForumMessage play =
                new Zamba.WFExecution.PlayDoAddForumMessage();
        ...
        List<object> IResultActivity.GetParams()
        {
        ...
        List<ITaskResult> IResultActivity.Results
        {
            get
            {
                throw new NotImplementedException();
