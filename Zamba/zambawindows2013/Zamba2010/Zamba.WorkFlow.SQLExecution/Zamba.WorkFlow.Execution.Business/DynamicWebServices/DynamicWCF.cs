   ...
   public class DynamicWCF
    {
        ...
        public object ConsumeWCF(string wsdl, string contract, string methodName, ref object[] Parameters, Boolean useCredentials)
        {
            ...
            return methodInfo.Invoke(proxyInstance, BindingFlags.InvokeMethod, null, operationParameters, null);
        }
