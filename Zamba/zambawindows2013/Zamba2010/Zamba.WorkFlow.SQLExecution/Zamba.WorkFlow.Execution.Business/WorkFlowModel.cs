                ...
                if (((IResultActivity)activity).RuleType == 0)
                {
                        ...
                        IRule rule = null;
                            ...
                            if (e.Index > 0)
                            {
                                ...
                                rule = Zamba.Core.WFRulesBusiness.CreateNewRule(((IResultActivity)activity).RuleClass, ((IResultActivity)activity).RuleClass, this.wfstepid, TypesofRules.Regla, parentactivity.ruleId, ((IResultActivity)activity).RuleType);

                            }
                            else if (activity.Parent is WorkFlowModel)
                            rule = Zamba.Core.WFRulesBusiness.CreateNewRule(((IResultActivity)activity).RuleClass, ((IResultActivity)activity).RuleClass, this.wfstepid, TypesofRules.Regla, 0, this.RuleType);
                       else if (activity.Parent.ToString().Contains("Xoml.Parallel")==false)
                        {
                            rule = Zamba.Core.WFRulesBusiness.CreateNewRule(((IResultActivity)activity).RuleClass, ((IResultActivity)activity).RuleClass, this.wfstepid, TypesofRules.Regla, ((IResultActivity)activity.Parent.Activities[activity.Parent.Activities.Count - 2]).ruleId, ((IResultActivity)activity.Parent.Activities[activity.Parent.Activities.Count - 2]).RuleType);
                        }
                        else if (activity.Parent.ToString().Contains("Xoml.ParallelBranch") && activity.Parent.Activities.Count==1)
                            rule = Zamba.Core.WFRulesBusiness.CreateNewRule(((IResultActivity)activity).RuleClass, ((IResultActivity)activity).RuleClass, this.wfstepid, TypesofRules.Regla, 0, TypesofRules.AccionUsuario);
                        else
                            rule = Zamba.Core.WFRulesBusiness.CreateNewRule(((IResultActivity)activity).RuleClass, ((IResultActivity)activity).RuleClass, this.wfstepid, TypesofRules.Regla, ((IResultActivity)activity.Parent.Activities[activity.Parent.Activities.Count - 2]).ruleId, ((IResultActivity)activity.Parent.Activities[activity.Parent.Activities.Count - 2]).RuleType);
