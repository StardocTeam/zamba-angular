...
namespace Zamba.WorkFlow.Factories
{
	...
	public class ZNetron_Factory
	{
		...
		{ 
			...
			return Zamba.Servers.Server.get_Con(false,true,false).ExecuteDataset(CommandType.Text, strSelect); 
		} 
		...
		{ 
			...
			{ 
				...
				Zamba.Servers.Server.get_Con(false,true,false).ExecuteNonQuery(CommandType.Text, strInsert); 
			} 
			catch
			{ 
			} 
		...
		{ 
			...
			Zamba.Servers.Server.get_Con(false,true,false).ExecuteNonQuery(CommandType.Text, strDelete); 
		}
		...
		{ 
			...
			DataSet DsIds = Zamba.Servers.Server.get_Con(false,true,false).ExecuteDataset(CommandType.Text, strSelect); 
		...
		public static void UpdateObject(System.Int32 Shape_Height,String ShapeColor, String Shape_Text,System.Int32 Shape_Width,System.Int32 Shape_X,System.Int32 Shape_Y,bool Shape_Opaque,int Shape_Id,System.Int32 DocT,System.Int32 DocId)
		{
			try
			{
				...
				Zamba.Servers.Server.get_Con(false,true,false).ExecuteNonQuery (CommandType.Text, strUpdate); 
			}				
			catch
				  {
				  }
