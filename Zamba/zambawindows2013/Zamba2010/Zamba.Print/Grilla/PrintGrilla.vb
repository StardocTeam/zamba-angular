...
Public Class PrintGrilla
    ...
    Public Shared Sub ImprimirDirectlyToExcel(ByVal pDataTable As DataTable, ByVal fileName As String)
        ...
        Try
            ...
            sArchivo = Environment.CurrentDirectory & "\" & fileName & ".xls"
            PD.Document = Doc
            PD.UseEXDialog = True
            If PD.ShowDialog() = DialogResult.OK Then
                Zamba.Office.ExcelInterop.DataTableDirectlyToExcel(False, pDataTable, sArchivo, Office.ExcelInterop.eEstilosHoja.Reporte2, False)
    ...
    Public Shared Sub ImprimirWord(ByVal FilePath As String)
        Try
            Office.OfficeInterop.ImprimirWord(FilePath)
        Catch ex As Exception
    ...
    Public Shared Sub ImprimirPP(ByVal OfficeFile As Object)
        Try
            Office.OfficeInterop.ImprimirPP(OfficeFile)
        Catch ex As Exception
            MessageBox.Show("No se pudo imprimir en Office, excepción: " & ex.ToString.Substring(20))
        End Try
    End Sub
