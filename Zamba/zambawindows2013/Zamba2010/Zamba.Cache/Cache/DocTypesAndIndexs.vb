    ...
    Public Class DocTypesAndIndexs
        Public Shared Sub clearAll()
            Try
                ...
                hsDocAsociationsIds.Clear()
                hsAssociatedIndexsRights.Clear()
                hsAssociatedColumnsRights.Clear()
                ...
                hsFormsByEntityId.Clear()
                hsFormsByEntityIdAndType.Clear()
                arIndexs.Clear()
        ...
        Public Shared hsIndexsReferenceStatus As New Hashtable
        ...
        'Hash que guarda las asociaciones entre 2 entidades y sus permisos sobre indices de la entidad asociada.
        Public Shared hsAssociatedIndexsRights As New Hashtable

        'Hash que guarda las asociaciones entre 2 entidades y sus permisos sobre columnas de zamba.
        Public Shared hsAssociatedColumnsRights As New Hashtable
        ...
        'Hash que guarda los forms de los doctypes
        Public Shared hsFormsByEntityIdAndType As New Hashtable
        ...
        Public Shared dicDocTypeByRight As New Dictionary(Of Zamba.Core.RightsType, List(Of IDocType))()

        'Hash que guarda los atributos por id de atributo
        Public Shared arIndexs As New Hashtable
        Public Shared Property hsDocAsociationsIds As New Hashtable
