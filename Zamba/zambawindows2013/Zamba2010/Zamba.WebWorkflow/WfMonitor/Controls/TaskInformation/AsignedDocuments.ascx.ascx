...
<fieldset title="Documentos Asociados">
    <legend style="font: caption; color: navy">Documentos asignados</legend>
    <div class="UserControlBody">
        <asp:HiddenField runat="server" ID="hfTaskId" />
        <asp:GridView ID="gvAsociatedDocuments" runat="server" BackColor="White" BorderColor="White"
    ...
    <div class="UserControlButtons">
        <asp:Button ID="btRefresh" runat="server" Text="Actualizar" OnClick="btRefresh_Click"
            ...
            Font-Names="Verdana" ForeColor="#284775" ToolTip="Actualizar Listado" />
    </div>
</fieldset>
