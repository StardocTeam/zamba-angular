<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListadoTareasTerminadas.ascx.cs"
    Inherits="ListadoTareasTerminadas" %>
...
<fieldset title="Listado de Tareas" class="FieldSet">
    ...
    <div class="UserControlBody">
        <table>
            ...
            <tr>
                <td style="width: 100%; color: navy; text-align: left; font-size: xx-small;" align="center"
                    valign="middle">
                    <asp:GridView ID="gvTasks" OnPageIndexChanging="gvTasks_PageIndexChanging" OnSelectedIndexChanged="gvTasks_SelectedIndexChanged"
                        ...
                        Font-Size="xx-Small" CellPadding="4" GridLines="None" Width="100%">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Regla" />
