    ...
    <tr>
        <td style="margin: 0px 0px 0px 0px">
            <asp:RadioButton ID="rdbByUser" AutoPostBack="true" runat="server" Checked="True"
                ...
                Text="Por Usuario" ToolTip="Muestra las tareas asignadas por usuario" />
            <asp:RadioButton
                    ID="rdbByStep" AutoPostBack="true" runat="server" Font-Size="XX-Small" OnCheckedChanged="rdbByStep_CheckedChanged"
                    Text="Por Etapa" ToolTip="Muestra las tareas asignadas por etapa" />&nbsp;</td>
        <td style="margin: 0px 0px 0px 0px">
            |
            <asp:RadioButton ID="rdbVerGrafico" AutoPostBack="true" runat="server" Checked="True"
                ...
                ToolTip="Muestra un gráfico con las tareas asignadas del Work Flow seleccionado" /><asp:RadioButton
                    ID="rdbVerTabla" AutoPostBack="true" runat="server" 
                Font-Size="XX-Small" Text="Ver Tabla"
                    OnCheckedChanged="rdbVerTabla_CheckedChanged" 
                ToolTip="Muestra en forma de tabla la asignacion de tareas del Work Flow seleccionado" /></td>
    </tr>
</table>
                ...
                <LocalReport ReportPath="~/WfReports\Reports\RptAsignedTasksCounts.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                            Name="dsAsignedTasksCounts_dtAsignedTasksCounts" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
