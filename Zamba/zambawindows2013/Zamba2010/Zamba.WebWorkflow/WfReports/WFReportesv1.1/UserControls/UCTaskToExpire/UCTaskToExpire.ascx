...
<body class="ms-informationbar">
        ...
        <tr>
            ...
            <td style="margin: 0px 0px 0px 0px">
                ...
                <asp:Button ID="btnBuscar" runat="server" Text="Aplicar" 
                    ...
                    ToolTip="Muestra en la grilla las tareas que estan por vencer según el criterio cargado en las horas restantes para expirar" />
            </td>
        </tr>
        <tr>
            <td style="margin: 0px 0px 0px 0px">
    ...
    <table style="margin: 0px 0px 0px 0px" class="ms-informationbar">
        <tr>
            ...
            <td style="margin: 0px 0px 0px 0px">
                <asp:Button ID="Button1" runat="server" Text="Ver Gráfico" 
                    onclick="Button1_Click" Font-Size="Smaller" 
                    ToolTip="Muestra el gráfico de barras de la grilla" />
                <br />
