<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCAverageTimeInSteps.ascx.cs" Inherits="UCAverageTimeInSteps" %>
        ...
        <body class="ms-informationbar">
            <table style="margin: 0px 0px 0px 0px">
                ...
                <tr runat="server" id="RowSteps">
                    ...
                    <td style="margin: 0px 0px 0px 0px">
                        <asp:DropDownList ID="cmbEtapas" runat="server" AutoPostBack="true" Font-Size="XX-Small" OnSelectedIndexChanged="DropEtapas_SelectedIndexChanged" Width="130px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="margin: 0px 0px 0px 0px">
                        <asp:RadioButton ID="rdbWorkflow" AutoPostBack="true" runat="server" Checked="True" Font-Size="XX-Small" OnCheckedChanged="rdbWorkflow_CheckedChanged" Text="Por Workflow" /><asp:RadioButton ID="rdbByStep" AutoPostBack="true" runat="server" Font-Size="XX-Small" OnCheckedChanged="rdbByStep_CheckedChanged" Text="Por Etapa" />&nbsp;
                    </td>
                    <td style="margin: 0px 0px 0px 0px">
                        |
            ...
            <table style="margin: 0px 0px 0px 0px" class="ms-informationbar">
                <tr height="100px">
                    ...
                    <td style="margin: 0px 0px 0px 0px">
                        <rsweb:ReportViewer ID="rpvGrdAverageTimeInSteps" runat="server" ShowFindControls="False" ShowPageNavigationControls="False" Font-Names="Verdana" Font-Size="8pt" Height="250px" Width="275px" ShowExportControls="False" ShowPrintButton="False" ShowPromptAreaButton="False" ShowRefreshButton="False" ShowZoomControl="False">
