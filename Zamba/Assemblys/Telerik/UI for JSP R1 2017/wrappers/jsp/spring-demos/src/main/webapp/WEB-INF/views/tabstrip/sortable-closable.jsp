...
<kendo:tabStrip name="tabstrip" animation="false" >
	<kendo:tabStrip-items>
	    <kendo:tabStrip-item text="Baseball" selected="true">
        ...
        <kendo:tabStrip-item text="Swimming">
            <kendo:tabStrip-item-content>
                ...
                Written references date from 2000 BC. Some of the earliest references to swimming include the Gilgamesh, the Iliad, the Odyssey, the Bible, Beowulf, and other sagas.
                In 1578, Nikolaus Wynmann, a German professor of languages, wrote the first swimming book, The Swimmer or A Dialogue on the Art of Swimming (Der Schwimmer oder ein Zwiegespr&auml;ch &uuml;ber die Schwimmkunst). 
                Competitive swimming in Europe started around 1800, mostly using breaststroke.
            </kendo:tabStrip-item-content>    
        </kendo:tabStrip-item>
        <kendo:tabStrip-item text="Snowboarding">
            <kendo:tabStrip-item-content>
                ...
                It was developed in the U.S.A. in the 1960s to 1970s and became a Winter Olympic Sport in 1998.
            </kendo:tabStrip-item-content>    
        </kendo:tabStrip-item>
    </kendo:tabStrip-items>
</kendo:tabStrip>
