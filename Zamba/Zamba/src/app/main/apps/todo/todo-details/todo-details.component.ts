...
export class TodoDetailsComponent implements OnInit, OnDestroy
{
    ...
    createTodoForm(): FormGroup
    {
        return this._formBuilder.group({
            ID       : [this.todo.ID],
            PROVEEDOR    : [this.todo.PROVEEDOR],
            MONEDA    : [this.todo.MONEDA],
            IMPORTE: [this.todo.IMPORTE],
            VENCIMIENTO  : [this.todo.VENCIMIENTO],
            TIPO_GASTO  : [this.todo.TIPO_GASTO],
            CONCEPTO  : [this.todo.CONCEPTO],
            AREA  : [this.todo.AREA],
            CODIGOA : [this.todo.CODIGOA],
