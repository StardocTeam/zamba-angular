...
public partial class Views_Tools_ToolPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            _url = string.Format(MembershipHelper.Protocol + "{0}{1}/Services/GetDocFile.ashx?DocTypeId={2}&DocId={3}&UserID={4}", Request.ServerVariables["HTTP_HOST"], Request.ApplicationPath, _doctypeId, _docId, Session["UserId"]);
