...
public partial class Views_ImageViewer : System.Web.UI.UserControl
{
    ...
    private string CreateTempImage()
    {
        ...
        string url = string.Format(_URLFORMAT, Request.ServerVariables["HTTP_HOST"], Request.ApplicationPath, Result.DocTypeId, Result.ID, Session["UserId"], MembershipHelper.Protocol);
