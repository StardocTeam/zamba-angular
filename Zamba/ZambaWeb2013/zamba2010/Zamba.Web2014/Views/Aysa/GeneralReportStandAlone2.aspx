<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GeneralReportStandAlone2.aspx.cs"
    Inherits="Views_Aysa_GeneralReportStandAlone2" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <telerik:RadGrid runat="server" ID="RadGrid1" DataSourceID="SqlDataSource2" AllowPaging="True"
                ...
                CellSpacing="0" GridLines="None" Skin="Windows7" PageSize="250"
                Visible="false">
                <ClientSettings>
