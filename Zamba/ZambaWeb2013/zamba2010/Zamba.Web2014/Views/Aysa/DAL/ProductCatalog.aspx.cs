...
namespace Views.Aysa.GEC
{
    ...
    {
        //private IEnumerable<long> _hiddenColumns;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Zopt = null;
                Title = (string.IsNullOrEmpty(title)) ? "Zamba Software " : title + " - Catálogo de Productos";
            }
            catch (Exception ex)
            {
                ZException.Log(ex);
        ...
        private void RunCommand(GridCommandEventArgs e)
        {
            ...
            //}
            //else if (command == "ExportToCSV")
            //{
            //    ConfigureExport();
            //    RadGrid1.MasterTableView.ExportToCSV();
            //}
            //else if (command == RadGrid.ExportToExcelCommandName ||
            //    command == RadGrid.ExportToWordCommandName ||
            //    command == RadGrid.ExportToCsvCommandName)
            //{
            //    ConfigureExport();
            //}
            //else if (command == "ExportToWord")
            //{
            //    ConfigureExport();
            //    RadGrid1.MasterTableView.ExportToWord();
            //}
            //else if (command == "ExportToPDF")
            //{
            //    ConfigureExport();
