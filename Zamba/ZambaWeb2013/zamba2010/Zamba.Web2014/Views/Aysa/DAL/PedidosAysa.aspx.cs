...
public partial class Views_Aysa_PedidosAysa : System.Web.UI.Page
{
    long lastDocIDSelected = 0;
    long lastdoctypeid = 0; 
    private const string PAGELOCATION = "Aysa/DAL/PedidosAysa.aspx{0}";
    private const string TASKSELECTORURL = "WF/TaskSelector.ashx?DocId={0}&DocTypeId={1}";
    const string REPORTQUERY =
" select Aysa.i12362 as [Numero de Pedido], Aysa.i12475  as [Numero de Requerimiento],  " +
...
" Area.name  as [Direccion],  Aysa.i12387  as [Centro de Costo], Sitio.i12404 as [Sitio], " +
" Deposito.i12352 as [Deposito], Proceso.i12344  as [Proceso], etapa.name  as [Etapa],  " +
...
"  inner join doc_i12125 proceso on proceso.i12436 = Aysa.i12437 ORDER BY Aysa.i12362 DESC " ;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["User"] != null)
            {
                ...
                if (!Page.IsPostBack)
                {
                    this.Title = "Reporte de Pedidos Aysa" + " - Zamba Software";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            if (CheckBox2.Checked == true)
            {
                ...
                String url = "http://" + Request.ServerVariables["HTTP_HOST"] + Request.ApplicationPath + "/log/temp/exportPedidosAysa" + Zamba.Membership.MembershipHelper.CurrentUser.ID + ".xls";

                String path = Zamba.Membership.MembershipHelper.AppTempPath + "\\temp\\exportPedidosAysa" + Zamba.Membership.MembershipHelper.CurrentUser.ID + ".xls";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        try
        {
            if (CheckBox2.Checked == true)
            {
                ...
                String url = "http://" + Request.ServerVariables["HTTP_HOST"] + Request.ApplicationPath + "/log/temp/exportPedidosAysa" + Zamba.Membership.MembershipHelper.CurrentUser.ID + ".csv";

                String path = Zamba.Membership.MembershipHelper.AppTempPath + "\\temp\\exportPedidosAysa" + Zamba.Membership.MembershipHelper.CurrentUser.ID + ".csv";
