...
{
    public partial class GeneralReportStandAlone : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var sUserPreferences = new SUserPreferences();
                    rights.UpdateOrInsertActionTime(_user.ID, _user.Name, _user.puesto, _user.ConnectionId,
                                                    Int32.Parse(sUserPreferences.getValue("TimeOut",
                                                                                          Sections.UserPreferences, "30")),
                                                    type);
