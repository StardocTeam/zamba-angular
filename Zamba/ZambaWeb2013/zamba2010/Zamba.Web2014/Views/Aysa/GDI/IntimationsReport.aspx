<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntimationsReport.aspx.cs"
    Inherits="Views_Aysa_IntimationsReport" %>
...
<html>
<head runat="server">
    <title>Reporte de Intimaciones</title>
            ...
            function ResizeGrid() {
                ...
                if (radGrid0 != null) {
                    ...
                    if (radGrid0._groupPanel) {
                        ...
                        if (headerHeight + FirstHeight + grpPanelHeight + 30 > docHeight) {
