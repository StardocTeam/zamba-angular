...
namespace Zamba.WebFormEditor
{
	...
	public partial class FormEditorDD : System.Web.UI.Page
	{
		...
		private const string WEBFORMSMASTERREGION = STARTMASTERREGION +
				...
				"<script type=\"text/javascript\" src=\"../../scripts/Zamba.js\"></script><script src=\"../../scripts/Zamba.Validations.js\" type=\"text/javascript\"></script>" +
		...
		private DocType GetDocType(int DocTypeId)
		{
