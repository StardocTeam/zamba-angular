...
function searchViewModel() {
    ...
    //initialize entities
    $.getJSON('http://localhost:49864/api/Search/Entities', function (data) {
        try {
    ...
    var searchBox = new Bloodhound({
        ...
        prefetch: 'http://localhost:49864/api/Search/Suggestions',
        remote: 'http://localhost:49864/api/Search/Suggestions?text=%QUERY'
    });
