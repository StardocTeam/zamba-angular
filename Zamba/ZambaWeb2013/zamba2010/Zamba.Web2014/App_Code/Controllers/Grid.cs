...
namespace Presenters
{
    public class Grid
    {
        ...
        private const string ESTADO_TAREA_COLUMNNAME = "Estado Tarea";
        ...
        public Grid(long UserId, IGrid View, Zamba.Core.IUser user)
        {
            ...
            nombreDocumento_currUserConfig = SUserPreferences.getValue("ColumnNameNombreDelDocumento", Sections.UserPreferences, "Nombre del Documento");
            imagen_currUserConfig = SUserPreferences.getValue("ColumnNameImagen", Sections.UserPreferences, "Imagen");
            ver_currUserConfig = SUserPreferences.getValue("ColumnNameVer", Sections.UserPreferences, "Ver");
            TipoDocumento_currUserConfig = SUserPreferences.getValue("ColumnNameTipoDocumento", Sections.UserPreferences, "Tipo De Documento");
            EstadoTarea_currUserConfig = SUserPreferences.getValue("ColumnNameEstadoTarea", Sections.UserPreferences, "Estado Tarea");
            Asignado_currUserConfig = SUserPreferences.getValue("ColumnNameAsignado", Sections.UserPreferences, "Asignado");
            Situacion_currUserConfig = SUserPreferences.getValue("ColumnNameSituacion", Sections.UserPreferences, "Situacion");
            Nombre_Original_currUserConfig = SUserPreferences.getValue("ColumnNameNombreOriginal", Sections.UserPreferences, "Nombre Original");
            version_UserConfig = SUserPreferences.getValue("ColumnNameVersion", Sections.UserPreferences, "Version");
            NroVersion_UserConfig = SUserPreferences.getValue("ColumnNameNroVersion", Sections.UserPreferences, "Nro Version");
            FechaCreacion_currUserConfig = SUserPreferences.getValue("ColumnNameFechaCreacion", Sections.UserPreferences, "Fecha Creacion");
            FechaModificacion_currUserConfig = SUserPreferences.getValue("ColumnNameFechaModificacion", Sections.UserPreferences, "Fecha Modificacion");
        }
        ...
        public void LoadDocTypes()
        {
            ...
            DataTable dt = sDocType.GetDocTypesByWfStepAsDT(this.view.StepId);
        ...
        private bool GetVisibility(String ColName)
        {
            ...
            if (_hideColumns.Count == 0)
            {
                ...
                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.AssociatedWebResultGridShowIconNameColumn, -1))
                {
                ...
                //if (useVersion && Rights.GetUserRights(ObjectTypes.Grids, RightsType.AssociatedWebResultGridShowVersionColumn, -1))
                //{
                //    _hideColumns.Add(version_UserConfig.ToLower());
                //}
                //if (useVersion && Rights.GetUserRights(ObjectTypes.Grids, RightsType.AssociatedWebResultGridShowVersionNumberColumn, -1))
                //{
                //    _hideColumns.Add(NroVersion_UserConfig.ToLower());
                //}
        ...
        private bool GetVisibilityTaskGrid(String ColName)
        {
            ...
            {
                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridShowResultNameColumn, -1))
                    _hideColumnsTask.Add(nombreDocumento_currUserConfig);

                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridShowIconNameColumn, -1))
                    _hideColumnsTask.Add(imagen_currUserConfig);

                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridVerColumn, -1))
                    _hideColumnsTask.Add(ver_currUserConfig);

                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridShowTaskStateColumn, -1))
                    _hideColumnsTask.Add(EstadoTarea_currUserConfig);

                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridShowAssignedToColumn, -1))
                    _hideColumnsTask.Add(Asignado_currUserConfig);

                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridShowSituationColumn, -1))
                    _hideColumnsTask.Add(Situacion_currUserConfig);

                if (Rights.GetUserRights(ObjectTypes.Grids, RightsType.TaskWebResultGridShowOriginalName, -1))
        ...
        public bool SetColumnVisible(String name)
        {
            ...
            if (name.Contains("Ingreso"))
                return bool.Parse(SUserPreferences.getValue("ColumnCheckInVisible", Sections.WorkFlow, "False"));
            if (name.Contains("Vencimiento"))
                return bool.Parse(SUserPreferences.getValue("ColumnExpireDateVisible", Sections.WorkFlow, "False"));
