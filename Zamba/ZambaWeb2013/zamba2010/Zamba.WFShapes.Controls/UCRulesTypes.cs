...
{   
    ...
    /// </summary>
    public partial class UCRulesTypes : ZControl
    {
        ...
        /// Alejandro Ruetalo
        /// 
        public UCRulesTypes(IWFStep WFStep, Boolean ShowEditControls)
        {
        ...
        public void LoadRuleTypes()
        {
            try
            {
                if (this.wfstep != null)
                {
                    ...
                    oDiagramShape.loadWFStep(diagramControl1, this.wfstep);
        ...
        private void EditDiagram()
        {
            if (this.diagramControl1.SelectedItems.Count > 0)
            {
                if (this.diagramControl1.SelectedItems[0] is Zamba.WFShapes.IShape)
                {
                    ...
                    if (this.dDesignRule != null)
                    {

                        this.dDesignRule(shape.ZambaObject.ID, shape.ZambaObject.Name);
                    }
                }
            }
        }
