...
Public Class ZTCData
    ...
    Public Shared Function GetGeneralTypes() As DataTable
        Return Server.Con.ExecuteDataset("zsp_100_PRJ_ZGGetTypes", New Object() {}).Tables(0)
    End Function
    ...
    Public Shared Function GetAsocGeneralTypes(ByVal _projectID As Int64, ByVal Type As Int64) As DataTable
        Return Server.Con.ExecuteDataset("zsp_100_PRJ_GPGeneralTypeByPJD", New Object() {_projectID, Type}).Tables(0)
    End Function
    ...
    Public Shared Function GetTypeDescription(ByVal TypeID As Int64) As String
        Return Server.Con.ExecuteScalar("zsp_100_PRJ_ZGGetTypeDescription", New Object() {TypeID})
    End Function
End Class