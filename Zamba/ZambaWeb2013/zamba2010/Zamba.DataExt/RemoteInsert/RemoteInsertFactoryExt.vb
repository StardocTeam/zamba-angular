...
Public NotInheritable Class RemoteInsertFactoryExt
    ...
    Public Sub SaveDocumentStatus(ByVal temporaryId As Int64, ByVal statusId As Int32, ByVal ResultId As Int64, ByRef t As Transaction)
        If Server.isOracle Then
            Dim Query As New StringBuilder()
            Query.Append("UPDATE RemoteInsert SET Status=")
            Query.Append(statusId.ToString())
    ...
    Public Sub SaveTransactionStatus(ByVal transactionId As Int64, ByVal statusId As Int32, ByRef t As Transaction)
        If Server.isOracle Then
