...
namespace Zamba.Outlook
{
    ...
    public sealed class Mail
    {
        ...
        public static void SendMail(String body, Boolean isBodyHTML, String subject, List<String> toMailAdresses)
        {
            if (isBodyHTML)
        ...
        public static void SendMail(String body, Boolean isBodyHTML, String subject, List<String> toMailAdresses, List<String> ccMailAddresses)
        {
            if (isBodyHTML)
        ...
        public static void SendMail(String body, Boolean isBodyHTML, String subject, List<String> toMailAdresses, List<String> ccMailAddresses, List<String> bccMailAddresses)
        {
            if (isBodyHTML)
        ...
        public static void SendMail(String body, Boolean isBodyHTML, String subject, List<String> toMailAdresses, List<String> ccMailAddresses, List<String> bccMailAddresses, List<String> AttachmentsFilePaths)
        {
            if (isBodyHTML)
