<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TasksByWorkflow.ascx.cs"
    Inherits="Web.TasksByWorkflow" %>
...
<%--<asp:UpdatePanel runat="server" ID="udptw">
    <ContentTemplate>--%>
        ...
        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="pageView"
            ...
            <div id="PrintChart" runat="server">
                ...
                <asp:Chart ID="Chart1" runat="server" DataSourceID="ZSQL" BackColor="White" BorderlineDashStyle="Solid"
                    BackGradientStyle="LeftRight" BorderColor="#B54001" OnDataBound="Chart1_DataBound" BorderlineWidth="2" Height="300"
                    Width="450">
                    <Titles>
                    ...
                    <Series>                    
                        <asp:Series Name="Series1" ChartType="Pie" XValueMember="Etapa" Font="Trebuchet MS, 8"
                ...
                <asp:SqlDataSource ID="ZSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ZambaConnectionString %>"
                    SelectCommand="SELECT COUNT(1) AS Cantidad, WFStep.Name AS Etapa from WFStep INNER JOIN WFDocument ON wfstep.step_id  = WFDocument.step_id WHERE wfdocument.work_id = @work_id GROUP BY WFStep.Name">
                    <SelectParameters>
