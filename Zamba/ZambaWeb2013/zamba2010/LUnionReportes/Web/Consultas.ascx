<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Consultas.ascx.cs" Inherits="Web.Consultas" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<div class="design">
    <span class="title2">Consultas Pendientes</span>
</div>
    ...
    <telerik:RadPageView ID="RadPageView1" runat="server">
        ...
        <div id="ChartDiv">
            <asp:Chart ID="Chart1" runat="server" DataSourceID="ZSQL" BackColor="White" BorderlineDashStyle="Solid"
                ...
                <%--<Titles>
                    <asp:Title Name="chartTitle" ShadowColor="Gray" ShadowOffset="3" ForeColor="#1a3b69"
                        Text="Consultas Pendientes" Alignment="TopLeft" Font="Trebuchet MS, 14">
                    </asp:Title>
                </Titles>--%>
                <Series>
                    <asp:Series Name="Series1" ChartType="Pie" XValueMember="Usuario" YValueMembers="Cantidad"
            ...
            <asp:SqlDataSource ID="ZSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ZambaConnectionString %>"
                SelectCommand="select count(1) AS Cantidad, usrtable.NAME AS Usuario from doc_i26058 inner join WFDocument on WFDocument.Doc_id = doc_i26058.Doc_id and step_id = 26056 inner join usrtable on usrtable.id = I27580 group by I27580,usrtable.NAME">
            </asp:SqlDataSource>
        </div>
    </telerik:RadPageView>
    <telerik:RadPageView ID="RadPageView2" runat="server" Width="450">
        <div id="GridDiv">
            <asp:CheckBox ID="CheckBox2" Text="Ignorar paginado en exportacion a Excel/Word" runat="server">
            </asp:CheckBox>
            ...
            <asp:SqlDataSource ID="ZSQL2" runat="server" ConnectionString="<%$ ConnectionStrings:ZambaConnectionString %>"
                SelectCommand="select consulta.i26328 as 'Nro de Reclamo',consulta.i1131 as 'Asunto', reclamo.i26201 as 'FechadeSiniestro', consulta.i26561 as 'FechadeVencimiento', consulta.i26174 as 'NrodePoliza', consulta.i26457 as 'ImportePesos', consulta.i26556 as 'FechaConsulta', consulta.i26232 as 'TipoReclamo', slst_s26472.descripcion 'Creado por', slst_s27580.descripcion 'UsuarioySectores', consulta.i26247 as 'Nro Siniestro' from doc_i26058 as consulta left join slst_s26472 on consulta.i26472=slst_s26472.codigo left join slst_s27580 on consulta.i27580=slst_s27580.codigo left join doc_i26027 as reclamo on reclamo.i26260 = consulta.i26328 inner join wfdocument on consulta.doc_id=wfdocument.doc_id where wfdocument.step_id=26056   order by consulta.i26556 desc">
            </asp:SqlDataSource>
        </div>
    </telerik:RadPageView>
