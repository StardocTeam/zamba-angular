<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Reclamos.ascx.cs" Inherits="Web.Reclamos" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<div class="design">
    <span class="title2">Reclamos por etapas</span>
</div>
...
<telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="pageView"
    ...
    <telerik:RadPageView ID="RadPageView1" runat="server">
        ...
        <asp:Chart ID="Chart1" runat="server" DataSourceID="ZSQL" BackColor="White" BorderlineDashStyle="Solid"
            ...
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1" BorderColor="#404040" BackSecondaryColor="White"
                    ...
                    <Area3DStyle Enable3D="true" Rotation="180" Perspective="30" Inclination="50" IsRightAngleAxes="true"
        ...
        <asp:SqlDataSource ID="ZSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ZambaConnectionString %>"
            SelectCommand="select COUNT(1) as [Cantidad],wfstep.name as [Etapa] from doc_t26027 INNER JOIN wfdocument on wfdocument.doc_id=doc_t26027.doc_id INNER JOIN wfstep ON wfstep.step_id=wfdocument.step_id GROUP BY wfstep.name"></asp:SqlDataSource>
    </telerik:RadPageView>
