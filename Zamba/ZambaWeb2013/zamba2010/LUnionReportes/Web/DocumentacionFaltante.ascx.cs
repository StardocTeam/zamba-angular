...
namespace Web
{
    public partial class DocumentacionFaltante : System.Web.UI.UserControl
    {
        ...
        protected void Chart1_DataBound(object sender, EventArgs e)
        {
            ...
            Chart1.Titles["NoDataFound1"].Visible = isDataSourceEmpty;
            PrintChart1.Visible = !isDataSourceEmpty;  
        }
        ...
        protected void Chart2_DataBound(object sender, EventArgs e)
        {
            ...
            bool isDataSourceEmpty = Chart2.Series["Series1"].Points.Count == 0;
            Chart2.Titles["NoDataFound2"].Visible = isDataSourceEmpty;
            PrintChart2.Visible = !isDataSourceEmpty;  
        }

        protected void zsql_selected(Object sender, SqlDataSourceStatusEventArgs e)
        {
            if (e.AffectedRows < 1)
            {                
                //e.AffectedRows es la cantidad de filas que contiene el DataSource
            }
        }
