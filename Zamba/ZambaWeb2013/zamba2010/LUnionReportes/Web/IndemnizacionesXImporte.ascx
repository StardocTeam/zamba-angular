<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndemnizacionesXImporte.ascx.cs"
    Inherits="Web.IndemnizacionesXImporte" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<div class="design">
    <span class="title2">Gastos de indemnizaciones por mes</span>
</div>
...
<telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="pageView"
    ...
    <telerik:RadPageView ID="RadPageView1" runat="server">
        ...
        <asp:Chart ID="Chart1" runat="server" DataSourceID="ZSQL" OnDataBound="Chart1_DataBound" BackColor="White" BorderlineDashStyle="Solid"
        ...
        Width="450">
            ...
            <Series>
                <asp:Series Name="Series1" ChartType="Column" XValueMember="MesIngreso" YValueMembers="Importe">
                </asp:Series>
            </Series>
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1">
                <Position X="5" Y="20" Height="90" Width="90" />
                </asp:ChartArea>
            </ChartAreas>
        </asp:Chart>
        <asp:SqlDataSource ID="ZSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ZambaConnectionString %>"
            SelectCommand="select top 12 CONVERT(char(7), i26327, 111) as MesIngreso,SUM(i26206) as 'Importe' from DOC_i26037 inner join WFDocument on DOC_i26037.DOC_ID =WFDocument.Doc_ID where i26206 is not null and step_id in (26038,26044) group by CONVERT(char(7), i26327, 111)  order by MesIngreso desc">
        </asp:SqlDataSource>
    </telerik:RadPageView>
