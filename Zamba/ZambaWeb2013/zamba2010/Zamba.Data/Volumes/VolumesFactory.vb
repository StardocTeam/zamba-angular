...
#Region "GetVolumeData"
    Public Shared Function GetVolumeData(ByVal VolumeId As Integer, Optional ByVal Transaction As Zamba.Data.Transaction = Nothing) As IVolume
...
& " Disk_Vol_Size_Len,Disk_Vol_State,Disk_Vol_LstOffset,Disk_Vol_Files from Disk_Volume where disk_vol_id = " & VolumeId
        ...
        Else
            Ds = Server.Con.ExecuteDataset(Transaction.Transaction, CommandType.Text, Strselect)
        End If
        ...
        Vol.VolumeType = Ds.Tables(0)(0)("Disk_Vol_Type")
...
& " Disk_Vol_Size_Len,Disk_Vol_State,Disk_Vol_LstOffset,Disk_Vol_Files,Disk_Vol_Id from Disk_Volume  WHERE Disk_Vol_id = " & VolumeId & " order by Disk_Vol_Name"
    ...
    Public Shared Function GetTemporalVolume(ByVal DocTypeId As Int32) As IVolume
        Dim Strselect As String
        Strselect = "select Disk_Vol_Name,Disk_Vol_Size,Disk_Vol_Type,Disk_Vol_Copy,Disk_Vol_Path," _
      & " Disk_Vol_Size_Len,Disk_Vol_State,Disk_Vol_LstOffset,Disk_Vol_Files,Disk_Vol_Id from Disk_Volume WHERE Disk_Vol_ID < 0 and DISK_VOL_NAME = '" & System.Environment.MachineName & "' order by Disk_Vol_Name"
...
#Region "Document Insert"
    ...
    Public Shared Function GetVolumeListIdByEntityId(ByVal DocTypeId As Integer) As Integer
    ...
    Public Shared Function GetOffSet(ByRef Volume As IVolume) As Int32
        Try
            Dim DSize As Decimal = CDec(Volume.sizelen) / 1024
            If (DSize / (Volume.Size / 200)) + 1 <= Volume.offset Then
                Return Volume.offset
            Else
                If Volume.offset < 200 Then
                    Volume.offset += 1
                    SetLastOffSetUsed(Volume.offset, Volume.ID)
                    Return Volume.offset
                Else
