...
Public Class ZIndexReferenceDAC
    ...
    ''' <summary>
    ''' Método que permite guardar en la base de datos los correspondientes valores asociados a un índice referenciado
    ''' </summary>
    ...
    Public Shared Sub UpdateView(ByVal docTypeId As Int64, ByVal lstColKeys As Dictionary(Of String(), String), ByVal lstColIndexs As Dictionary(Of String, String), ByVal lstColSelects As Dictionary(Of String, String()))
        ...
        Zamba.Servers.Server.CreateTables.CreateView(docTypeId, lstColKeys, lstColIndexs, lstColSelects)
    End Sub

    ''' <summary>
    ''' Obtiene todos los indices a poner en el select por el id del entidad
    ''' </summary>
