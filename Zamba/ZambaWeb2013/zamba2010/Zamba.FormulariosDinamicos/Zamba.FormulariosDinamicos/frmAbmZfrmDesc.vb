...
Public Class frmAbmZfrmDesc
    ...
    Dim index As Index
    Private Const CONS_HELP_MSJ As String = "Permite agregar condiciones a indices, las mismas condicionaran el ingreso de datos a los indices"
    ...
    Public Sub New(ByRef state As DynamicFormState)
        ...
        ' Add any initialization after the InitializeComponent() call.
        _state = state
        Me.grvList.SelectionMode = DataGridViewSelectionMode.FullRowSelect
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        grvList.Rows.Clear()
        Try
            Me.Text = "Condiciones de Indices - " & _state.FormName.ToString()

            bnClose = True

            If (Me.Tag = "openFromBtnConditions") Then
                btnBack.Visible = False
                btnCancel.Location = New Point(302, 400)
            End If

            '[sebastian 24-02-2009] carga el listado de tipos de documentos
            Dim DocTypeList As DataSet = DocTypesBusiness.GetAllDocTypes

            ' [Tomas] 25/02/09  Carga los índices al cboIndexs dependiendo del tipo de documento elegido 
    ...
    ''' <summary>
    ''' Evento que se ejecuta cuando se selecciona un elemento perteneciente al combobox "Indices"
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    ''' </history>
    Private Sub cboIndexs_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboIndexs.SelectedIndexChanged
    ...
    '''    [Gaston]	16/04/2009	Modified  Se obtiene el valor del control que se genera dependiendo del índice seleccionado. Llamada a createControlOfDynamicIndex()    
    ''' </history>
    ...
    '''     [Gaston]	16/04/2009	Modified    Adaptación para verificar si el control que se crea en base al índice está vacío o no
    ''' </history>
    Private Function IsValidForm() As Boolean
        ...
        If (Display.Index.Type <> IndexDataType.Si_No) Then
            ...
            If (String.IsNullOrEmpty(Display.Index.DataTemp.Trim())) Then
                Me.ErrorProvider1.SetError(Me.btnAddToList, "Ingrese un valor")
                Display.Focus()
                Return (False)
            End If
    ...
    ''' <summary>
    ''' Método que sirve para crear un control en base al índice seleccionado en el combobox "Indices"
    ''' </summary>
    ''' <remarks></remarks>
    ''' <history>
    '''     [Gaston]	16/04/2009	Created    
    ...
    Private Sub createControlOfDynamicIndex()
        ...
        Me.panelValues.Controls.Add(Display)
    ...
    Private Sub frmAbmZfrmDesc_HelpButtonClicked(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.HelpButtonClicked
        Help.ShowPopup(lblOpRelacion, CONS_HELP_MSJ, New Point(Me.Location.X + lblOpRelacion.Location.X, Me.Location.Y + lblOpRelacion.Location.Y))
    End Sub
