...
Public Class frmAbmDynamicForms
    ...
    Private Const CONS_HELP_MSJ As String = "Permite agregar y ubicar indices dentro del formulario dinamico, Se puede agregar en distintas filas y distintas columnas, Luego desde la grilla de visualizacion se permite ordenar en su aparicion, por columnas y por secciones"
#Region "ctr"
...
#End Region
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            'Cargo los índices guardados en la tabla anterior
    ...
    ''' <summary>
    ''' Carga el listado de indices ingresados en el AMB anterior.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ''' <history> [sebastian 24-02-2009]Carga el listado de indices
    '''           [Tomas] 26/02/09      Se cargan los índices ingresados en el AMB anterior y las secciones.
    ...
    ''' </history>
    Private Sub frmAbmDynamicForms_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Me.Text = "Opciones de visualización - " & _state.FormName
    ...
    ''' </history>
    Private Sub btnAddSections_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddSections.Click
        ...
        If (frmSections.DialogResult = Windows.Forms.DialogResult.OK) Then
    ...
    Private Sub AddItem(ByVal indexid As Int64, ByVal indexname As String, ByVal sectionid As Int64, ByVal sectionname As String, ByVal order As String)
        ...
        'Remueve el índice agregado al dgv del combo
    ...
    ''' </history>
    Private Sub tnAddToList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddToList.Click
    ...
    ''' <remarks></remarks>
    ''' <history>
    ''' [Tomas 10/03/09] Modified - Se modifica para que no acepte 2 índices.
    ''' </history>
        ...
        Try
            ...
            If dgrvValuesList.Rows.Count <> 0 Then
                ...
                For Each dgvr As DataGridViewRow In selectedRows
                    ...
                    'Agrego una fila al dsIndices con los valores del índice removido
        ...
        Try
            ...
            If (Secciones1.Count <> 0) Then
                ...
                If (IsNothing(frmIndexEdition)) Then
                    ...
                    ' Llamo al formulario que define los índices
                    frmIndexEdition = New frmABMZfrmIndexsDesc(_state)

                    RemoveHandler frmIndexEdition.showPreviousForm, AddressOf Me.showForm
                    RemoveHandler frmIndexEdition.closeForms_, AddressOf Me.closeForms
                    AddHandler frmIndexEdition.showPreviousForm, AddressOf Me.showForm
                    AddHandler frmIndexEdition.closeForms_, AddressOf Me.closeForms
            ...
            Else
                ...
                ErrorProvider1.SetError(Me.btnAddToList, "Debe agregar un índice como mínimo.")
            End If
    ...
    Private Sub SaveValuesToState()
        ...
        'Agrego, modifico y elimino los nuevos índices
        For Each Row As DataGridViewRow In dgrvValuesList.Rows
            orden += 1
    ...
    Private Sub OrderUpByFila(ByRef dt As DataTable)
        ...
        If selectedrowindex = 0 Then
            MessageBox.Show("El indice ya se encuentra en el nivel superior", "Zamba")
            Exit Sub
        End If
    ...
    Private Sub OrderDownByFila(ByRef dt As DataTable)
        ...
        If selectedrowindex = dgrvValuesList.Rows.Count - 1 Then
            MessageBox.Show("El indice ya se encuentra en el nivel inferior", "Zamba")
            Exit Sub
        End If
    ...
    Private Sub frmAbmDynamicForms_HelpButtonClicked(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.HelpButtonClicked
        Help.ShowPopup(btnAddSections, CONS_HELP_MSJ, New Point(Me.Location.X + btnAddSections.Location.X, Me.Location.Y + btnAddSections.Location.Y))
    End Sub
End Class