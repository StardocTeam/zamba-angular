...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("DISEÑO DE REGLA"), RuleHelp("Brinda ayuda para diseñar reglas si/no de manera semántica.")]
    [ToolboxItem(typeof(ParallelToolboxItem))]
    [Designer(typeof(ParallelDesigner), typeof(IDesigner))]
public partial class IfDesign : ZCompositeRule, IResultActivity, IIfDesign
	{
        public IfDesign()
		{
			InitializeComponent();
        ...
        protected override ActivityExecutionStatus Execute(ActivityExecutionContext executionContext)
        {
            for (int child = 0; child < this.EnabledActivities.Count; child++)
            {
                ...
                Zamba.WFExecution.PlayIfDesign play =
                new Zamba.WFExecution.PlayIfDesign();
                play.Play(this.Results, (Zamba.Core.IIfDesign)this);
