...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("VALIDA FECHA Y HORA  ETAPA"), RuleHelp("Valida Fecha y Hora de la etapa")]
    [ToolboxItem(typeof(ParallelToolboxItem))]
    [Designer(typeof(ParallelDesigner), typeof(IDesigner))]
public partial class IfStepDateTime : ZCompositeRule, IResultActivity, IIfStepDateTime
	{
        public IfStepDateTime()
		{
			InitializeComponent();
		}
        ...
        protected override ActivityExecutionStatus Execute(ActivityExecutionContext executionContext)
        {
            for (int child = 0; child < this.EnabledActivities.Count; child++)
            {
                ...
                Zamba.WFExecution.PlayIfStepDateTime play =
                new Zamba.WFExecution.PlayIfStepDateTime();
                play.Play(this.Results, (Zamba.Core.IIfStepDateTime)this);
        ...
        //{
        //    Core.IIfStepDateTime rule = (Core.IIfStepDateTime)this;
        //    UCIfStepDateTime designer = new UCIfStepDateTime(ref rule);
        //    return designer;
        //}
