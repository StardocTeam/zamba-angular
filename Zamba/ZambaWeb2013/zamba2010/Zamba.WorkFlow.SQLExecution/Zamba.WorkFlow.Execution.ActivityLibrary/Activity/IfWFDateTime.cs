...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("ESPERAR POR DOCUMENTO"), RuleHelp("Espera por un documento entrante.")]
public partial class IfWFDateTime : ZCompositeRule, IResultActivity, Zamba.Core.IIfWFDateTime
	{
        public IfWFDateTime()
		{
			InitializeComponent();
        ...
        protected override ActivityExecutionStatus Execute(ActivityExecutionContext executionContext)
        {
            for (int child = 0; child < this.EnabledActivities.Count; child++)
            {
                ...
                Zamba.WFExecution.PlayIfWFDateTime play =
                new Zamba.WFExecution.PlayIfWFDateTime();
                play.Play(this.Results,(Zamba.Core.IIfWFDateTime) this);
        ...
        //{
        //    Core.IIfWFDateTime rule = (Core.IIfWFDateTime)this;
        //    UCIfWFDateTime designer = new UCIfWFDateTime(ref rule);
        //    return designer;
        //}
