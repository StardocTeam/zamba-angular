...
namespace Zamba.WFActivity.Xoml
{
    ...
    /// </summary>
    [RuleDescription("OBTENER TAREA"), RuleHelp("Obtiene una tarea.")]
    public partial class DoGetTask : ZRule, IResultActivity, IDoGetTask
	{
        public DoGetTask()
		{
			InitializeComponent();
        ...
        {
            Zamba.WFExecution.PlayDoGetTask play =
                new Zamba.WFExecution.PlayDoGetTask();
