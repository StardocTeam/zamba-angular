    ...
    Public Class vEvent
        ...
        Public Function ToString_Backup() As String
            ...
            For Each att As String In Attendee
                result.AppendFormat("ATTENDEE;CN=""{0}"";RSVP=TRUE:mailto:{0}{1}", att, System.Environment.NewLine)
            Next
            ...
            If AllDayEvent Then
                result.AppendFormat("DTSTART;VALUE=DATE:{0}{1}", DTStart.ToUniversalTime.ToString("yyyyMMdd"), System.Environment.NewLine)
                result.AppendFormat("DTEND;VALUE=DATE:{0}{1}", DTEnd.AddDays(1).ToUniversalTime.ToString("yyyyMMdd"), System.Environment.NewLine)
            Else
            ...
            If AllDayEvent Then
                result.AppendFormat("TRANSP:TRANSPARENT{0}", System.Environment.NewLine)
                result.AppendFormat("X-MICROSOFT-CDO-BUSYSTATUS:FREE{0}", System.Environment.NewLine)
            Else
                result.AppendFormat("TRANSP:OPAQUE{0}", System.Environment.NewLine)
                result.AppendFormat("X-MICROSOFT-CDO-BUSYSTATUS:BUSY{0}", System.Environment.NewLine)
            End If

            result.AppendFormat("X-MICROSOFT-CDO-IMPORTANCE:1{0}", System.Environment.NewLine)
            result.AppendFormat("X-MICROSOFT-DISALLOW-COUNTER:FALSE{0}", System.Environment.NewLine)
            result.AppendFormat("X-MS-OLK-ALLOWEXTERNCHECK:TRUE{0}", System.Environment.NewLine)
            result.AppendFormat("X-MS-OLK-CONFTYPE:0{0}", System.Environment.NewLine)
        ...
        Public Overrides Function ToString() As String
            ...
            result.AppendFormat("LOCATION:{0}{1}", Location, System.Environment.NewLine)
            result.AppendFormat("TRANSP:OPAQUE{0}", System.Environment.NewLine)
            result.AppendFormat("SEQUENCE:0{0}", System.Environment.NewLine)
            result.AppendFormat("UID:{0}{1}", UID, System.Environment.NewLine)
            result.AppendFormat("DTSTAMP:{0}{1}", Now.ToUniversalTime.ToString("yyyyMMdd\THHmmss\Z"), System.Environment.NewLine)
            result.AppendFormat("SUMMARY:{0}{1}", Summary, System.Environment.NewLine)
            result.AppendFormat("DESCRIPTION:{0}{1}", Description, System.Environment.NewLine)
