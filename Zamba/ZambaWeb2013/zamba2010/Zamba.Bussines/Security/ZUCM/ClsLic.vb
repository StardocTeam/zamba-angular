...
Public Class ClsLic
    ...
    ''' </history>
    Public Shared ReadOnly Property AllowedConections(ByVal type As Int32) As Int32
    ...
    Public Function GetLicenseCount(ByVal licType As LicenseType) As String
        ...
        lic = zoptb.GetValue("DocLicUse")

        'Si se utiliza la obtiene, sino obtiene la vieja y la actualiza
        If String.IsNullOrEmpty(lic) = False AndAlso String.Compare(Encryption.DecryptNewString(lic), "OK") = 0 Then
            lic = Encryption.DecryptNewString(zoptb.GetValue(GetZoptLicValue(licType)))
        Else
    ...
    Private Function GetOldLicense(ByVal licType As LicenseType) As String
        ...
        Select Case licType
            Case LicenseType.Documental
                Return UB.VerLicenciasDocumentales
            Case LicenseType.Workflow
                Return UB.VerLicenciasWorkFlow
        End Select
    End Function
End Class