...
Public Class SecurityOptions
    ...
    Public Shared Function ClaveVencida(ByVal UserId As Int32) As Boolean
        ...
        Try
            ...
            If Boolean.Parse(UP.getValue("ExternalUser", UPSections.UserPreferences, "False", UserId)) = False Then
...
#End Region
    ...
    Public Shared Function IsValidPassword(ByVal userid As Int64, ByVal username As String, ByVal password As String, ByVal PswHasChanged As Boolean) As Boolean
        ...
        Return True
    End Function
    Public Shared Function IsAlfanumeric(ByVal password As String) As Boolean
        ...
        End If
    End Function
    Public Shared Function Repetida(ByVal userid As Int32, ByVal password As String) As Boolean
        ...
        If ds.Tables(0).Rows.Count = 0 Then
            Return False
        Else
            If DateDiff(DateInterval.Month, CDate(ds.Tables(0).Rows(0).Item(0)), Now) < 12 Then
                Return True
            Else
                Return False
            End If
    ...
    Public Shared Function MustLockUser() As Boolean
        If Zamba.Servers.Server.Con.ExecuteScalar(CommandType.Text, "Select lockuser from ZSecOption") = "TRUE" Then
            Return True
        Else
            Return False
        End If
    ...
    Public Shared Sub SetConfig(ByVal expiredtime As Int16, ByVal acceptnull As String, ByVal sameuser As String, ByVal samemachine As String, ByVal lockuser As String, ByVal email As String, ByVal actualizar As Boolean, ByVal longitud As Boolean, ByVal alfanumerico As Boolean, ByVal CanRepeat As Boolean, ByVal userId As Int64)
        ...
        End If
        Dim UB As UserBusiness
        'Guardo la accion en la columna U_Time de UCM y en User_Hst para el manejo de sesion y el historial de acciones
        UB.SaveAction(userId, ObjectTypes.Security, RightsType.Edit, "Se modifico la configuracion de Seguridad")
        UB = Nothing
    End Sub
        ...
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                Else
                    Me.SameUser = True
                End If
                Me.Expired = ds.Tables(0).Rows(0).Item(1)
                ...
                If String.Compare(ds.Tables(0).Rows(0).Item(6).ToString, "FALSE") = 0 Then
                    Me.LongitudMinima = False
                Else
                    Me.LongitudMinima = True
                End If
                If String.Compare(ds.Tables(0).Rows(0).Item(7).ToString, "FALSE") = 0 Then
                    Me.Alfanumerico = False
                Else
                    Me.Alfanumerico = True
                End If
