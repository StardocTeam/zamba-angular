...
Public Class ActionsBusiness
    ...
    Public Shared Function GetUserActions(ByVal UserId As Int64) As DataSet
        ...
        Return dsHistory
    End Function
    Public Shared Sub SaveActioninDB(ByVal ObjectId As Int64, ByVal ObjectType As Zamba.ObjectTypes, ByVal ActionType As Zamba.Core.RightsType, ByVal S_Object_ID As String, ByVal _userid As Int32, ByVal ConnectionId As Int32)
