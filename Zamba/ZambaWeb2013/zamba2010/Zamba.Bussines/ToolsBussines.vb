...
Public Class ToolsBusiness
    ...
    Public Shared Function ValidateComp(ByVal value1 As String, ByVal value2 As String, ByVal comptype As Comparadores, ByVal tmpCaseInsensitive As Boolean, Optional ByVal r As Result = Nothing) As Boolean
        ...
        If value1 Is Nothing OrElse String.IsNullOrEmpty(value1) Then value1 = ""
        If value2 Is Nothing OrElse String.IsNullOrEmpty(value2) Then value2 = ""
        If Decimal.TryParse(value1, valor1) And Decimal.TryParse(value2, valor2) Then

            If value1.Contains(".") Then
                value1 = value1.Replace(".", ",")
                Decimal.TryParse(value1, valor1)
            End If
            If value2.Contains(".") Then
                value2 = value2.Replace(".", ",")
                Decimal.TryParse(value2, valor2)
            End If
        ...
        Else
            ...
            End Select
        End If
        ZTrace.WriteLineIf(ZTrace.IsInfo, "No se valida")
        Return False
    End Function
    Public Shared Function GetZiteMap() As DataSet
        Return CoreData.GetZsiteMap()
    End Function
...
#Region "Global Variable Bussines"
    ...
    Public Sub loadGlobalVariables()
        Try
            ...
            If (ZOPT.GetValue("Environment") IsNot Nothing) Then

                Dim ds As DataSet = ToolsBusiness.GetGlobalVariablesByEnvironment(ZOPT.GetValue("Environment"))

                For Each dr As DataRow In ds.Tables(0).Rows
                    If (VariablesInterReglas.ContainsKey(dr(1)) = False) Then
                        VariablesInterReglas.Add(dr(1), dr(2))
                    End If
                Next
