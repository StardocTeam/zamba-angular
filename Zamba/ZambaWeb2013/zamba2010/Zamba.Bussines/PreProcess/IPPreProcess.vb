...
Public Class PreProcessFactory
    ...
    Public Shared Function ReturnpreProcessInstance(ByVal PreProcessName As String) As Ipreprocess
        Dim a As Reflection.Assembly = System.Reflection.Assembly.LoadFile(Membership.MembershipHelper.AppConfigPath & "\Zamba.PreProcess.dll")
    ...
    Public Shared Function getPreprocess(ByVal id As Integer) As ArrayList
        ...
        Try
            dsp = PreProcess_Factory.GetPreProcessById(id)
    ...
    Public Shared Function GetProcessByUser(ByVal user As IUser) As ArrayList
        ...
        Return ProcessFactory.GetProcessByUserId(MembershipHelper.CurrentUser.ID)
    End Function
    ...
    Private Shared Function GetRight(ByVal user As IUser, ByVal processId As Integer) As Boolean
        Return RightsBusiness.GetUserRights(user, Zamba.ObjectTypes.Preproceso, Zamba.Core.RightsType.Use, processId)
    End Function
    ...
    Public Shared Function getmethods() As ArrayList
        ...
        Dim asem As Reflection.Assembly = System.Reflection.Assembly.LoadFile(Membership.MembershipHelper.AppConfigPath & "\Zamba.PreProcess.dll")
