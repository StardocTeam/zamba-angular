Imports Zamba.Core.Access.Server
Imports Zamba.Data
Public Class CreateTablesBusiness
    ...
    End Sub
    'TODO ERROR: REFERENCIAR DE Business A SERVER NO SE PUEDE< DEBE SER A TRAVEZ DE DATA
    Public Sub CreateSustitucionTable(ByVal Index As Integer, ByVal IsAlphanumeric As Boolean, ByVal IndexLen As Int32) 'Implements Servers.CreateTables.CreateSustitucionTable
        CreateTablesFactory.CreateSustitucionTable(Index, IsAlphanumeric, IndexLen)
    End Sub
    'TODO ERROR: REFERENCIAR DE Business A SERVER NO SE PUEDE< DEBE SER A TRAVEZ DE DATA
