...
Public Class NotifyBusiness
    ...
    Public Function GetMails(ByVal typeGroupToNotify As GroupToNotifyTypes, ByVal idGroupToNotify As Int64, ByRef mailsToNotify As List(Of String)) As Boolean
    ...
    End Function
    Public Function GetMails(ByVal typeGroupToNotify As GroupToNotifyTypes, ByVal docIds As Generic.List(Of Int64), ByRef mailsToNotify As List(Of String)) As Boolean
    ...
    '    If MessageBox.Show("Hay usuarios sin cuentas de mail definidas, ¿Desea continuar el envio?", "Zamba", MessageBoxButtons.YesNo, MessageBoxIcon.Information) =DialogResult.Yes Then
    '        For Each mail As String In externalMails
    '            mails.Add(mail)
    '        Next
    ...
    '         If String.Compare(Zamba.Membership.MembershipHelper.CurrentUser.eMail.Mail, String.Empty) <> 0 Then
    '             'Obtiene todos los usuarios seleccionados y de grupos
    '             UsersIds = GetAllUserIDsToNotify(typeGroupToNotify, idGroupToNotify)
    '             For Each userid As Int64 In UsersIds
    '                 reciepusers.Add(userid)
    ...
    Public Shared Function GetGroupToNotifyAllUsers(ByVal typeid As GroupToNotifyTypes, ByVal Id As Int64) As List(Of Int64)
        ...
        Try
            ...
            For Each groupID As String In lstGroupIDs
                ...
                tmpUserList = UB.GetGroupUsers(Int64.Parse(groupID))
    ...
    Public Shared Function GetGroupToNotifyUserGroups(ByVal typeId As GroupToNotifyTypes, ByVal docIds As Generic.List(Of Int64)) As List(Of Int64)
        ...
        Return tmpUserGroups
    End Function
    Public Function GetAllUserIDsToNotify(ByVal typeID As GroupToNotifyTypes, ByVal groupID As Int64) As List(Of Int64)
        ...
        For Each gID As Int64 In tmpGroupIDs
            For Each uID As Int64 In UserGroupBusiness.GetUsersIds(gID)
        ...
        Return tmpUserIDs2
    End Function
    Public Function GetAllUserIDsToNotify(ByVal typeID As GroupToNotifyTypes, ByVal docIds As Generic.List(Of Int64)) As List(Of Int64)
