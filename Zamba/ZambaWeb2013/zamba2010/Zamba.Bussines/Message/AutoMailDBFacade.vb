...
Public Class AutoMailDBFacade
    ...
    Public Shared Sub Save(ByVal automail As AutoMail)
        ...
        UserBusiness.SaveAction(automail.ID, ObjectTypes.ModuleAutoMail, RightsType.Edit, "Se ha modificado el automail: " & automail.Name)
    End Sub
    ...
    Public Shared Function GetNew(ByVal name As String) As AutoMail
        Try
            ...
            NewAutomail.From = MembershipHelper.CurrentUser.eMail.Mail
    ...
    Public Shared Sub Insert(ByVal am As AutoMail)
        ...
        'Guardo la accion en la columna U_Time de UCM y en User_Hst para el manejo de sesion y el historial de acciones
        UserBusiness.SaveAction(am.ID, ObjectTypes.ModuleAutoMail, RightsType.insert, "Se ha creado un nuevo automail: " & am.Name)
    End Sub
    ...
    Public Shared Sub Remove(ByVal Am As AutoMail)
        ...
        'Guardo la accion en la columna U_Time de UCM y en User_Hst para el manejo de sesion y el historial de acciones
        UserBusiness.SaveAction(Am.ID, ObjectTypes.ModuleAutoMail, RightsType.Delete, "Se ha eliminado el automail: " & Am.Name)
    End Sub

    'Public Shared Sub SendAutoMail(ByVal automail As AutoMail)
    '    Dim CurrentAutoMail As IMailMessage = Zamba.Core.MessagesBusiness.GetMessage(MembershipHelper.CurrentUser.eMail.Type) 'Servers.Server.MailType)
    ...
    '    If AddIndexs Then
    '        Dim TextoIndices As String = "Indices: " & vbNewLine & vbNewLine
