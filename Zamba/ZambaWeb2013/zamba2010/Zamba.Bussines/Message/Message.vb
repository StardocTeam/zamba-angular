...
#End Region
    ...
    Public Function getResend() As IInternalMessage Implements IInternalMessage.getResend
        Dim msg As New InternalMessage(Zamba.Membership.MembershipHelper.CurrentUser)
    ...
    Public Sub Send() Implements IInternalMessage.Send
        ...
        Me.De = Convert.ToInt32(Zamba.Membership.MembershipHelper.CurrentUser.ID) 'Id Usuario que envia mensaje
...
#End Region
    ...
    Public Shared Sub SendInternalMessage(ByVal subject As String, ByVal fecha As Date, ByVal body As String, ByVal receiptUsers As Generic.List(Of User), ByVal SendType As MessageType)
        Dim msj As New InternalMessage(Zamba.Membership.MembershipHelper.CurrentUser.ID)
        msj.Body = body
        msj.Subject = subject
        msj.Fecha = fecha
