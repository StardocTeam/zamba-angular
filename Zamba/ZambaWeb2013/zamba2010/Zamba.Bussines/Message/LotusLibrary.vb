...
Public Class MailLibrary
    ...
    Private Shared Sub ArreglarXML(ByVal path As String)
        ...
        Dim filetemp As New IO.StreamWriter(Membership.MembershipHelper.AppTempPath & "\Temp.xml", False)
        ...
        file.Close()
        filetemp.Close()
        IO.File.Copy(Membership.MembershipHelper.AppTempPath & "\temp.xml", path, True)
        IO.File.Delete(Membership.MembershipHelper.AppTempPath & "\temp.xml")
    End Sub
End Class
...
Public Class LotusDestArrayList
    ...
    Public Overloads Sub Add(ByVal Direction As String, ByVal mt As MessageType)
        Me.Add(New Destinatario(Direction, mt, String.Empty))
    End Sub
