...
Public Class ImportsBusiness
    ...
    Public Shared Function DeleteRow(ByVal Row As dsIPFolder.IP_FolderRow) As Boolean
        ...
        If deleted = True Then
            ...
            UserBusiness.SaveAction(Row.ID, ObjectTypes.ModuleMonitor, RightsType.Delete, "Se elimino el monitoreo: " & Row.NOMBRE)
        End If
        Return deleted
    End Function
    ...
    Public Shared Function UpdateRow(ByVal Row As dsIPFolder.IP_FolderRow) As Boolean
        ...
        If updated = True Then
            'Guardo la accion en la columna U_Time de UCM y en User_Hst para el manejo de sesion y el historial de acciones
            UserBusiness.SaveAction(Row.ID, ObjectTypes.ModuleMonitor, RightsType.Edit, "Se actualizo el monitoreo: " & Row.NOMBRE)
        End If
    ...
    Public Shared Function StoreRow(ByVal Row As dsIPFolder.IP_FolderRow) As Boolean
        ...
        If saved = True Then
            'Guardo la accion en la columna U_Time de UCM y en User_Hst para el manejo de sesion y el historial de acciones
            UserBusiness.SaveAction(iID, ObjectTypes.ModuleMonitor, RightsType.insert, "Se elimino el monitoreo: " & Row.NOMBRE)
        End If
    ...
    Public Shared Function StoreIpFolderRow(ByVal Row As dsIPFolder.IP_FolderRow) As Decimal
        ...
        If saved = True Then
            'Guardo la accion en la columna U_Time de UCM y en User_Hst para el manejo de sesion y el historial de acciones
            UserBusiness.SaveAction(iId, ObjectTypes.ModuleMonitor, RightsType.insert, "Se inserto el monitoreo: " & Row.NOMBRE)
        End If
