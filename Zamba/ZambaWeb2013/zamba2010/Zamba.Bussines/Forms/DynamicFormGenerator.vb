...
Public Class DynamicFormGenerator
    ...
    Public Function GetTableHeader(ByVal SectionId As String)
        ...
        title.AppendLine(FF.GetDynamicFormSectionName(SectionId))
    ...
    Public Function GetControlHtml(ByVal ControlType As String, ByVal ControlId As Integer, ByVal ControlName As String, ByVal readOnlyAttribute As String)
        Select Case ControlType
            Case "0"
                ...
                Return ("<input type=""text"" id=""zamba_index_" & ControlId & """ name=""zamba_index_" & ControlId & """ " & readOnlyAttribute & "/>")

            Case "1", "3"
                Dim SelectControl As New StringBuilder()
                ' [Gaston 04/03/2009] Se define un alto y ancho para el combobox
                SelectControl.AppendLine("<select id=""zamba_index_" & ControlId & """ name=""zamba_index_" & ControlId & """ " & readOnlyAttribute & "/>")
            ...
            Case "2", "4"
                ...
                ' [Gaston 04/03/2009] Se define un alto y ancho para el combobox
                SustitutionList.AppendLine("<select style=""height: 21px; width: 290px"" id=""zamba_index_" & ControlId & """ name=""zamba_index_" & ControlId & """ " & readOnlyAttribute & "/>")
                ...
                If Int32.TryParse(ControlId, Atributo) = True Then
                    ...
                    SustLisTable = ASB.GetIndexData(Atributo, False)
                    ASB = Nothing
                End If
    ...
    Private Sub buildControlHTML(ByVal CellValue As DataRow, ByRef strhtml As StringBuilder, ByRef readOnlyAttribute As String)
        ...
        If CellValue.Table.Columns.Contains("IdIndice") = True AndAlso CellValue.Table.Columns.Contains("IdFormulario") = True Then
            dsValues = FB.getValuesOfReadOnlyAndVisibleIndex_Of_DynamicForm(CellValue("IdFormulario"), CellValue("IdIndice"))
        End If

        If Not (IsNothing(dsValues)) Then

            ' Si el Atributo tiene asignado las propiedades "Sólo Lectura" y "Visible" o una de las dos
    ...
    Public Function GetNewTableCell(ByVal CellValue As DataRow, ByVal NewColumn As String, ByVal CloseRow As Boolean, ByVal labelName As String)
        ...
        If String.Compare(labelName, String.Empty) = 0 Or String.Compare(labelName.ToLower, "index_name") = 0 Then
            ...
            Else
                indexname = IndexsBusiness.GetIndexName(CellValue("index_id"))
            End If
        Else
            ...
            Try
                ...
                For Each CurrentRow As DataRow In dsFormTable.Tables(0).Rows
                    ...
                    Else
                        ...
                        ' [Gaston 13/03/2009] Después de definirse la apertura de una tabla se inserta el Atributo
                        NewColumn = "true"
                        CloseRow = False
                        strgHtml.AppendLine(GetNewTableCell(CurrentRow, NewColumn, CloseRow, labelName).ToString())
                ...
                '    Dim dir As New DirectoryInfo(Application.StartupPath & "\temp\")
                '    dir.Create()
                'End If
                ...
                strgHtml.Replace(strgHtml.ToString, FB.RepairHtml(strgHtml.ToString))
    ...
    Public Function UpdateTable(ByVal dsFormTable As DataSet, ByVal HTML As String, ByVal frmName As String, Optional ByVal OverrideFile As Boolean = False, Optional ByVal LabelName As String = "") As String
        ...
        Try
            ...
            strTablaDatos.Replace(strTablaDatos.ToString, FB.RepairHtml(strTablaDatos.ToString))
