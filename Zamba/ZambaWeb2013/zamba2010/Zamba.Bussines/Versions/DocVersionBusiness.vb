...
Public Class DocVersionBusiness
    ...
    Private Shared firstTimeShowConverstationsOfAllVersions As Boolean = True
    ...
    Public Shared ReadOnly Property VersionType() As DocVersion
        Get
            If firstTimeVersionType Then
                ...
                Dim version As String = ZOPTB.GetValue("DocVersionMode")
                ZOPTB = Nothing
    ...
    Public Shared ReadOnly Property ReplaceWfDocVersion() As Boolean
        Get
            If firstTimeReplaceVersion Then
                ...
                Dim replace As String = ZOPTB.GetValue("ReplaceWfDocVersion")
                ZOPTB = Nothing
    ...
    Public Shared ReadOnly Property ShowAssocLastVersion() As Boolean
        Get
            If firstTimeShowAssocLastVersion Then
                ...
                Dim show As String = ZOPTB.GetValue("ShowAssocLastVersion")
                ZOPTB = Nothing
        ...
        End Get
    End Property
    Public Shared ReadOnly Property ShowConverstationsOfAllVersions() As Boolean
        Get
            If firstTimeShowConverstationsOfAllVersions Then
                Dim ZOPTB As New ZOptBusiness

                Dim show As String = ZOPTB.GetValue("ShowConverstationsOfAllVersions")
                ZOPTB = Nothing
                If String.IsNullOrEmpty(show) Then
                    ZOptBusiness.Insert("ShowConverstationsOfAllVersions", "False")
                    _showConverstationsOfAllVersions = False
                Else
                    _showConverstationsOfAllVersions = Boolean.Parse(show)
                End If
                firstTimeShowConverstationsOfAllVersions = False
                show = Nothing
            End If
            Return _showConverstationsOfAllVersions
        End Get
    End Property
    Public Shared ReadOnly Property UseVersion() As Boolean
        Get
            If firstTimeUseVersionRight Then
                ...
                _useVersionRight = RiB.GetUserRights(Zamba.Membership.MembershipHelper.CurrentUser.ID, ObjectTypes.ModuleVersions, RightsType.Use)
                RiB = Nothing
            End If
    ...
    End Sub
    Public Shared Sub SaveShowConverstationsOfAllVersions(ByVal showConverstations As Boolean)
        If firstTimeShowConverstationsOfAllVersions Then
            ZOptBusiness.Insert("ShowConverstationsOfAllVersions", showConverstations)
            firstTimeShowConverstationsOfAllVersions = False
        Else
            ZOptBusiness.Update("ShowConverstationsOfAllVersions", showConverstations)
        End If
        _showConverstationsOfAllVersions = showConverstations
    End Sub
    ...
    Public Shared Sub ForceFirstTime()
        ...
        firstTimeShowConverstationsOfAllVersions = True
    End Sub
End Class
