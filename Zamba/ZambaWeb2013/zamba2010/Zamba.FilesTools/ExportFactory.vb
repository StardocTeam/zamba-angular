...
Public Class ExportFactory
    ...
    Public Shared Sub InsertIncomingMail(ByVal userId As Int64, ByVal codigo As String, ByVal DocTypeId As Int64)
        If Server.ServerType = Server.DBTYPES.OracleClient Or Server.ServerType = Server.DBTYPES.Oracle9 Or Server.ServerType = Server.DBTYPES.Oracle Then
            ...
            Server.Con.ExecuteNonQuery("ZSP_EXPORTMAIL_200.InsertIncomingMail", parNames, parTypes, parValues)
        Else
    ...
    Public Shared Sub SetMailInserted(ByVal codigo As String)
        If Server.ServerType = Server.DBTYPES.OracleClient Or Server.ServerType = Server.DBTYPES.Oracle9 Or Server.ServerType = Server.DBTYPES.Oracle Then
            ...
            Server.Con.ExecuteNonQuery("ZSP_EXPORTMAIL_100.SetMailInserted", parNames, parTypes, parValues)
        Else
