...
#Region "Get"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetAllWorkflowsInEntityView() As System.Collections.Generic.List(Of Zamba.Core.EntityView)
        Dim hs As New System.Collections.Generic.List(Of Zamba.Core.EntityView)
        Dim dt As DataTable

        dt = Zamba.Data.WFStepsFactory.GetAllWFsAndStepIdsAndNamesAndTaskCount()
    ...
    Public Shared Function GetAllWorkflows() As DsWF
        Return WFFactory.GetWFs(0)
    End Function
    Public Shared Function GetWf(ByVal r As DsWF.WFRow) As WorkFlow
        Return WFFactory.GetWf(r)
    End Function
    ...
    ''' </history>
    Public Shared Function GetStepNameByWFId(ByVal stepid As Int64) As String
        Return WFFactory.GetStepNameByStepId(stepid)
    End Function
    Public Shared Function GetWFsByDocType() As DsWFsByDocType
        Return WFFactory.GetWFsByDocType()
    End Function
    Public Shared Function GetWFStepsDetails() As DsWFStepDetails
        Return WFFactory.GetWFStepsDetails()
    End Function
...
#Region "Rules"
    ...
    ''' </history>
    Public Shared Function GetUserActionName(ByVal ruleid As Int64, wfstepid As Int64, rulename As String, ByVal WithCache As Boolean) As String
        Try
    ...
    Public Shared Function recoverItemsSelected(stepid As Int64, ByVal ruleId As Int64, ByVal sectionId As Integer, ByVal item1 As RulePreferences, ByVal item2 As RulePreferences, ByVal item3 As RulePreferences, ByVal useCache As Boolean) As DataTable
        ...
        Try
            ...
            dv = New DataView(dt)
            dv.RowFilter = "ruleid = " & ruleId & "and SectionId = " & sectionId & " And (ObjectId = " & _
    ...
    Public Shared Function CanExecuteRules(ByVal ruleid As Int64, ByVal userid As Int64) As Boolean
        Return WFFactory.CanExecuteRules(ruleid, userid)
    End Function
...
#Region "Get"
    ...
    Public Shared Function GetWFs(ByVal UserID As Int32) As DsWF
        Return WFFactory.GetWFs(UserID)
    End Function
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Shared Function GetWFsByUserRightsEDIT(ByVal UserID As Int64) As DsWF
        Dim grpids As New Generic.List(Of Int64)
        grpids = UserBusiness.GetUserGroupsIdsByUserid(UserID)
        If Not IsNothing(grpids) Then
            Return WFFactory.GetWFsByUserRightsEDIT(grpids)
        Else
            Return Nothing
        End If
    End Function
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Shared Function GetWFsByUserRightMONITORING(ByVal UserID As Int64) As DsWF
        Dim grpids As New Generic.List(Of Int64)
        grpids = UserBusiness.GetUserGroupsIdsByUserid(UserID)
        If Not IsNothing(grpids) Then
...
#Region "ABM"
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Shared Sub SaveWfChanges(ByVal DsWf As DsWF)
