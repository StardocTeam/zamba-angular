Public Class ListViewResultComparer
    ...
    Public CompararPor As Zamba.Core.IndexDataType
    ...
    End Sub
    '
    Public Overridable Function Compare(ByVal a As Object, ByVal b As Object) As Integer Implements IComparer.Compare
        ...
        Try
            ...
            Select Case CompararPor
                Case Core.IndexDataType.Fecha, Core.IndexDataType.Fecha_Hora
                    ...
                    End Try
                Case Core.IndexDataType.Numerico, Core.IndexDataType.Numerico_Decimales, Core.IndexDataType.Numerico_Largo
                    ' Si da error, se comparan como cadenas
                    Try
