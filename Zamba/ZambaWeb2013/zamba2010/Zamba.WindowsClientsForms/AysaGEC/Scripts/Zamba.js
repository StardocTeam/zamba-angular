...
function GetIDSuccess(result) {
    ...
    var height = screen.availHeight - headersHeight - 100;
    alert("aysagec/script "+height);
    $('#MainTabber').tabs("select", '#tabtasks');
    if (document.getElementById(tabID) == null) {
        var divtag = '<div id="' + tabID + '" style="padding:0px;height:409px"><iframe id="IF" width="100%" height: "' + height + '" frameborder="0" src="' + urlToOpen + '"/><div/>';
