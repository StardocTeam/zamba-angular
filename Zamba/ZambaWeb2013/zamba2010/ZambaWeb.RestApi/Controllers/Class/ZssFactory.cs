...
namespace ZambaWeb.RestApi.Controllers
{
    public class ZssFactory
    {
        ...
        public void SetZssValues(Zss zss)
        {
            ...
            var insert = "INSERT INTO ZSS (TOKEN, USERID, CREATEDATE, TOKENEXPIREDATE, CONNECTIONID,OKTAACCESSTOKEN,OKTAIDTOKEN) VALUES('" + zss.Token + "'," + zss.UserId + "," + FormatDate(zss.CreateDate) + "," + FormatDate(zss.TokenExpireDate) + "," + zss.ConnectionId + ",'" + zss.OktaAccessToken + "','" + zss.OktaIdToken +"')";
