...
namespace ZambaWeb.RestApi
{
    ...
    public class ApplicationUser : IdentityUser
    {
        ...
        public async Task<ClaimsIdentity> GenerateUserIdentityAsync(UserManager<ApplicationUser> manager, string type)
        {
            // authenticationType debe coincidir con el definido en CookieAuthenticationOptions.AuthenticationType
            var userIdentity = await manager.CreateIdentityAsync(this,type);
            // Agregar aquí notificaciones personalizadas de usuario
            return userIdentity;
        }
    }
