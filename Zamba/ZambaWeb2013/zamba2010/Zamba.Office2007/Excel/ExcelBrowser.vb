...
#Region "Variables privadas"
    ...
    Private Const toolbarHeight As Int32 = 25
...
#Region "Metodos"
    ...
    Public Sub ShowDocument(ByVal filepath As String)
        ...
        Catch ex As Exception
            Trace.WriteLine("ExcelBrowser Exception: " & ex.ToString())
        End Try
        ...
        If filepath.ToLower <> docFile.ToLower Then
            ...
            Try
                ...
                Me.pnlDoc.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
                Me.pnlDoc.Width = TP.Width
                Me.pnlDoc.Height = TP.Height - toolbarHeight
                Me.pnlDoc.Top = toolbarHeight
                Me.pnlDoc.Left = 0
                Me.pnlDoc.BackColor = Color.Gray
...
#Region "Funciones y llamadas a apis"
    ...
    Private Function FindWindowByApi(ByVal WindowCaption As String) As System.IntPtr
        ...
        If winHandle = IntPtr.Zero Then
            Trace.WriteLine("Comienza a buscar la ventana ..." & Date.Now.ToString())
            ...
            Trace.WriteLine(winHandle.ToString() & " = FindWindow ( rctrl_renwnd32 , '" & WindowCaption & "' ) " & Date.Now.ToString())
    ...
    Private Sub MsgTimer_Tick()
        ...
        If Not ExcelApp Is Nothing Then
            ...
            Try
                ...
                Trace.WriteLine("Buscando ventana: " & Caption)

                winHandle = FindWindowByApi(Caption)


                If winHandle = IntPtr.Zero Then
                    Trace.WriteLine("NO Se encontro Handle de la ventana " & Date.Now.ToString())
                End If
                ...
                Else
                    ...
                    Else
                        If timOut >= 300 Then
                            Trace.WriteLine(" TIMEOUT : NO SE ENCONTRO VENTANA " & Date.Now.ToString())
                            Me.MsgTimer.Enabled = False
                        Else
                            timOut = timOut + 1
                            Trace.WriteLine(" TIME COUNT = " & timOut.ToString() & " " & Date.Now.ToString())
                        End If
                    End If
            ...
            Trace.WriteLine(" -- End sub de MsgTimer_Tick -- " & Date.Now.ToString())
