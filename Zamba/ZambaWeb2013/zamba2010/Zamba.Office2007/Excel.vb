...
Public Class ExcelInterop
    ...
    End Function
    Public Shared Function DataTableDirectlyToExcel(ByVal addcol As Boolean, ByVal pDatatable As DataTable, ByVal sArchivo As String, ByVal eEstilo As eEstilosHoja, Optional ByVal bolShow As Boolean = False, Optional ByVal tipe As Int16 = -4143) As Boolean
        Dim apxls As New Excel.Application()
        Dim i As Int32 = 0
        Dim j As Int32 = 0
        apxls.Workbooks.Add()
    ...
    Public Shared Sub TextToExcel(ByVal sArchOrg As String, ByVal pFileName As String, ByVal eEstilo As eEstilosHoja)
        ...
        Try
            ...
            'Title blue and bold
            Ws.Range(Ws.Cells(1, 1), Ws.Cells(1, Ws.UsedRange.Columns.Count)).Font.Color = System.Drawing.ColorTranslator.ToOle(Color.DodgerBlue)
