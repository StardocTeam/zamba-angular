...
#End Region
    ...
    Private Sub GenerarNuevaConsulta(ByVal idquery As Int32, ByVal doctypeid As Int32)
    ...
    Private Sub GenerarNuevaSentencia(ByVal idquery As Int32, ByVal doctypeid As Int32)
        Dim strinsert As String
        Dim QueryName As String = InputBox("Complete el nombre para la nueva consulta", "Zamba")
        If QueryName.Trim = "" Then
            OK = False
