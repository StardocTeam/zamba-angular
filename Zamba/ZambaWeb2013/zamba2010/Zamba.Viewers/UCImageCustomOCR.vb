...
#Region " NETRON "
    ...
    Public Sub SearchInDb(ByRef Result As Result)
        ...
        Try
            DsObjects = ZNetron_Business.GetAllObjects(CInt(Result.DocType.ID), CInt(Result.ID))
            DsConnections = ZNetron_Business.GetAllConnections(CInt(Result.DocType.ID), CInt(Result.ID))
            Dim i As Integer = 0
