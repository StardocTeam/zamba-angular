...
namespace Zamba
{
    namespace Thumbnails
    {
        ...
        public partial class BarraNavegacionPagina : UserControl
        {
            ...
            protected IPageList listaPaginada;
            ...
            {
                InitializeComponent();
                this.home.Top = Constante.BarraNavegacionPagina.SEPARACION;
                this.back.Top = Constante.BarraNavegacionPagina.SEPARACION;
                this.next.Top = Constante.BarraNavegacionPagina.SEPARACION;
                this.end.Top = Constante.BarraNavegacionPagina.SEPARACION;

                this.PageCount = 0;
                this.visiblePageCount =
                    Constante.BarraNavegacionPagina.DEFAULT_VISIBLE_PAGE_COUNT;
                this.Visible = false;
            }
                ...
                for (int i = firtPage; i <= lastPage; i++)
                {
                    ...
                    linkPagina =
                        FabricaLinkLabel.newLinkLabel(
                          ...
                          linkPagina,
                          this.back.Right,
                          Constante.BarraNavegacionPagina.
                    ...
                    if (
                        (posRelInicio <=
                         Constante.BarraNavegacionPagina.
                            MAX_PAGE_GROUP_WIDTH) &&
                         this.Height <=
                         Constante.BarraNavegacionPagina.LINE_HEIGHT
                        )
                        this.Width +=
                            linkPagina.Width + 
                            Constante.BarraNavegacionPagina.SEPARACION;
