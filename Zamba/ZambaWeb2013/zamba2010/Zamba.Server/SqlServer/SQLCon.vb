...
Public Class SQLCreateTables
    ...
    Public Shadows Sub AddDocsTables(ByVal DocTypeId As Int64) Implements CreateTables.AddDocsTables
        Try
            ...
            str = "CREATE TABLE [DOC_I" & DocTypeId & "] ([lupdate] [datetime],[crdate] [datetime] ,[Fecha] smalldatetime default(GetDate()), [DOC_ID] [numeric] foreign key(doc_id) references doc_t" & DocTypeId & "(doc_id)ON DELETE CASCADE) ON [PRIMARY];"
            Server.Con.ExecuteNonQuery(CommandType.Text, str)
