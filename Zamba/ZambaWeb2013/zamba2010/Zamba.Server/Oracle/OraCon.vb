...
Public Class OraCon
    ...
    '        flag = False
    '    End If
    '    '        SQL: INSERT INTO "SYSTEM"."UCM" (USER_ID, C_TIME, U_TIME, 
    '    'WINUSER, WINPC, CON_ID)
    '    '  VALUES (1, CONVERT(DATETIME, '2003-05-26 12:49:52', 102),
    '    ' CONVERT(DATETIME, '2003-05-26 12:49:52', 102), MLEGNANI, SERVER1_STARDOC, 1)

    '    'Oracle: INSERT INTO "SYSTEM"."UCM" ("USER_ID" ,"C_TIME" ,"U_TIME" ,
    '    '    "WINUSER" ,"WINPC" ,"CON_ID" ) 
    '    '    VALUES (1 ,TO_DATE('2003-05-26 10:52:35', 'dd-Mon-yyyy 
    '    'HH:     MI() : SS(AM) ') ,TO_DATE('2003-05-26 10:52:35', 'dd-Mon-yyyy 
    '    'HH:     MI() : SS(AM) ') ,'MLEGNANI' ,'SERVER1_STARDOC' ,1  ) 
