...
#Region "private utility methods & constructors"
    ...
    Private Sub AssignParameterValues(ByVal commandParameters() As IDbDataParameter, ByVal parameterValues() As Object) Implements IConnection.AssignParameterValues
        ...
        For i = 0 To j
            If commandParameters(i).DbType = OracleType.Cursor Then
...
#Region "ExecuteNonQuery"
    ...
    ByVal ParametersNames() As Object, ByVal parameterstypes As Object, ByVal parameterValues() As Object) As Integer Implements IConnection.ExecuteNonQuery
        ...
        Try
            ...
            For i = 0 To parameterValues.Length - 1
                ...
                param.OracleType = parameterstypes(i)
        ...
        Catch ex As System.Data.OracleClient.OracleException
            ...
            If (ex.Code = 3114 OrElse ex.Code = 3113 OrElse ex.Code = 12571 OrElse ex.Code = 1089 OrElse ex.Code = 27101 OrElse ex.Code.ToString = "01034" OrElse ex.Code = 12500 OrElse ex.Code = 12541 OrElse ex.Code.ToString = "01033" OrElse ex.Code.ToString = "03113" OrElse ex.Code.ToString = "03114" OrElse ex.Code.ToString = "01090") AndAlso RunFirstTime Then
                RunFirstTime = False
    ...
    Public Overloads Function ExecuteNonQuery(ByVal commandType As CommandType, ByVal commandText As String, ByVal ParamArray commandParameters() As IDbDataParameter) As Integer Implements IConnection.ExecuteNonQuery
        ...
        Catch ex As System.Data.OracleClient.OracleException
            ...
            End If
            If (ex.Code = 3114 OrElse ex.Code = 3113 OrElse ex.Code = 12571 OrElse ex.Code = 1089 OrElse ex.Code = 27101 OrElse ex.Code.ToString = "01034" OrElse ex.Code = 12500 OrElse ex.Code = 12541 OrElse ex.Code.ToString = "01033" OrElse ex.Code.ToString = "03113" OrElse ex.Code.ToString = "03114") AndAlso RunFirstTime Then
                RunFirstTime = False
                Me.CN = Server.ConnectionIsBroken(ex).CN
    ...
    Public Overloads Function ExecuteNonQuery(ByVal spName As String,
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            Try
                commandParameters = OracleHelperParameterCache.GetSpParameterSet(CN, CN.ConnectionString, spName)
    ...
    Public Overloads Function ExecuteNonQuery(ByVal transaction As IDbTransaction, ByVal spName As String,
        ...
        Dim commandParameters As IDbDataParameter()
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            commandParameters = OracleHelperParameterCache.GetSpParameterSet(transaction, transaction.Connection.ConnectionString, spName)
            AssignParameterValues(commandParameters, parameterValues)
            Me.State = IConnection.ConnectionStates.Ready
    ...
    Public Overloads Function ExecuteNonQuery(ByVal transaction As IDbTransaction, ByVal spName As String,
        ...
        For i = 0 To parametersValues.Length - 1
            ...
            If parameterstypes(i) = OracleType.Cursor Then
...
#Region "ExecuteDataset"
    Public Overloads Function ExecuteDataset(ByVal spName As String,
        ...
        Catch ex As System.Data.OracleClient.OracleException
            Zamba.AppBlock.ZException.Log(New Exception(spName & ":" & ex.ToString))
            If ex.Code = 3114 OrElse ex.Code = 3113 OrElse ex.Code = 12571 OrElse ex.Code = 1089 OrElse ex.Code = 27101 OrElse ex.Code.ToString = "01034" OrElse ex.Code = 12500 OrElse ex.Code = 12541 OrElse ex.Code.ToString = "01033" OrElse ex.Code.ToString = "03113" OrElse ex.Code.ToString = "03114" Then
                Me.CN = Server.ConnectionIsBroken(ex).CN
...
#Region "ExecuteScalar"
   ...
   ByVal ParamArray commandParameters() As IDbDataParameter) As Object Implements IConnection.ExecuteScalar
        ...
        Catch ex As System.Data.OracleClient.OracleException
            Zamba.AppBlock.ZException.Log(New Exception(commandText & ":" & ex.ToString))
            If ex.Code = 3114 OrElse ex.Code = 12154 OrElse ex.Code = 1017 OrElse ex.Code = 3113 OrElse ex.Code = 12571 OrElse ex.Code = 1089 OrElse ex.Code = 27101 OrElse ex.Code.ToString = "01034" OrElse ex.Code = 12500 OrElse ex.Code = 12541 OrElse ex.Code.ToString = "01033" OrElse ex.Code.ToString = "03113" OrElse ex.Code.ToString = "03114" Then
                Me.CN = Server.ConnectionIsBroken(ex).CN
  ...
  ByVal ParametersNames() As Object, ByVal parameterstypes As Object, ByVal parametersValues() As Object) As String Implements IConnection.ExecuteScalar
        ...
        Try
            ...
            For i = 0 To parametersValues.Length - 1
                ...
                log = log & " " & parametersValues(i)
            Next
            cmd.Parameters.Add(New OracleParameter(CStr(ParametersNames(parametersValues.Length - 1)), OracleType.Cursor)).Direction = ParameterDirection.Output
...
Public Class OraClientCreateTables
    ...
    Public Shadows Sub AddDocsTables(ByVal DocTypeId As Int64) Implements CreateTables.AddDocsTables
        Try
            ...
            'strDrop = "DROP TABLE DOC_I" & DocTypeId
            'Try
            '    server.con.ExecuteNonQuery( CommandType.Text, strDrop)
            'Catch ex As Exception
            '    Zamba.AppBlock.ZException.Log(ex,commandtext)
            'End Try

            str = "CREATE TABLE " & "DOC_I" & DocTypeId & " (DOC_ID NUMBER(10),CRDATE DATE,LUPDATE DATE ,FECHA DATE, CONSTRAINT fk" & DocTypeId & " FOREIGN KEY(doc_id) REFERENCES DOC_T" & DocTypeId & " (DOC_ID))STORAGE(INITIAL 64K)"
            Server.Con.ExecuteNonQuery(CommandType.Text, str)
            'strDrop = "DROP TABLE DOC_D" & DocTypeId
            'Try
            '    Server.Con.ExecuteNonQuery( CommandType.Text, strDrop)
            'Catch ex As Exception
            '    Zamba.AppBlock.ZException.Log(ex,commandtext)
            ...
            Dim strTrig As New System.Text.StringBuilder
   ...
   & " FROM DOC_I" & DocTypeId & " INNER JOIN DOC_T" & DocTypeId & " ON DOC_I" & DocTypeId & ".DOC_ID = DOC_T" & DocTypeId & ".DOC_ID"
    ...
    Public Shadows Sub AddIndexColumn(ByVal DocTypeId As Int64, ByVal IndexIdArray As ArrayList, ByVal IndexTypeArray As ArrayList, ByVal IndexLenArray As ArrayList) Implements CreateTables.AddIndexColumn
        Try
            ...
            'Dim strd As New System.Text.StringBuilder
            Dim i As Integer
            Dim str1 As New System.Text.StringBuilder
            'Dim strd1 As New System.Text.StringBuilder

            str.Append("ALTER TABLE DOC_I" & DocTypeId & " ADD (")
            'strd.Append("ALTER TABLE DOC_D" & DocTypeId & " ADD (")
            ...
            For i = 0 To IndexIdArray.Count - 1
                ...
                End Select
                'strd1.Append("D")
                'strd1.Append(IndexIdArray(i))
                'strd1.Append(" NUMBER(1) DEFAULT 0")
                If i = 0 Then
                    str.Append(str1.ToString)
                    'strd.Append(strd1.ToString)
                Else
                    str.Append(", ")
                    str.Append(str1.ToString)
                    'strd.Append(", ")
            ...
            Try
                ...
                'c.ExecuteNonQuery(t, CommandType.Text, strd.ToString)
                t.Commit()
                c.CN.Close()
            Catch ex As Exception
                t.Rollback()
