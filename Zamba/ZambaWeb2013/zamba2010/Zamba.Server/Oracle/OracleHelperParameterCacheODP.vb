...
Public NotInheritable Class OracleHelperParameterCacheODP
...
#Region "private methods, variables, and constructors"
    ...
    Private Shared Function DiscoverSpParameterSet(ByVal co As IDbConnection, ByVal connectionString As String,
    ...
    ' - includeReturnValueParameter - whether or not to include their return value parameter>
    ' Returns: OracleParameter()
    Private Shared Function DiscoverSpParameterSet(ByRef t As IDbTransaction, ByVal connectionString As String,
                                                   ByVal spName As String,
                                                   ByVal ParamArray parameterValues() As Object) As OracleParameter()

        '   Dim cn As New OracleConnection(connectionString)
        Dim cmd As OracleCommand = New OracleCommand(spName, t.Connection)
        Dim discoveredParameters() As OracleParameter
...
#Region "Parameter Discovery Functions"
    ...
    Public Overloads Shared Function GetSpParameterSet(ByVal co As IDbConnection, ByVal connectionString As String,
    ...
    ' -includeReturnValueParameter - a bool value indicating whether the return value parameter should be included in the results 
    ' Returns: an array of SqlParameters 
    Public Overloads Shared Function GetSpParameterSet(ByRef t As IDbTransaction, ByVal connectionString As String,
                                                       ByVal spName As String) As OracleParameter()
