...
TryAgain:
    ...
    Public Function ConvertDatetime(ByVal data As String) As String Implements IConnection.ConvertDateTime
        Try
            ...
            Dim d As DateTime
            Dim str As String
            If Date.TryParse(data, New System.Globalization.CultureInfo("es-AR"), Globalization.DateTimeStyles.AssumeLocal, d) Then
                str = "TO_DATE('" & d.ToString("dd/MM/yyyy HH:mm:ss") & "' ,'DD/MM/YYYY HH24:MI:SS')"
            ElseIf Date.TryParse(data, New System.Globalization.CultureInfo("en-US"), Globalization.DateTimeStyles.AssumeLocal, d) Then
                str = "TO_DATE('" & d.ToString("yyyy/MM/dd HH:mm:ss") & "' ,'YYYY/MM/DD HH24:MI:SS')"
            ElseIf Date.TryParse(data, d) Then
                str = "TO_DATE('" & d.ToString("yyyy/MM/dd HH:mm:ss") & "' ,'YYYY/MM/DD HH24:MI:SS')"
            End If
            Return str
        Catch ex As Exception
...
#Region "ExecuteNonQuery"
    ...
    ByVal ParametersNames() As Object, ByVal parameterstypes As Object, ByVal parameterValues() As Object) As Integer Implements IConnection.ExecuteNonQuery
        ...
        Catch ex As System.Data.OracleClient.OracleException
            ...
            If (ex.Code = 3114 OrElse ex.Code = 3113 OrElse ex.Code = 12571 OrElse ex.Code = 1089 OrElse ex.Code = 27101 OrElse ex.Code.ToString = "01034" OrElse ex.Code = 12500 OrElse ex.Code = 12541 OrElse ex.Code.ToString = "01033" OrElse ex.Code.ToString = "03113" OrElse ex.Code.ToString = "03114" OrElse ex.Code.ToString = "01090" OrElse ex.Code = 1017) AndAlso RunFirstTime Then
                RunFirstTime = False
