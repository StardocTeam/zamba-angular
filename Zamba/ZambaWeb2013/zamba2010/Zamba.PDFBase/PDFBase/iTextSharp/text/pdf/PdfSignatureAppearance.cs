...
namespace iTextSharp.text.pdf {
    ...
    public class PdfSignatureAppearance {
        ...
        private String reasonCaption = "Motivo: ";

        /** The caption for the location of signing. */
        private String locationCaption = "Lugar: ";
        ...
        virtual public PdfTemplate GetAppearance() {
            ...
            if (app[2] == null) {
                ...
                if (layer2Text == null) {
                    ...
                    buf.Append("Firmado digitalmente por");
                    String name = null;
                    ...
                    buf.Append("Fecha: ").Append(signDate.ToString("dd.MM.yyyy HH:mm:ss"));//tenia establecido zona con "zzz"
                    if (reason != null)
