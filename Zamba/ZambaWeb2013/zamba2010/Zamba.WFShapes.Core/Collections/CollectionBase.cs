...
namespace Zamba.WFShapes
{
    ...
    public class CollectionBase<T> : ICollection<T>, ICollection
    {
        ...
        public virtual void CopyTo(T[] array, int arrayIndex)
        {
            ...
            if (count < 0)
                throw new ArgumentOutOfRangeException("count", count,"Error");
            if (arrayIndex < 0)
                throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, "Error");
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            if (array == null)
                throw new ArgumentNullException("array");
            if (index < 0)
                throw new ArgumentOutOfRangeException("index", index, "Error");
