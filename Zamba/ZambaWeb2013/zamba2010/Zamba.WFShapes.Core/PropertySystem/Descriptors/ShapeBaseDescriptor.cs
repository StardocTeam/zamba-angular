...
{
public class ShapeBaseDescriptor : DescriptorBase
    {
        ...
        private void AddBaseProperties()
        {
            ...
            this.AddProperty("Location", typeof(Point), constLayout, "The location of the shape.", Point.Empty, typeof(UITypeEditor), typeof(Zamba.WFShapes.PointConverter));
        }
