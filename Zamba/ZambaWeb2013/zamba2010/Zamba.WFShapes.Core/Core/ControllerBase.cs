...
public delegate void GeneraEvento_mouseUpEventHandler(object sender, MouseEventArgs e);
public delegate void GeneraEvento_mouseMoveEventHandler(object sender, MouseEventArgs e);
public delegate void GeneraEvento_mouseDownEventHandler(object sender, MouseEventArgs e);
public delegate void GeneraEvento_ConnectionmouseMoveEventHandler(object sender,MouseEventArgs e);//Zamba.WFShapes.IConnector p1, Zamba.WFShapes.IConnector p2, Zamba.WFShapes.Win.DiagramControl Diagrama);
...
namespace Zamba.WFShapes
{
    public abstract class ControllerBase : IUndoSupport, IController
    {
        ...
        // MouseUp del Shape
        private GeneraEvento_mouseUpEventHandler dMouseUp;
        // MouseMove del Shape
        private GeneraEvento_mouseMoveEventHandler dMouseMove;
        // MouseDown del Shape
        private GeneraEvento_mouseDownEventHandler dMouseDown;
        // Nueva Instancia del class que controla los Move del Shape
        private CapturaShapeMouse escucha;
        ...
        protected ControllerBase(IDiagramControl surface)
        {
            ...
            this.escucha = new CapturaShapeMouse();
            this.e_OnMouseUp += new GeneraEvento_mouseUpEventHandler(this.escucha.mouseUp);
            this.e_OnMouseMove += new GeneraEvento_mouseMoveEventHandler(this.escucha.mouseMove);
            this.e_OnMouseDown += new GeneraEvento_mouseDownEventHandler(this.escucha.mouseDown);
        ...
        void surface_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                if (instanciaDiagramControl.SelectedItems[0].EntityName == "Class Shape")
                {
                    shape = (IShape)instanciaDiagramControl.SelectedItems[0];
                }
            }
            if (shape != null)
            {
            ...
            if (null != this.dMouseDown)
                this.dMouseDown(sender, e);
        ...
        void surface_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            // Evento para traer el shape al frente
            try
            {
                ...
                {
                   // if (Diagrama.SelectedItems[0].EntityName == "Class Shape")
                        if (null != this.dMouseMove)
                            this.dMouseMove(sender, e);
                }
            }
            catch (Exception ex)
            {
        ...
        void surface_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (null != this.dMouseUp)
                this.dMouseUp(sender, e);//new GeneraEvento_MouseUpEventArgs("Marcelo"));
            }
            catch (Exception  ex)
            {
        ...
        //Habilito el MouseUp del Shape
        public event GeneraEvento_mouseUpEventHandler e_OnMouseUp
        {
            add
            {
                this.dMouseUp += value;
        ...
        //Habilito el MouseMove del Shape
        public event GeneraEvento_mouseMoveEventHandler e_OnMouseMove
        {
            add
            {
                this.dMouseMove += value;
            }
            remove
            {
                this.dMouseMove-= value;
        ...
        //Habilito el MouseDown del Shape
        public event GeneraEvento_mouseDownEventHandler e_OnMouseDown
        {
            add
            {
                this.dMouseDown += value;
            }
            remove
            {
                this.dMouseDown -= value;
