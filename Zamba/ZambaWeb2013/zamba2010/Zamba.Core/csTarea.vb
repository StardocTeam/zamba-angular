...
Public Class csTarea
    ...
    Public Overloads Function CompareTo(ByVal obj As Object) As Integer Implements IComparable.CompareTo
        ...
        If (Me.getId = Tarea.getId AndAlso Me.getReporteId = Tarea.getReporteId AndAlso Me.getFechaEejecucion = Tarea.getFechaEejecucion AndAlso Me.getFechaEejecucion = Tarea.getFechaEejecucion AndAlso Me.getFechaFin = Tarea.getFechaFin AndAlso Me.getFormato = Tarea.getFormato AndAlso Me.getFrecuencia = Tarea.getFrecuencia AndAlso Me.getImprimir = Tarea.getImprimir AndAlso Me.getMailCc = Tarea.getMailCc AndAlso Me.getMailCco = Tarea.MailCco AndAlso Me.getMailPara = Tarea.getMailPara AndAlso Me.getRepetirCadaMin = Tarea.getRepetirCadaMin AndAlso Me.getReporteId = Tarea.getReporteId AndAlso Me.getDescripcion = Tarea.getDescripcion) Then
            Return 0
        Else
            Return 1
        End If
