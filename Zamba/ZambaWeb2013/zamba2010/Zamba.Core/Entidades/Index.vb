        ...
        Get
            ...
            If Me.Type = IndexDataType.Fecha Then
                ...
                Catch ex As Exception
                    'Puede producirse error si el formato de fecha es español, esta invertido dia y mes
                    Try
...
#Region " Constructores "
    ...
    Public Sub New(ByVal Id As Int32, ByVal Name As String, ByVal Type As Int32, ByVal Len As Int32, ByVal AutoFill As Boolean, ByVal NoIndex As Boolean, ByVal DropDown As Int16,
        ...
        If Me.Type = IndexDataType.Alfanumerico OrElse Me.Type = IndexDataType.Alfanumerico_Largo OrElse Me.DropDown = IndexAdditionalType.AutoSustitución OrElse Me.DropDown = IndexAdditionalType.AutoSustituciónJerarquico Then
            Me.[Operator] = "Empieza"
        Else
            Me.[Operator] = "="
        End If
