...
#Region " Propiedades "
    ...
    Public Property WFIds() As System.Collections.Generic.List(Of Int64) Implements IWFService.WFIds
        ...
        End Set
    End Property
    Public Property RefreshRate() As Int32 Implements IWFService.RefreshRate
        Get
            Return _refreshRate
        End Get
...
#Region " Constructores "
    Public Sub New(ByVal pWFIds As System.Collections.Generic.List(Of Int64), ByVal refreshRate As Int32)
        _WFIds = pWFIds
