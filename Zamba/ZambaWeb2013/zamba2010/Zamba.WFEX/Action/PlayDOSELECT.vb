...
Public Class PlayDOSELECT
    ...
    Private Sub ExecuteDataset(ByVal strquery As String)
        ...
        Trace.WriteLineIf((ZTrace.IsInfo) AndAlso (Not IsNothing(Me.Ds) AndAlso Me.Ds.Tables.Count > 0), "Cantidad de filas obtenidas: " & Me.Ds.Tables(0).Rows.Count)

        If Not IsNothing(Me.Ds) AndAlso Me.Ds.Tables.Count > 0 AndAlso Not IsNothing(Me.Ds.Tables(0)) Then
