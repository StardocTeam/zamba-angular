Public Class UCDOScript
    ...
    Public Sub New(ByRef GetDocScript As IDOSCRIPT, ByRef _wfPanelCircuit As IWFPanelCircuit)
        MyBase.New(GetDocScript, _wfPanelCircuit)
        InitializeComponent()
    End Sub
    ...
    Private Shadows Sub InitializeComponent()
        ...
        Me.lblEnConstruccion.Location = New System.Drawing.Point(20, 28)
...
'        Dim indice As String = ComboBox2.Text
'        indixes.Add(indice)
'        TextBox1.Text &= "<<" & indice & ">>"
'    End Sub
