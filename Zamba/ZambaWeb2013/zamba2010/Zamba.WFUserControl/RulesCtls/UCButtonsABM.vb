Public Class UCButtonsABM
    ...
    Public Sub New(Optional ByVal title As String = "", _
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles btnAdd.Click
        ...
        With frmButtons
            If .ShowDialog() = DialogResult.OK Then
                ...
                'Se agrega la regla
                GenericButtonBusiness.AddRuleButton(.cboRules.SelectedValue, _
                                                 DirectCast(CInt(.cboPlace.SelectedValue), ButtonPlace), _
                                                 Int32.Parse(.txtOrder.Text), _
                                                 .txtCaption.Text, _
                                                 .txtParams.Text, _
                                                 .chkNeedRights.Checked, _
                                                 workId, _
                                                 .cmbSelectIcon.SelectedIndex, _
                                                 .txtCssClass.Text, _
                                                 .txtGroupName.Text, _
                                                 .txtGroupClass.Text)
        ...
        If dgvButtons.SelectedRows.Count > 0 Then
            ...
            If GenericButtonBusiness.CheckExistance(id) Then
                ...
                With frmButtons
                    ...
                    If IsDBNull(dgvButtons.SelectedRows(0).Cells("VIEWCLASS").Value) Then
                        .txtCssClass.Text = String.Empty
                    Else
                        .txtCssClass.Text = dgvButtons.SelectedRows(0).Cells("VIEWCLASS").Value
                    End If
                    ...
                    If IsDBNull(dgvButtons.SelectedRows(0).Cells("GroupClass").Value) Then
                        .txtGroupClass.Text = String.Empty
                    Else
                        .txtGroupClass.Text = dgvButtons.SelectedRows(0).Cells("GroupClass").Value
                    End If
                    ...
                    If .ShowDialog() = DialogResult.OK Then
                        ...
                        GenericButtonBusiness.UpdateRuleButton(id, _
                                                            .cboRules.SelectedValue, _
                                                            DirectCast(CInt(.cboPlace.SelectedValue), ButtonPlace), _
                                                            Int32.Parse(.txtOrder.Text), _
                                                            .txtCaption.Text, _
                                                            .txtParams.Text, _
        ...
        If dgvButtons.SelectedRows.Count > 0 Then
            ...
            If GenericButtonBusiness.CheckExistance(id) Then
                If MessageBox.Show("Se eliminará el botón " & dgvButtons.SelectedRows(0).Cells("ButtonID").Value.ToString & " ¿Desea continuar?", "Confirmar acción", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                    ...
                    RefreshGrid([Enum].Parse(GetType(ButtonType), cboFilters.Text))
                End If
            Else
