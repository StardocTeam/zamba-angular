...
<RuleCategory("Tareas"), RuleDescription("Validar Entidad"), RuleHelp("Permite realizar una validadción del entidad para tomar una desición determinada"), RuleFeatures(False)> _
