...
<RuleCategory("Vencimientos"), RuleDescription("Validar Fecha de Work Flow"), RuleHelp("Valida la Fecha y Hora del WorkFlow"), RuleFeatures(False)> _
Public Class IfWFDateTime
    Inherits WFRuleParent
    Implements IRuleIFPlay, IIfWFDateTime
    ...
    Public Overloads Overrides Function Play(ByVal results As System.Collections.Generic.List(Of ITaskResult)) As System.Collections.Generic.List(Of ITaskResult)
        Dim playRule As New Zamba.WFExecution.PlayIfWFDateTime()
