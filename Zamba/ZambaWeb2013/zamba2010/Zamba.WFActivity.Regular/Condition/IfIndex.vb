...
''' </history>
''' -----------------------------------------------------------------------------
<RuleCategory("Datos"), RuleDescription("Validar Indice"), RuleHelp("Compara el o los indices ingresados con una condición ingresada para poder tomar una desición determinada por el usuario"), RuleFeatures(False)> _
Public Class IfIndex
    Inherits WFRuleParent
    Implements IIfIndex, IRuleIFPlay
    ...
    Public Sub New(ByVal Id As Int64, ByVal Name As String, ByVal wfstepid As Int64, ByVal Condiciones As String, ByVal Variable As String, ByVal OpAnd As Boolean)
        ...
        Me.playRule = New Zamba.WFExecution.PlayIfIndex(Me)
    End Sub
...
#Region "Metodos Locales"
    ...
    Private Class IndexValue
        ...
        Private _Tipo As IndexDataType = Nothing
        ...
        Public Function CompareTo(ByVal obj As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End Try
        End Function
        Public Property Tipo() As IndexDataType
            Get
                Return _Tipo
            End Get
