...
<RuleCategory("Archivos"), RuleDescription("Guarda en un archivo de texto"), RuleHelp("Guarda texto en un archivo"), RuleFeatures(False)> <Serializable()>
Public MustInherit Class DoSaveFile
...
#End Region
    ...
    Public ReadOnly Property MaskName() As String
        Get
            Return "Guardar texto en documento"
        End Get
    End Property
    ...
    Public Sub New(ByVal Id As Int64,
                   ...
                   ByVal texttosave As String,
                   ByVal DocPathVar As String,
