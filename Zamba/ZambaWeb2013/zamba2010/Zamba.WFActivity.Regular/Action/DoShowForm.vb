...
<RuleCategory("Formularios"), RuleDescription("Mostrar Fomulario"), RuleHelp("Permite mostrar un formulario a elección, pero previamente este debe estar generado con la regla 'crear formulario'"), RuleFeatures(True)> <Serializable()> _
