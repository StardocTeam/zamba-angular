...
''' </summary>
''' <remarks></remarks>
<RuleCategory("Variables de Zamba"), RuleDescription("Permite obtener los valores de un objeto para almacenarlo en variables o indices"), RuleHelp(""), RuleFeatures(False)> <Serializable()> _
Public Class DoDismemberObject
    Inherits WFRuleParent
    Implements IDoDismemberObject
