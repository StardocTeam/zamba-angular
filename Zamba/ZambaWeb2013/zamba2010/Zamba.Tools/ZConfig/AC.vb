...
Public Class ApplicationConfig
    ...
    Public Enum ConfigType As Integer
        All = 0
        Database = 1
        Importacion = 2
        monitoreo = 3
    ...
    Public ReadOnly Property STATION() As Int16
        Get
            Return Int16.Parse(Dsconfig1.Configuration(0).STATION.ToString())
        End Get
    End Property
