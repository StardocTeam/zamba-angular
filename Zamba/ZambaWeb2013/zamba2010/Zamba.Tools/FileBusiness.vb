...
Public Class FileBusiness
    ...
    ''' <summary>
    ''' Funcion para quitar caracteres no permitidos a la hora de crear un archivo en windows.
    ''' </summary>
    ''' <param name="fileName">Nombre del archivo a guardar</param>
    ''' <returns></returns>
    Public Shared Function FormatFileName(fileName As String) As String

        Dim fileNameString As String = String.Empty
