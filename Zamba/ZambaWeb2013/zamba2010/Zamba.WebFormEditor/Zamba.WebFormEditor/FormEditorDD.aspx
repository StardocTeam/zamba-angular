<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEditorDD.aspx.cs" Inherits="Zamba.WebFormEditor.FormEditorDD" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Content/scripts/jquery.layout-latest.js" type="text/javascript"></script>
...
<body class="BODY">
    ...
    <table width="97%" summary="Resource Browser">
        ...
        <td style="padding-left: 20px; font-size: 12px;border-bottom-color:Gray; border-bottom-style: solid; border-bottom-width:1px" valign="top">
                ...
                <strong>
                  Entidad:  <%=GetDocTypeName() %></strong>
    Tipo:   &nbsp;         <asp:DropDownList runat="server" ID="DropDownListFormTypes" Enabled="true">
                </asp:DropDownList>
            </td>
...
<br />&nbsp;&nbsp;
<br />&nbsp;&nbsp;
<input type="submit" class="submit" id="zamba_save"  name="zamba_save" value="Guardar"></input>
<input type="submit" class="submit" id="zamba_cancel"  name="zamba_cancel" value="Cancelar"></input>
<br />&nbsp;&nbsp;
<br />&nbsp;&nbsp;
<br />&nbsp;&nbsp;
<br />&nbsp;&nbsp;
...
//<![CDATA[
        ...
        function OnClientSelectionChange(editor, args) {
            try {
                ...
                if (element != null) {
                    document.getElementById("divIndexAttr").style.display = "block";
                    ...
                    if (valReadOnly == "readonly") {
                        document.getElementById("chkReadOnly").checked = true;
                    } else {
                        document.getElementById("chkReadOnly").checked = false;
                    }
                    ...
                    if (valDatatyype) {
                        ...
                        document.getElementById("divIndexAttr").style.display = "none";
                }
            } catch (e) {
        ...
        function UpdateAttr() {
            ...
            try {
                ...
                if (element) {
                    ...
                    if (document.getElementById("chkReadOnly").checked) {
                        element.setAttribute("readonly", "readonly");
                    } else {
                        element.removeAttribute("readonly");
                    }
                    if (document.getElementById("chkDisabled").checked) {
                ...
                try {
                    ...
                    if (indexElem.id.toLowerCase().indexOf("zamba_index_") != -1) {
                        ...
                        if (indexElem.tagName == "SELECT") {
                            ...
                            document.getElementById("txtDataType").disabled = true;
                            document.getElementById("chkReadOnly").disabled = true;
                        } else {
                            document.getElementById("txtLength").disabled = false;
                            document.getElementById("txtDataType").disabled = false;
                            document.getElementById("chkReadOnly").disabled = false;
                        }
                    } else {
                        return null;
                    }
        ...
        function OnClientLoad(editor) {
            ...
            if (document.getElementById("divIndexAttr") != null) 
                document.getElementById("divIndexAttr").style.display = "none";
        }
