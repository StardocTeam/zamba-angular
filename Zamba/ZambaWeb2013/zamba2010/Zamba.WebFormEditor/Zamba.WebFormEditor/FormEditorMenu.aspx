<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEditorMenu.aspx.cs" Inherits="Zamba.WebFormEditor.FormEditorMenu" %>
...
<body>
    ...
    <div align="center" >
        ...
        <table summary="Resource Browser" style="margin:15px; width:90%; height:90%; text-align:left ">
         <tr>
         <td colspan="4" style=" background-color:LightSteelBlue; height:25px; color:White; font-size: 12px; text-align:center; padding: 10px" >
         &nbsp; Zamba Editor de Formularios
         </td>
   </tr>
