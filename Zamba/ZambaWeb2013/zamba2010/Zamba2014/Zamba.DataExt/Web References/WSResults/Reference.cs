...
namespace Zamba.DataExt.WSResults {
    ...
    public partial class Results : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")]
        public byte[] GetMail(string url, long userId) {
        ...
        /// <remarks/>
        public void GetMailAsync(string url, long userId) {
            this.GetMailAsync(url, userId, null);
        }
        
        /// <remarks/>
        public void GetMailAsync(string url, long userId, object userState) {
        ...
        public void SaveMessageFileBlob(string url, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] file) {
            this.Invoke("SaveMessageFileBlob", new object[] {
                        url,
                        file});
        }
        
        /// <remarks/>
        public void SaveMessageFileBlobAsync(string url, byte[] file) {
            this.SaveMessageFileBlobAsync(url, file, null);
        }
        
        /// <remarks/>
        public void SaveMessageFileBlobAsync(string url, byte[] file, object userState) {
        ...
        private void OnSaveMessageFileBlobOperationCompleted(object arg) {
            if ((this.SaveMessageFileBlobCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SaveMessageFileBlobCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void SaveMessageFileBlobCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
