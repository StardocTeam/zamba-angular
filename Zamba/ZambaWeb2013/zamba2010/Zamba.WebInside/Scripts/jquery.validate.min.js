...
(function (c) {
    c.extend(c.fn, {
        ...
        , rules: function (a, b) {
            ...
            if (a) {
                ...
                switch (a) {
                    case "add": c.extend(g, c.validator.normalizeRule(b));
                        f[d.name] = g;
    ...
    c.extend(c.validator, {
        ...
        , messages: {
            required: "Requerido.", remote: "Please fix this field.", email: "Please enter a valid email address.", url: "Please enter a valid URL.", date: "Please enter a valid date.", dateISO: "Please enter a valid date (ISO).", number: "Please enter a valid number.", digits: "Please enter only digits.", creditcard: "Please enter a valid credit card number.", equalTo: "Please enter the same value again.", accept: "Please enter a value with a valid extension.", maxlength: c.validator.format("Máximo {0} caracteres."),
        ...
        , autoCreateRanges: false, prototype: {
            ...
            , check: function (a) {
                var originalData = $(a).attr("ZOriginalValue");
                var currData = $(a).val();
                ...
                //Si ejecuta validaciones, y viene vacio siendo requerido, o cambio el original data(para formularios) o el campo es de una regla
                if (document.ExecuteValidations && (currData == "" && $(a).rules().required) || (originalData != null && currData != originalData) 
                    || $(a).hasClass("RuleField")) {
                    for (e in b) {
                        var f = {
            ...
            , getLength: function (a, b) {
                switch (b.nodeName.toLowerCase()) {
                    case "select": return c("option:selected", b).length;
            ...
            c.each(a, function (d, e) {
                ...
                false) delete a[d];
                    ...
                    switch (typeof e.depends) {
                        case "string": f = !!c(e.depends, b.form).length;
                            break;
        ...
        methods: {
            required: function (a, b, d) {
                ...
                switch (b.nodeName.toLowerCase()) {
                    case "select": return (a = c(b).val()) && a.length > 0;
            ...
            , remote: function (a, b, d) {
                if (!$(b).rules().required) return "dependency-mismatch";
            ...
            , minlength: function (a, b, d) {
                return this.getLength(c.trim(a), b) >= d
            }
