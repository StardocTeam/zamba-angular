...
{
    public static Zamba.License.Controllers.AccountController Account = new Zamba.License.Controllers.T4MVC_AccountController();
    public static Zamba.License.Controllers.ConnectionController Connection = new Zamba.License.Controllers.T4MVC_ConnectionController();
    public static Zamba.License.Controllers.ErrorController Error = new Zamba.License.Controllers.T4MVC_ErrorController();
    public static Zamba.License.Controllers.HomeController Home = new Zamba.License.Controllers.T4MVC_HomeController();
    public static Zamba.License.Controllers.LicenseController License = new Zamba.License.Controllers.T4MVC_LicenseController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static readonly string zamba_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/zamba.min.css") ? Url("zamba.min.css") : Url("zamba.css");
