...
Public Class PlayIfDocAsocExist
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myrule As IIfDocAsocExist) As System.Collections.Generic.List(Of Core.ITaskResult)
        Return results
    End Function
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myrule As IIfDocAsocExist, ByVal ifType As Boolean) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            For Each R As TaskResult In results
                ...
                For Each AsocResult As Core.Result In DAB.getAsociatedResultsFromResult(R, Int32.Parse(UP.getValue("CantidadFilas", UPSections.UserPreferences, 100)), Membership.MembershipHelper.CurrentUser.ID)
