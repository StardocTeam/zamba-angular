Public Class PlayIfStepDateTime
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myrule As IIfStepDateTime) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Return NewList
    End Function
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myrule As IIfStepDateTime, ByVal ifType As Boolean) As System.Collections.Generic.List(Of Core.ITaskResult)
        Return results
    End Function
End Class
