...
Public Class PlayDOEDITTABLE
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myRule As IDOEditTable) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            Else
                ...
                Select Case myRule.EditType
                    Case 0
                        ZTrace.WriteLineIf(ZTrace.IsInfo, "sort: " & myRule.KeyColumn & ", " & myRule.EditColumn & " desc")
                        dv.Sort = myRule.KeyColumn & ", " & myRule.EditColumn & " desc"
                    Case 1
                        ZTrace.WriteLineIf(ZTrace.IsInfo, "sort: " & myRule.KeyColumn & ", " & myRule.EditColumn & " asc")
                        dv.Sort = myRule.KeyColumn & ", " & myRule.EditColumn & " asc"
                    Case 2
                        ZTrace.WriteLineIf(ZTrace.IsInfo, "sort: " & myRule.KeyColumn & " desc")
                        dv.Sort = myRule.KeyColumn & " desc"
                    Case 3
                        ZTrace.WriteLineIf(ZTrace.IsInfo, "sort: " & myRule.KeyColumn & " asc")
                        dv.Sort = myRule.KeyColumn & " asc"
                    Case 4
                        ZTrace.WriteLineIf(ZTrace.IsInfo, "Sin sort")
                End Select
                ZTrace.WriteLineIf(ZTrace.IsInfo, "Obteniendo nueva tabla")
                ...
                If VariablesInterReglas.ContainsKey(myRule.VarDestiny) = False Then
                    VariablesInterReglas.Add(myRule.VarDestiny, ds)
                Else
