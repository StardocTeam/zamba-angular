...
Public Class PlayDOSHOWEDITTABLE
    ...
    ''' </history>
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myRule As IDOShowEditTable) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            Else
                ...
                ZTrace.WriteLineIf(ZTrace.IsInfo, "Creando el formulario y sus componentes.")
                'frm = New ZForm
                ...
                ZTrace.WriteLineIf(ZTrace.IsInfo, "Agregando eventos al formulario y sus componentes.")
                'Botón Aceptar.
                ...
                '    ZTrace.WriteLineIf(ZTrace.IsInfo, "Obteniendo las filas seleccionadas.")
                ...
                '        ZTrace.WriteLineIf(ZTrace.IsInfo, "Guardando toda la tabla en variables inter reglas.")
                ...
                '        ZTrace.WriteLineIf(ZTrace.IsInfo, "Se guardarán las columnas seleccionadas.")
                '        If myRule.GetSelectedCols.Split(",").Length = 1 AndAlso dt.Rows.Count = 1 Then
                '            Dim col As String = myRule.GetSelectedCols.Split(",")(0)

                '            ZTrace.WriteLineIf(ZTrace.IsInfo, "Se ha seleccionado un registro y se guardará el valor de una única columna." _
                '                              & vbCrLf & "Guardando el valor a la variable inter regla.")
                ...
                '            Else
                '                If IsNumeric(col) Then
                '                    VariablesInterReglas.Add(myRule.VarDestiny, dt.Rows(0)(Integer.Parse(col) - 1))
                '                Else
                ...
                '        Else
                '            ZTrace.WriteLineIf(ZTrace.IsInfo, "Se ha seleccionado más de un registro y se guardarán los valores en más de una columna.")
                ...
                '            ZTrace.WriteLineIf(ZTrace.IsInfo, "Guardando valores en variables inter reglas.")
                '            If VariablesInterReglas.ContainsKey(myRule.VarDestiny) = False Then
                '                VariablesInterReglas.Add(myRule.VarDestiny, dt)
                '            Else
                '                VariablesInterReglas.Item(myRule.VarDestiny) = dt
        ...
        Finally
            ZTrace.WriteLineIf(ZTrace.IsInfo, "Liberando recursos.")
    ...
    Private Sub CloseForm()
        If HasRowsSelected() Then
            ZTrace.WriteLineIf(ZTrace.IsInfo, "Cerrando el formulario desde el aceptar.")
    ...
    Private Sub FixFormSize(ByVal sender As Object, ByVal e As EventArgs)
        ZTrace.WriteLineIf(ZTrace.IsInfo, "Corrigiendo el tamaño del formulario.")
    ...
    Private Sub CheckSelectedRows(ByVal sender As Object, ByVal e As EventArgs)
        ZTrace.WriteLineIf(ZTrace.IsInfo, "Se ha seleccionado un registro mediante el doble click.")
