...
Public Class PlayDoConsumeWCF
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of ITaskResult)) As System.Collections.Generic.List(Of ITaskResult)
        Dim dynamicWCF As DynamicWCF ' DynamicWebservice
        Try
            For Each r As TaskResult In results
                ZTrace.WriteLineIf(ZTrace.IsInfo, "Servicio: " & Me._myRule.Wsdl & " metodo invocado: " & Me._myRule.MethodName)
                ...
                Me.serviceResult = dynamicWCF.Consume(Me._myRule.Wsdl, Me._myRule.Contract, Me._myRule.MethodName, Parameters, _myRule.useCredentials)
                ...
                If Me._myRule.SaveInValue.Contains("<<") = False Then
                    ...
                    If VariablesInterReglas.ContainsKey(Me._myRule.SaveInValue) = False Then
                        VariablesInterReglas.Add(Me._myRule.SaveInValue, serviceResult)
