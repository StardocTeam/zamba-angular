...
Public Class PlayDOGenerateTaskResult
    ...
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult)) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            Me.ruleindicesaux = Me.MyRule.indices.Replace("//", "ง")
            ...
            While Not String.IsNullOrEmpty(Me.ruleindicesaux)
                strItem = Me.ruleindicesaux.Split("ง")(0)
                ...
                Me.ruleindicesaux = Me.ruleindicesaux.Remove(0, Me.ruleindicesaux.Split("ง")(0).Length)
            ...
            Else
                ...
                If results.Count > 0 Then
                    ZTrace.WriteLineIf(ZTrace.IsInfo, "No se reconoci๓ ninguna variable, se creara una sola tarea")
                    Me.r = results(0)
                    '[Ezequiel] - 23/11/09 - Valido si se tiene que continuar la ejecucion con los nuevos resultados
                    If Not Me.MyRule.ContinueWithCurrentTasks Then
                ...
                Else
                    ZTrace.WriteLineIf(ZTrace.IsInfo, "No se reconoci๓ ninguna variable, no se crearan tareas")
                    Return results
                End If
            End If
    ...
    Private Function createResult(ByVal tipo As Int16) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Select Case tipo
                    ...
                    For Each indice As String In Me.indices.Keys
                        For Each index As Index In newRes.Indexs
                            If index.ID = Int64.Parse(indice) Then
                                ...
                                If index.DropDown = IndexAdditionalType.AutoSustituci๓n OrElse index.DropDown = IndexAdditionalType.AutoSustituci๓nJerarquico Then
            ...
            Case 1
                ...
                For Each row As DataRow In Me.dt.Rows
                    ...
                    Dim newRes As NewResult = ResultBusiness.GetNewNewResult(Me.MyRule.docTypeId)
                    newRes.File = Me._filepath
                    ZTrace.WriteLineIf(ZTrace.IsInfo, "บบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบบ")
                    ZTrace.WriteLineIf(ZTrace.IsInfo, "New Result")
                        ...
                        If Int64.Parse(indice) <> 0 Then
                            For Each resIndice As Index In newRes.Indexs
                                If resIndice.ID = Int64.Parse(indice) Then
                                    ...
                                    If resIndice.DropDown = IndexAdditionalType.AutoSustituci๓n OrElse resIndice.DropDown = IndexAdditionalType.AutoSustituci๓nJerarquico Then
                                        ZTrace.WriteLineIf(ZTrace.IsInfo, "Indice de Sustitucion- Intentando recuperar descripcion")
                    ...
                    Case InsertResult.Insertado
                        ...
                        If newRes.ID > 0 Then
                            ...
                            If String.Compare(IO.Path.GetExtension(path).ToLower().Trim(), ".msg") = 0 Then
                                ZTrace.WriteLineIf(ZTrace.IsInfo, "El archivo es de extensi๓n MSG.")
                                Try
                                    ...
                                    If IO.File.Exists(path) Then
                                        ...
                                        ZTrace.WriteLineIf(ZTrace.IsInfo, "La copia se ha realizado con ้xito. Ruta: " & destino)
                                    Else
                                        ZTrace.WriteLineIf(ZTrace.IsInfo, "No se encontr๓ el archivo: " & path)
                                    End If
        ...
        End Select
        VarInterReglas = Nothing
        ZTrace.WriteLineIf(ZTrace.IsInfo, "Tarea generada con ้xito!")
    ...
    Public Function PlayWeb(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal Params As Hashtable) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            Else
                'If results.Count > 0 Then
                ZTrace.WriteLineIf(ZTrace.IsInfo, "No se reconoci๓ ninguna variable, se creara un solo documento")
                If results.Count > 0 Then
                    Me.r = results(0)
                End If
                '[Ezequiel] - 23/11/09 - Valido si se tiene que continuar la ejecucion con los nuevos resultados
    ...
    Private Function createWebResult(ByVal tipo As Int16, ByRef Params As Hashtable) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        VarInterReglas = Nothing
        ZTrace.WriteLineIf(ZTrace.IsInfo, "Tarea generada con ้xito!")
        Params.Add("msg", "Tarea generada con ้xito!")
        ResultBusiness = Nothing
        WFB = Nothing
