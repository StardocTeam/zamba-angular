...
Public Class PlayDoInsertTable
    ...
    ''' </history>
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myRule As IDoInsertTable) As System.Collections.Generic.List(Of Core.ITaskResult)
