...
Public Class PlayDoExport
    Public Function Play(ByVal results As System.Collections.Generic.List(Of Core.ITaskResult), ByVal myrule As IDoExport) As System.Collections.Generic.List(Of Core.ITaskResult)
        ...
        Try
            ...
            For Each r As TaskResult In results
                ...
                ' o sino se crea un unico archivo con los indices de todos los results
                ...
                For Each Item As String In myrule.resultLine.Split(myrule.separator.ToCharArray)
                    ...
                    count += 1
                Next
                ZTrace.WriteLineIf(ZTrace.IsInfo, "Exportando documento...")
