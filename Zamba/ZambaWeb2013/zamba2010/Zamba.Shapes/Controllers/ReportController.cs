...
namespace Zamba.Shapes.Controllers
{
    class ReportController: IDiagramFiltereable, IRefresh
    {
        ...
        private IDiagram FillDiagram(Object[] parameters)
        {
            ...
            dsReports = ReportBuilder.Business.ReportBuilderComponent.GetAllQueryIdsAndNames();
            ...
            dsGeneralReports = ReportBuilder.Business.ReportBuilderComponent.GetAllQueryIdsAndNamesReporteGeneral();
