...
Public Class NotifyPublish
    ...
    Private Sub SendMail()
        ...
        If RdbIncluirResumen.Checked Then
            ...
            If RdbAgregarLink.Checked Then
                body.Append("Acceso al archivo: ")
                body.Append(_link)
                If MessagesBusiness.SendMail(_mailsPara.ToString, Nothing, Nothing, "Notificación de publicación", body.ToString(), True, Nothing) Then
            ...
            Else ' se adjunta el archivo
                ...
                If MessagesBusiness.SendMail(_mailsPara.ToString, Nothing, Nothing, "Notificación de publicación", body.ToString(), True, AttachList) Then
                    MessageBox.Show("Envio realizado con exito", "Zamba", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Me.Close()
                Else
                    MessageBox.Show("No se pudo enviar correctamente", "Zamba", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ...
        Else ' no se incluye resumen
            If RdbAgregarLink.Checked Then
                ...
                If MessagesBusiness.SendMail(_mailsPara.ToString, Nothing, Nothing, "Notificación de publicación", body.ToString(), False, Nothing) Then
                    MessageBox.Show("Envio realizado con exito", "Zamba", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Me.Close()
                Else
                    MessageBox.Show("No se pudo enviar correctamente", "Zamba", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                ...
                End If
            Else ' se adjunta el archivo
                If MessagesBusiness.SendMail(_mailsPara.ToString, Nothing, Nothing, "Notificación de publicación", String.Empty, False, AttachList) Then
                    MessageBox.Show("Envio realizado con exito", "Zamba", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Me.Close()
                Else
                    MessageBox.Show("No se pudo enviar correctamente", "Zamba", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    ...
    Private Sub RdbNoIncluirResumen_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RdbNoIncluirResumen.CheckedChanged
    ...
    Private Sub RdbIncluirResumen_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RdbIncluirResumen.CheckedChanged
