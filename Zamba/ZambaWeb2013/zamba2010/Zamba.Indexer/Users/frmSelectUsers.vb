...
Public Class frmSelectUsers
    ...
    Public Sub New(ByVal typeId As GroupToNotifyTypes, ByVal idGroup As Int64, ByVal doctypeid As Int64)
        ...
        Me.ucPrincipal = New UCSelectUsers(typeId, idGroup, doctypeid)
        Me.Controls.Add(Me.ucPrincipal)
        Me.ucPrincipal.Dock = DockStyle.Fill
    End Sub

    Public Sub New(ByVal typeId As GroupToNotifyTypes, ByVal idGroup As Int64, Optional ByVal participantIds As Generic.List(Of Int64) = Nothing)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        Me.ucPrincipal = New UCSelectUsers(typeId, idGroup, participantIds)
        Me.Controls.Add(Me.ucPrincipal)
        Me.ucPrincipal.Dock = DockStyle.Fill
    End Sub
    ...
    Public Sub New(ByVal typeId As GroupToNotifyTypes, ByVal docIds As Generic.List(Of Int64))
        ...
        Me.ucPrincipal = New UCSelectUsers(typeId, docIds)
        Me.Controls.Add(Me.ucPrincipal)
        Me.ucPrincipal.Dock = DockStyle.Fill
    End Sub
