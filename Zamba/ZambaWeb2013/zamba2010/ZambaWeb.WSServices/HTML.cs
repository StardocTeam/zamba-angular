...
public static class HTML
{
    ...
    public static string getHtmlSection(string HTML, HTMLSection Section,String CurrentTheme)
    {
        ...
        else
        {
            ...
            {
                return getHtmlSection(HTML, HTMLSection.BODY, CurrentTheme);
            }
            else
                return HTML;
        }
    ...
    /// <param name="HTML"></param>
    /// <returns></returns>
    public static string MakeDynamicConditions(string HTMLBody, long formId, ArrayList indexs)
    {
    ...
    public static string GetAttributeValue(string tag, string attributeName)
    {
        ...
        string[] att = tag.Split(' ');
        foreach (string item in att)
        {
            if (item.IndexOf(attributeName + "=") > -1)
            {
                value = item.Replace(attributeName+"=", string.Empty);
            }
        }
        return value;
    }
