...
{
    public delegate void PageGroupGridClickEventHandler         
                                ( Object sender, EventArgs e );
    public delegate void PageGroupGridDoubleClickEventHandler   
                                (Object sender, EventArgs e);
    ...
    public partial class PageGroupGrid : UserControl, IDataSource
    {
        ...
        private IFilter GridController;
        public PageGroupGrid(Int64 currentUserId,ref IFilter GridController)
        {
            ...
            this.view.ShortDateFormat = Boolean.Parse(Zamba.Core.UserPreferences.getValue("GridShortDateFormat", Zamba.Core.Sections.UserPreferences, "True"));
        ...
        public void usePrint(Boolean useIt)
        {
            this.view.ShowPrintButton(useIt);
        }
        ...
        public void pageBar_Click(Object sender,
        ...
        private void setPage(Object value)
        {
            ...
            if (0 >= list.PageCount)
            {
                ...
                this.view.DataSourcePage =
                    this.pageBar.DataSource =
                                        null;
            }
            else
            {
        ...
        {
            this.view.Group(this.view.OutLookGrid.Columns[ColumnName]);
            //this.view.Refresh();
        }
    }
}
