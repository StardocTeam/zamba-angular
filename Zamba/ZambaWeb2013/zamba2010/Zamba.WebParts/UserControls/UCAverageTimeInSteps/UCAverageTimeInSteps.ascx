...
<table style="margin: 0px 0px 0px 0px">
    <tr>
        <td width="100%" style="background-color: Navy; margin: 0px 0px 0px 0px" colspan="2">
            ...
            <asp:Label ID="lblTitle" Text="Tiempos Promedio" runat="server" Font-Bold="true"
    ...
    <tr height="100px">
        <td style="margin: 0px 0px 0px 0px">
            <rsweb:ReportViewer ID="rpvAverageTimeInSteps" runat="server" ShowFindControls="False"
                ...
                <LocalReport ReportPath="Reports\rptAverageTimeInSteps.rdlc">
                    <DataSources>
        ...
        <td style="margin: 0px 0px 0px 0px">
            <rsweb:ReportViewer ID="rpvGrdAverageTimeInSteps" runat="server" ShowFindControls="False"
                ...
                <LocalReport ReportPath="Reports\RptGrdAverageTimeInSteps.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="dsAverageTimeInSteps_dtAverageTimeInSteps" />
                    </DataSources>
                </LocalReport>
