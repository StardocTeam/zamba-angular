...
<%@ Register TagPrefix="MyUCs" TagName="WorkflowList" Src="~/Controls/TaskSelector/WorkflowList.ascx" %>
<%@ Register TagPrefix="MyUCs" TagName="TasksList" Src="~/Controls/TaskSelector/TasksList.ascx" %>
<%@ Register TagPrefix="MyUCs" TagName="StepsList" Src="~/Controls/TaskSelector/StepsList.ascx" %>
<table width="100%">
    <tr>
