...
namespace Zamba.WfRemotingComponent
{
    public static class WfRemotingComponent
    {
        ...
        {
            ZTrace.WriteLineIf(ZTrace.IsVerbose,"Obteniendo los permisos de usuario");
            ...
            ZTrace.WriteLineIf(ZTrace.IsVerbose,"Los permisos se obtuvieron correctamente");
        }
        ...
        public static void  AddTrace ( string startPath)
        {
            try
            {
                Int32 level = int.Parse(UserPreferences.getValue("TraceLevel", Sections.UserPreferences, "1"));
                if (level > 0)
                {
        ...
        public static string  GetIp()
        {
	        ...
	        {	        
                ...
                ZTrace.WriteLineIf(ZTrace.IsVerbose,Direcciones[0].ToString());
        ...
        public static void SetChannel(string puerto , string  tipo ,  WellKnownServiceTypeEntry remObj  , string StartUpPath)
        {
            ...
            ZTrace.WriteLineIf(ZTrace.IsVerbose,"Ingreso con 0 parametro");
            ...
            if (tipo.ToString().ToUpper() == "HTTP")
	        {
                ...
                ZTrace.WriteLineIf(ZTrace.IsVerbose,@"Servidor Registrado en: TCP, Puerto " + puerto);
                ZTrace.WriteLineIf(ZTrace.IsVerbose,remObj.ToString());
