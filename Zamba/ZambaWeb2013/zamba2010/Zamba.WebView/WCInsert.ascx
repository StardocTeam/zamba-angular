...
<asp:UpdatePanel ID="udp_WCinsert" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <table>
            <tr>
                <td>
                    <%--<MyUc:CompletarIndices ID="ad" runat="server" />--%>
            ...
            <tr>
                <td>
                    ...
                    <MyUc:CompletarIndices ID="completarindice" runat="server" />
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btInsertar" runat="server" Text="Insertar" OnClick="btInsertar_Click"
                        ValidationGroup="Upload" />
                    <asp:HiddenField ID="hdnDocTypeId" runat="server" 
                        onvaluechanged="hdnDocTypeId_ValueChanged" />
                </td>
            </tr>
        </table>
        <%--<table>
