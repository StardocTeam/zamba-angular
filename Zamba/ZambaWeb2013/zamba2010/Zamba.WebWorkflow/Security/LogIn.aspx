<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Security/LogIn.aspx.cs"
    Inherits="Login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Zamba Web</title>
...
<div align="center" style="margin:0px auto;height:100%;width:100%">
    ...
    <table id="Table1" border="0" runat="server" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr>
            <td id="Td1" valign="top" runat="server" style="background-image: images/topshape.jpg">
                <img id="Img1" alt="Logo" runat="server" src="../images/bluebar.jpg" border="0" height="43"
                   style="width: 100%; height: 43px;" />
            </td>
           <%-- <td id="Td2" width="100%" runat="server" style="background-image: images/topshape.jpg">
            </td>--%>
        </tr>
        <tr>
            <td valign="top" height="100%" class="style1">
            </td>
        </tr>
        <tr style="padding: 0">
            <td>
                            ...
                            <table id="Table3" border="0" runat="server" cellpadding="0" cellspacing="0" height="100%"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td valign="top" colspan="2">
                                                    <%--<div>4--%>
                                                        <table style="width:100%; height: 500; background-image: url(images/fondoPantalla.JPG);
                                ...
                                <tr>
                                   <td id="Td7" runat="server" class="BackBot" style="font-size:small" height="20px" width="100%" align="center">
                                        ...
                                        <a href="#" onclick='window.open("ManualUsuario.pdf")' class="bot">Ayuda</a><img id="Img5" runat="server" src="images/line1.gif" style="border: 0"
                                            align="middle" width="5" height="36" /><a href="#" onclick='window.open("Licencia.rtf")' class="bot" />Licencia de
                                        uso</a><img id="Img6" runat="server" src="images/line1.gif" style="border: 0" align="middle"
                                            width="5" height="36" />
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="611">
                                            <tr>
                                                <td style="padding-left: 30px;" align="left">
                                                    <p class="text">
                                                        2008 Copyright Stardoc Argentina</p>
                                                </td>
                                                <td align="right" style="padding-right: 30px;">
                                                    <p class="text">
                                                        Contacto e-mail
                                                        <br />
                                                        info@stardoc.com.ar</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
