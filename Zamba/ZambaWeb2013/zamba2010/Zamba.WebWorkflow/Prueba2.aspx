<%@ Page Language="C#" MasterPageFile="~/ZambaMaster.master" AutoEventWireup="true" CodeFile="Prueba2.aspx.cs" Inherits="Prueba2" Title="Untitled Page" %>
    ...
    <ContentTemplate>
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="View1" runat="server">
                ...
                <asp:Button ID="Button1" runat="server" Text="Pasar a vista 2" onclick="Unnamed1_Click"  ></asp:Button>
