...
<head runat="server">
  ...
  <script language="javascript"  type="text/javascript">
    ...
    if (wshshell!=null){
		...
		otroHs.innerHTML = 'Bienvenido ' + hs.value + ', haga click en el boton para ingresar con su usuario Windows, o puede elegir entrar con otro usuario de Zamba.';
	    }
    }
     ...
     <table style="width: 100%; height:500; background-image: url(images/fondoPantalla.JPG); background-color: transparent;">
        <tr>
                <td style="vertical-align: bottom;">
                    <img src="images/ClienteBanner.jpg" style="height: 49px" />
                </td>
            </tr>
            <tr>
                <td>
                            ...
                            <div align="center">
                                <asp:Table  Width="40%" runat="server" ID="tbl5" Height="78px">
                                    <asp:TableRow runat="server">
										...
										<strong><em>Monitoreo de Workflow</em></strong></font>
										</asp:TableCell>
									</asp:TableRow>
                                </asp:Table>
                                <hr />
 ...
 <asp:Table runat="server" ID="tbl2" Width="49%" Height="80px">
            ...
            <center>
                <span style="font-size: 7pt; font-family: Arial; vertical-align: middle;">
                    ...
                    <br />
                    Resolución optima 1024 x 768</span>
                    </center>
                    </td>
            </tr>
        </table>
