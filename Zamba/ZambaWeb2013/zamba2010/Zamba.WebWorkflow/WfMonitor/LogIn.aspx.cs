...
public partial class Login : System.Web.UI.Page
{
    ...
    private Boolean IsUserValid()
    {
        try
        {
            RightFactory.ValidateLogIn(txtUserName.Text, txtPassword.Text);
            return true;
        }
        catch (Exception ex)
        {
    ...
    protected void LoadAspect(Boolean loadWindowsUserAspect)
    {
        if (loadWindowsUserAspect)
        {
            ...
            this.Title = ClientName() + " - Monitoreo de Workflow [Ingresar]";
            lblLoginWindows.Text = "Bienvenido, haga click en el boton para ingresar sistema.";
        ...
        else
        {
            ...
            this.Title = ClientName() + " - Monitoreo de Workflow [Iniciar Sesión]";
