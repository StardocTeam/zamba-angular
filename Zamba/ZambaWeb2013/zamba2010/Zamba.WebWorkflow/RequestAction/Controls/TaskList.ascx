<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/RequestAction/Controls/TaskList.ascx.cs" Inherits="TaskList" %>
...
<fieldset title="Listado de Tareas" class="FieldSet">
   ...
   <div class="UserControlBody">
      <table>
         ...
         <tr>
            <td style="width: 100%; color: navy; text-align: left; font-size: xx-small;"
