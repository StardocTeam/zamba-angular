...
using System.Xml;
using System.IO;
using InvocacionServWConsDepFiel.ServiceReference1;
...
namespace InvocacionServWConsDepFiel
{
    public class ServicioWConsDepFiel
    {
        ...
        public ListaEstadoResponse InvocarServicioListaEstadoRequest(Autenticacion autenticacion,
                                      string nroLegajo,
                                      string cuitPSAD,
                                      string codigo,
                                      string ticket,
                                      ...
                                      )
        {
            try
            {
                ...
                var wConsDepFielSoapClient = new InvocacionServWConsDepFiel.ServiceReference1.wConsDepFielSoapClient("wConsDepFielSoap");
                InvocacionServWConsDepFiel.ServiceReference1.wConsDepFielSoap wConsDepFielSoap  = wConsDepFielSoapClient; 
        ...
        public async Task<ServiceReference1.ListaEstadoResponse> GetListaEstadoResponse(ListaEstadoRequest listaEstadoRequest, wConsDepFielSoap wConsDepFielSoap)
        {
