...
moment_ext_1.newMomentProto.format = function () {
    ...
    if (this._ambigTime) {
        return moment_ext_1.oldMomentFormat(englishMoment(this), 'DD-MM-YYYY');
    }
    if (this._ambigZone) {
        return moment_ext_1.oldMomentFormat(englishMoment(this), 'DD-MM-YYYY[T]HH:mm:ss');
    }
    if (this._fullCalendar) {
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        return '<tr class="fc-list-heading" data-date="' + dayDate.format('DD-MM-YYYY') + '">' +
