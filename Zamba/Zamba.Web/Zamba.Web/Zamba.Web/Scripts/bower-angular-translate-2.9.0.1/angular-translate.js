...
function $translate($STORAGE_KEY, $windowProvider, $translateSanitizationProvider, pascalprechtTranslateOverrider) {
  ...
  var negotiateLocale = function (preferred) {
    ...
    var avail = [],
        locale = preferred.toLowerCase(),
        i = 0,
        n = $availableLanguageKeys.length;

    for (; i < n; i++) {
        avail.push($availableLanguageKeys[i].toLowerCase());
    }
      ...
      for (var langKeyAlias in $languageKeyAliases) {
        ...
        if (hasExactKey || hasWildcardKey) {
          alias = $languageKeyAliases[langKeyAlias];
            if (indexOf(avail, alias.toLowerCase()) > -1) {
            return alias;
          }
        }
      }
    ...
    var parts = preferred.split('_');
      ...
      if (parts.length > 1 && indexOf(avail, parts[0].toLowerCase()) > -1) {
      return parts[0];
    }
          ...
          if (translateValueExist) {
            for (var attr in tAttr) {
              if (Object.prototype.hasOwnProperty.call(iAttr, attr) && attr.substr(0, 14) === 'translateValue' && attr !== 'translateValues') {
                  var attributeName = attr.substr(14, 1).toLowerCase() + attr.substr(15);
        ...
        if (translateValueExist) {
          var observeValueAttribute = function (attrName) {
            iAttr.$observe(attrName, function (value) {
                var attributeName = attrName.substr(14, 1).toLowerCase() + attrName.substr(15);
