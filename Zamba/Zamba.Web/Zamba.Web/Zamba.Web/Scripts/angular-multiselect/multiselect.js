//(function () {
        ...
        return {
            ...
            link: function (originalScope, element, attrs, ctrls) {
               var modelCtrl = ctrls[0];
                ...
                var
                    ...
                    CallBack = attrs.onitemselected ? attrs.onitemselected : null,
                    nombrefuncion = attrs.nombrefuncion,
                    ...
                    selectSingle = function (item) {
                        ...
                        setModelValue(false);
                        var cscope = angular.element($("#ResultsCtrl")).scope().handleViewCheck
                        if (CallBack != null) cscope[CallBack](item.model);
                    },
            ...
            fireRecalculating = function () {
                ...
                scope.select = function (item) {
                    ...
                    executeFunctionByName(nombrefuncion, item.model.id, item.model.reportId);
                };
    ...
    app.factory('multiselectParser', multiselectParser);

    app.directive('multiselectPopup', multiselectPopup);

    app.directive('multiselect', multiselect);
//})()

//args id del tag del dom del select para obtener el scope y el id de la seleccion
function executeFunctionByName(functionName, args, reportId) {
    window[functionName](args, reportId);
