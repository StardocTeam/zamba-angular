                            ...
                            if (ConvertToPDf == false)
                            {
                                if (res.RealFullPath().Contains("__.__"))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Zamba.Data.Transaction t = null;
                                        RB.ReplaceDocument(ref res, tempPDFFile, false, t);
                                    }
                                    catch (Exception)
                                    {
                                    }
                            ...
                            else
                            {
                                if (res.RealFullPath().Contains("__.__"))
                                {
                                    ...
                                    try
                                    {
                                        Results_Business RB = new Results_Business();
                                        Zamba.Data.Transaction t = null;
                                        RB.ReplaceDocument(ref res, res.RealFullPath(), false, t);

                                        newPDFFile = res.FullPath.Replace(".pdf", "") + ".pdf";
