...
app.controller('ZambaAssociatedController', function ($scope, $filter, $http, ZambaAssociatedService, Search, ruleExecutionService, $uibModal) {
    ...
    function generateColumns(response) {
        ...
        return columnNames.map(function (name) {
			...
			if (name == "Despacho_Codigo") {
               return {
                   field: name.trim(),format: (isDateField[name] ? "{0:dd-MM-yyyy}" : ""),width: 500, template: "<p style=\""+
			...
			if(name == "Nro_Despacho" || name == "Estado_del_Despacho" || name == "DIG_Descripcion" || name == "HASH" || name == "DIG_Codigo_Error" || name == "DIG_Invocacion" || name == "Descripcion_Error" || name == "Invocacion_Recepcion" || name == "Fecha_Invocacion" || name == "Descripcion" || name == "Codigo_Error" || name == "Invocacion" || name == "Nro_Legajo" || name == "Descripcion_Afip" || name == "ID_Despachante" || name == "Nro_Factura" || name == "Monto_FOB" || name == "Documento_De_Transporte" || name == "Fecha_de_Despacho" || name == "Tipo_De_Despacho" || name == "Nro_Sigea" || name == "Nro_Despacho" || name == "Codigo" || name == "Origen" || name == "Familia" || name == "ImpoExpo_Seleccion" || name == "SeleccionDespachante" || name == "DIG_Fecha_Invocacion" || name == "Codigo_Error_Recepcion" || name == "Fecha_Invocacion_Recepcion" || name == "Codigo_Afip" || name == "Nro_Interno" || name == "Codigo_Familias" || name == "Aduanas" || name == "Despachante_Nombre" || name == "CUIT_ATA") {
			   return {
    ...
    function FixAssociatedKendoGrid(grid) {
        ...
        var cuitIE = getColumnIndex(grid.columns, "Despacho_Codigo");
		var CuitIE = grid.columns[cuitIE];
		
		if(CuitIE != undefined) {
			grid.reorderColumn(6, CuitIE);
		}
...
{    
var Url = (thisDomain + "/Services/GetDownloadFile.ashx?DocTypeId=" + result.DOC_TYPE_ID + "&DocId=" + result.DOC_ID +  "&UserID=" + userid);
	}
