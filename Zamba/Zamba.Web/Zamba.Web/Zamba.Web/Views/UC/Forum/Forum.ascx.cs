...
namespace Controls.Forum
{
    public partial class Controls_Forum_WCForum : ResultTab
    {
        ...
        {
            get { return (hdnDocTypeId.Value == string.Empty ? 0 : Int64.Parse(hdnDocTypeId.Value)); }
        ...
        private Int64 DocId
        {
            get { return (hdnDocId.Value == string.Empty ? 0 : Int64.Parse(hdnDocId.Value)); }
        ...
        private bool DeleteRights
        {
            get
            {
                ...
                {
                    hdnCanDelete.Value = RiB.GetUserRights(Zamba.Membership.MembershipHelper.CurrentUser.ID, ObjectTypes.DocTypes, RightsType.DeleteMsgForum, Int32.Parse(DocTypeId.ToString())).ToString();
                }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ZOptBusiness zopt = new ZOptBusiness();
                ...
                UB.ValidateLogIn(long.Parse(Request.QueryString["currentUserID"]), ClientType.Web);                
        ...
        protected void btnResponderForo_Click(object sender, EventArgs e)
        {
            ...
            if (msgid != -1)
            {
                ...
                //popUpMensaje.ClearAttachments(); //Se comenta hasta se arregle la funcionalidad de adjuntar
                Foro.Visible = false;
        ...
        private void ShowAttach(string path)
        {
            ...
            try
            {
                ...
                var js = "$(document).ready(function() {window.open('" + url + "');});";


                Page.ClientScript.RegisterStartupScript(this.GetType(), "OpenAttach", js, true);
        ...
        private void SetGUIRights()
        {
            ...
            //if (!RightsBusiness.CheckAllRights(ObjectTypes.DocTypes, RightsType.DeleteMsgForum, DocTypeId))
            //{
