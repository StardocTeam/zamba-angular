<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls.Notifications.Controls_WCSendMail" Codebehind="WCSendMail.ascx.cs" %>

<br />

<ajaxToolKit:TabContainer ID="TabContainer" runat="server" AutoPostBack="true"  ActiveTabIndex="0">
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <br /> 
                                        <asp:CheckBox ID="chkAddWebLink" runat="server" Font-Bold="False" checked="true"
