...
public partial class UC_WF_Rules_UCDoRequestData : UserControl, IRule
{
    ...
    public Index[] CurrentIndexs
    {
        get
        {
            ZTrace.WriteLineIf(ZTrace.IsVerbose, $"_taskID DoRequestDataIndexs: {_taskID}");
    ...
    public Int32? DtId
    {
        ...
        set
        {
            ...
            {
                ZTrace.WriteLineIf(ZTrace.IsVerbose, $"Clear DTId Null");
                Clear();
    ...
    public void _btnOk_Click(object sender, EventArgs e)
    {
        ...
        ContinueExecution(RuleID, ref _results, ref PendigEvent, ref ExecutionResult,
                          ref ExecutedIDs, ref MyParams, ref PendingChildRules, ref RefreshRule,
                          (List<long>)Session["TaskIdsToRefresh"], false);
    }
    ...
    public void _btnCancel_Click(object sender, EventArgs e)
    {
        ...
        ContinueExecution(RuleID, ref _results, ref MyPendigEvent, ref ExecutionResult,
                          ref ExecutedIDs, ref MyParams, ref PendingChildRules, ref RefreshRule,
                          (List<long>)Session["TaskIdsToRefresh"], false);
    }
    ...
    public void LoadOptions()
    {
        ...
        ZTrace.WriteLineIf(ZTrace.IsVerbose, $"Cantidad de Indices: {indexlist.Count.ToString()}");
    ...
    public void ShowIndexs(Index[] indexs)
    {
        ...
        ZTrace.WriteLineIf(ZTrace.IsVerbose, $"Cantidad de Indices: {indexs.Length.ToString()}");
            ...
            else
            {
                switch (currentIndex.DropDown)
                {
                    case IndexAdditionalType.AutoSustitución:
                        ...
                        {
                            cbValue.Items.Add(new ListItem(string.Format("{0} - {1}", row[0].ToString(), row[1].ToString()), row[0].ToString()));
                        }
                       ...
                       // cbValue.CssClass = "chosen-select";
                        cbValue.Attributes.Add("data-placeholder", "Elija un valor");
                        tcIndexValue = new TableCell();
                    ...
                    case IndexAdditionalType.AutoSustituciónJerarquico:
                        ...
                        if (currentIndex.HierarchicalParentID > 0)
                        {
                            ...
                            resutlsTable = Index.GetHierarchyTableByValue(currentIndex.ID, parentIndex);
                    ...
                    case IndexAdditionalType.DropDownJerarquico:
                        ...
                        if (currentIndex.HierarchicalParentID > 0)
                        {
                            ...
                            resutlsTableSearch = Index.GetHierarchyTableByValue(currentIndex.ID, parentIndex);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    tbValue = (TextBox)Validators.GetControlWithValidations(currentIndex, tbValue, WebModuleMode.Result, task, ZFieldType.RuleField);
                                }
                                service = null;
                            }
