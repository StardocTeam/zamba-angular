...
<div class="row">
    ...
    <div class="style2 col-xs-offset-2 col-xs-8" ">
        <asp:Button ID="_btnok" class="btn btn-primary" Text="Si" runat="server" OnClientClick="hideBtn(this)" OnClick="_btnOk_Click" Style="width: 100px;" />
        <asp:Button ID="_btnno" class="btn btn-default" Text="No" runat="server" OnClientClick="hideBtn(this)" UseSubmitBehavior="false" OnClick="_btnCancel_Click" Style="width: 100px;" />
        <asp:Button ID="_btnca" class="btn btn-default" Text="Cancelar" runat="server" OnClientClick="hideBtn(this)" UseSubmitBehavior="false" Style="width: 100px;" />
    </div>
</div>
