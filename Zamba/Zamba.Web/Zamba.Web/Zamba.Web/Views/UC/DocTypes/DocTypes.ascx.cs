...
public partial class DocTypes: UserControl 
{
    ...
    public string LastSavedEntitiesIds 
    {
        set 
        {
            UserPreferences.setValue("WebSearchLastEntityIdsSelection", value, Zamba.UPSections.Viewer);
        }
        get
        {
            return UP.getValue("WebSearchLastEntityIdsSelection", Zamba.UPSections.Viewer, String.Empty);
        }
    }
