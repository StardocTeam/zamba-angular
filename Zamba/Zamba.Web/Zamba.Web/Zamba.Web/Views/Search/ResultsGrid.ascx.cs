...
public partial class ResultsGrid : System.Web.UI.UserControl
{
    ...
    protected void imgtareas_Click(object sender, System.Web.UI.ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("http://" + Request.ServerVariables["HTTP_HOST"] + Request.ApplicationPath + "/Views/WF/TaskSelector.ashx?doctypeid=" + Session["doctypeid"] + "&docid=" + Session["docid"] + "&userId=" + Zamba.Membership.MembershipHelper.CurrentUser.ID.ToString());
        }
    }
}
