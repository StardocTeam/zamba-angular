<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuickSearch.aspx.cs" Inherits="Zamba.Web.Views.Main.QuickSearch" %>
...
<head>
    ...
    <script>
        ...
        conf.then(function (confVal) {
           ...
           // thisDomain = confVal.QuickSearchServer;
            //ZambaWebRestApiURL = thisDomain + "api";
            userIdGS = confVal.QSuserId;            
        });
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#Advfilter-modal-content").children(".modal-dialog").css({ "top": 0, "left": 0, "width": "760px", "padding":0 });
    });
