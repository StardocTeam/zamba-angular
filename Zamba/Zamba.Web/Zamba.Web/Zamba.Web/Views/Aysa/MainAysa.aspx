<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Views_Client_Aysa_MainAysa" Codebehind="MainAysa.aspx.cs" %>
...
function InsertFormModal(formid) {
    tb_show("Zamba Web - Inserción de Documentos", "../WF/DocInsertModal.aspx?formid=" + formid + "&modal=true&TB_iframe=true&height=550&width=960", false);
}
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <div style=" padding-top:10px; text-align: center">
            ...
            <input id="btnAltaEntidad" runat="server" type="button" onclick="InsertFormModal('1050')" class="btnAltaEntidad" />
            ...
            <input id="btnGeneralReport" type="button" onclick="ShowTabGenRep();"/>
    </div>
    </div>
