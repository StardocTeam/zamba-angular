<%@ Page Language="C#" AutoEventWireup="true" Inherits="Views_Aysa_ComplaintsSemaphore"
    Theme="AysaDiseno" Codebehind="ComplaintsSemaphore.aspx.cs" %>
...
<html>
<head runat="server">
    <title>Semáforo Denuncias</title>
            ...
            if ($('.RowStyleSem').find('a') != null) {
                $('.RowStyleSem').click(function () {
                    if ($(this).find('a')[0]) {
                        ...
                        parent.SwitchDocTaskForResults($(this).find('a')[0], true, "Denuncia");
                        parent.HideHome();
                        return false;
                    }
                });
                ...
                $('.RowStyleSem').find('a').click(function () {
                    ...
                    parent.SwitchDocTaskForResults($(this), true, "Denuncia");
                    parent.HideHome();
                    return false;
                });
            }
