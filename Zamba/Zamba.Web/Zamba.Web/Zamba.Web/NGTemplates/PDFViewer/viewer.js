...
var currentIndex = 0;
var currentId = '';
function OpenUrl(url, index, Id) {
    currentIndex = index;
    currentId = Id;
    if (PDFViewerApplication != undefined) PDFViewerApplication.open(url);
}
...
$(document).ready(function () {
    ...
    $('#viewerContainer').on('wheel', function (event) {
        if (event.originalEvent.deltaY > 0) {
            //console.log('up ss3');
        } else {
            // console.log('upssssa 3');
        }
    }).scroll(function () {
        if (!isCursorUp) {
        ...
        if ($('#viewerContainer').children().height() > 0 && $('#viewerContainer').height() + $('#viewerContainer').scrollTop() >= $('#viewerContainer').children().height()) {
            //console.log("bottom!");
            var url = parent.GetNextUrl(currentIndex,Id);
        }
    });
});
...
(function () {
    ...
    (function (root, factory) {
        ...
        var HOSTED_VIEWER_ORIGINS = ['null',
            'http://mozilla.github.io', 'https://mozilla.github.io', '//192.168.1.21'];
        ...
        function webViewerInitialized() {
            ...
            if (!PDFViewerApplication.supportsFullscreen) {
                ...
                if (appConfig.secondaryToolbar.presentationModeButton != null)appConfig.secondaryToolbar.presentationModeButton.classList.add('hidden');
            }
        ...
        document.addEventListener('pagerendered', function (e) {
            ...
            //Hago que PDF se vea desde arriba de documento
            if (pageIndex === 0) {
                $(PDFViewerApplication.pdfSidebar.pdfViewer.container).scrollTop(0);
            }
        ...
        window.addEventListener('change', function webViewerChange(evt) {
            ...
            appConfig.secondaryToolbar.download.setAttribute('hidden', 'false');
            appConfig.toolbar.print.setAttribute('hidden', 'false');
            appConfig.secondaryToolbar.print.setAttribute('hidden', 'false');
        }, true);
