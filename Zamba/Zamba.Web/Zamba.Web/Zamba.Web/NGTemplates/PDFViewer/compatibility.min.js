'use strict'; if (typeof PDFJS === 'undefined') { (typeof window !== 'undefined' ? window : this).PDFJS = {} } (function checkTypedArrayCompatibility() {
    ...
    if (typeof Object.defineProperty !== 'undefined') {
        var definePropertyPossible = !0; try { Object.defineProperty(new Image(), 'id', { value: 'test' }); var Test = function Test() { }; Test.prototype = { get id() { } }; Object.defineProperty(new Test(), 'id', { value: '', configurable: !0, enumerable: !0, writable: !1 }) } catch (e) { definePropertyPossible = !1 }
    ...
    var digits = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/='; window.btoa = function windowBtoa(chars) {
        var buffer = ''; var i, n; for (i = 0, n = chars.length; i < n; i += 3) { var b1 = chars.charCodeAt(i) & 0xFF; var b2 = chars.charCodeAt(i + 1) & 0xFF; var b3 = chars.charCodeAt(i + 2) & 0xFF; var d1 = b1 >> 2, d2 = ((b1 & 3) << 4) | (b2 >> 4); var d3 = i + 1 < n ? ((b2 & 0xF) << 2) | (b3 >> 6) : 64; var d4 = i + 2 < n ? (b3 & 0x3F) : 64; buffer += (digits.charAt(d1) + digits.charAt(d2) + digits.charAt(d3) + digits.charAt(d4)) }
        return buffer
    }
    ...
    Object.defineProperty(HTMLElement.prototype, 'dataset', {
        get: function () {
            ...
            Object.defineProperty(this, '_dataset', { value: dataset, writable: !1, enumerable: !1 }); return dataset
        }, enumerable: !0
    })
    ...
    var classListPrototype = { add: function (name) { changeList(this.element, name, !0, !1) }, contains: function (name) { return changeList(this.element, name, !1, !1) }, remove: function (name) { changeList(this.element, name, !1, !0) }, toggle: function (name) { changeList(this.element, name, !0, !0) } }; Object.defineProperty(HTMLElement.prototype, 'classList', {
        get: function () {
            if (this._classList) { return this._classList }
            var classList = Object.create(classListPrototype, { element: { value: this, writable: !1, enumerable: !0 } }); Object.defineProperty(this, '_classList', { value: classList, writable: !1, enumerable: !1 }); return classList
        }, enumerable: !0
    })
})(); (function checkConsoleCompatibility() { if (!('console' in window)) { window.console = { log: function () { }, error: function () { }, warn: function () { } } } else if (!('bind' in console.log)) { console.log = (function (fn) { return function (msg) { return fn(msg) } })(console.log); console.error = (function (fn) { return function (msg) { return fn(msg) } })(console.error); console.warn = (function (fn) { return function (msg) { return fn(msg) } })(console.warn) } })(); (function checkOnClickCompatibility() {
    ...
    if (navigator.userAgent.indexOf('Opera') !== -1) { document.addEventListener('click', ignoreIfTargetDisabled, !0) }
})(); (function checkOnBlobSupport() { if (navigator.userAgent.indexOf('Trident') >= 0) { PDFJS.disableCreateObjectURL = !0 } })(); (function checkNavigatorLanguage() {
...
})(); (function checkCanvasSizeLimitation() { var isIOS = /(iPad|iPhone|iPod)/g.test(navigator.userAgent); var isAndroid = /Android/g.test(navigator.userAgent); if (isIOS || isAndroid) { PDFJS.maxCanvasPixels = 5242880 } })(); (function checkFullscreenSupport() { var isEmbeddedIE = (navigator.userAgent.indexOf('Trident') >= 0 && window.parent !== window); if (isEmbeddedIE) { PDFJS.disableFullscreen = !0 } })(); (function checkCurrentScript() {
    if ('currentScript' in document) { return }
    Object.defineProperty(document, 'currentScript', { get: function () { var scripts = document.getElementsByTagName('script'); return scripts[scripts.length - 1] }, enumerable: !0, configurable: !0 })
})()