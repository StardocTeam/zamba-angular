...
app.factory('ZambaAssociatedService', ['$http', '$q', function ($http, $q) {
    ...
    //ver de poner async con IE
     function _getResults(parentResultId, parentEntityId, associatedIds, parentTaskId) {
        ...
        var genericRequest = {
         ...
         //$.ajax({
         //    type: "POST",
         //    url: serviceBase + '/search/getAssociatedResults',
    ...
    function _getResultsByZvar(parentResultId, parentEntityId, associatedIds, parentTaskId) {
        ...
        var genericRequest = {
            UserId: parseInt(GetUID()),
            Params: {
                "taskId": String(parentResultId),
                "zvarName": String(parentEntityId),
            }
        };

        //return $http.post(serviceBase + '/search/GetZvarTableResult', JSON.stringify(genericRequest));
    };
    ...
    zambaAssociatedFactory.GetResultsByZvar = _getResultsByZvar;
