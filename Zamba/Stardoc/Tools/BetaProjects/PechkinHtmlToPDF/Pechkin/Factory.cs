...
namespace Pechkin
{
    ...
    public static class Factory
    {
        ...
        /// </summary>
        private static readonly Pechkin.Util.Func<Pechkin.Util.Func<object>, object> invocationDelegate = (Pechkin.Util.Func<object> del) =>
        {
        ...
        private static void SetupAppDomain()
        {
            ...
            Pechkin.Util.Func<object> del = () =>
            {
                ...
                {
                    int wkhtml;
                    if (AppDomain.CurrentDomain.GetData("useX11Graphics") == null)
                        wkhtml = 0;
                    else
                        wkhtml = (bool)AppDomain.CurrentDomain.GetData("useX11Graphics") ? 1 : 0;
                    PechkinBindings.wkhtmltopdf_init(wkhtml);
                });
