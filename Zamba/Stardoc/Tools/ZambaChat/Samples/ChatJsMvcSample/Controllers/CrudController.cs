        ...
        try
            {
                ...
                {
                    ChatUser cu = db.ChatUser.Where(c => c.Id == Id).FirstOrDefault();
                    if (cu !=null && cu.Id == Id)
                    {
            ...
            try
            {
                switch (Type)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        //using (var fs = System.IO.File.OpenRead(Avatar))
                        //{
