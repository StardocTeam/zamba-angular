...
namespace ChatJsMvcSample.Code.LongPolling.Chat
{
    public class ChatLongPollingProvider : LongPollingProvider
    {
        ...
        private string GetMyRoomId()
        {
            ...
            // But for this example, it will always return "Zamba-Chat", because we have only one room.
            return ROOM_ID_STUB;
        }
        ...
        /// <returns></returns>
        private static LongPollingEvent GetLongPollingEventForRoomUsersChanged(IEnumerable<ChatUser> users, decimal myUserId)
        {
        ...
        /// <param name="users"></param>
        /// <returns></returns>
        private static LongPollingEvent GetLongPollingEventForUserTyped(decimal otherUserId)
        {
            return new LongPollingEvent()
            {
                Data = otherUserId,
        ...
        public override IEnumerable<LongPollingEvent> WaitForEvents(decimal myUserId, string roomId, long timestamp, string connectionString, Controller controller)
        {
