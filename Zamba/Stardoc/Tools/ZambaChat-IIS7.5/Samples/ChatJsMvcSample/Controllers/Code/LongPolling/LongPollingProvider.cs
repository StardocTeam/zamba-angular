...
namespace ChatJsMvcSample.Code.LongPolling
{
    public abstract class LongPollingProvider
    {
        ...
        public abstract IEnumerable<LongPollingEvent> WaitForEvents(decimal myUserId, string roomId, long timestamp, string connectionString, Controller controller);
    }
}
