                            ...
                            var $okAddUserButton = $("<div/>").addClass("okAddUser").attr("id", "tildeAddUser-" + chatId).appendTo(_this.$windowTitle)
                                .click(function (e) {
                                    if ($addUserTxt.val() == "" || !IsUserSelected($addUserTxt.val())) {
                                        ...
                                        SetFunctionUpload((_this.$window).attr("id"), (isCS || isExternal));
                    ...
                    if (validUser || isExternal) {
                        ...
                        if (chatMode == "compact" && !opening) {
                            ...
                            if (!isGroup) {
                                ...
                                //apertura grupo
                                var $chatWindow = $(".chat-window[chatid=" + message.Id + "]");
                                if ($chatWindow.length) {
                                    $(".user-list-item[chatid=" + message.Id + "]").attr("date", new Date().toString());
                                    chatGroups.UpdateLastMessage(message.Id);
                                    OrderUsrLstByDate();
